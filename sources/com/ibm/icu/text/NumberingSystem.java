...
public class NumberingSystem {
    ...
    public static NumberingSystem getInstance(ULocale locale) {
        ...
        if (numbersKeyword != null) {
            ...
            numbersKeyword = PhoneConstants.APN_TYPE_DEFAULT;
            nsResolved = false;
        }
        if (nsResolved) {
        ...
        return (NumberingSystem) cachedLocaleData.getInstance(baseName + "@numbers=" + numbersKeyword, new LocaleLookupData(locale, numbersKeyword));
    }
