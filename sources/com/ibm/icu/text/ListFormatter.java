...
public final class ListFormatter {
    ...
    static class FormattedListBuilder {
        ...
        public FormattedListBuilder append(String pattern, Object next, boolean recordOffset) {
            ...
            SimpleFormatterImpl.formatAndReplace(pattern, this.current, offsets, new CharSequence[]{this.current, next.toString()});
            if (offsets != null) {
    ...
    private static class Cache {
        ...
        private static ListFormatter load(ULocale ulocale, String style) {
            ...
            return new ListFormatter(access$000, access$0002, access$0003, ListFormatter.compilePattern(r.getWithFallback("listPattern/" + style + "/end").getString(), sb), ulocale);
        }
    }
}
