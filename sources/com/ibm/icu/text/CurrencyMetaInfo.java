...
public class CurrencyMetaInfo {
    ...
    public static final class CurrencyFilter {
        ...
        public CurrencyFilter withRegion(String region) {
            return new CurrencyFilter(region, this.currency, this.from, this.f2542to, this.tenderOnly);
        }

        public CurrencyFilter withCurrency(String currency) {
            return new CurrencyFilter(this.region, currency, this.from, this.f2542to, this.tenderOnly);
        }
        ...
        public CurrencyFilter withTender() {
            return new CurrencyFilter(this.region, this.currency, this.from, this.f2542to, true);
        }
        ...
        public boolean equals(CurrencyFilter rhs) {
            return Utility.sameObjects(this, rhs) || (rhs != null && equals(this.region, rhs.region) && equals(this.currency, rhs.currency) && this.from == rhs.from && this.f2542to == rhs.f2542to && this.tenderOnly == rhs.tenderOnly);
        }
        ...
        public int hashCode() {
            ...
            return (((((((((hc * 31) + ((int) this.from)) * 31) + ((int) (this.from >>> 32))) * 31) + ((int) this.f2542to)) * 31) + ((int) (this.f2542to >>> 32))) * 31) + (this.tenderOnly ? 1 : 0);
        }
