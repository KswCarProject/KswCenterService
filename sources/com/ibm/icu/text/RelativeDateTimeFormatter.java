...
public final class RelativeDateTimeFormatter {
    ...
    private static final class RelDateTimeDataSink extends UResource.Sink {
        ...
        /* renamed from: sb */
        StringBuilder f2560sb = new StringBuilder();
            ...
            for (int i = 0; unitTypesTable.getKeyAndValue(i, key, value); i++) {
                if (value.getType() == 0) {
                    ...
                    if (patterns[this.pastFutureIndex][pluralIndex] == null) {
                        patterns[this.pastFutureIndex][pluralIndex] = SimpleFormatterImpl.compileToStringMinMaxArguments(value.getString(), this.f2560sb, 0, 1);
                    }
                }
            }
        }
