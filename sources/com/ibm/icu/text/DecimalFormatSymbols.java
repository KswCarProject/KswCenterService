...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    private static final String[] SYMBOL_KEYS = {"decimal", WifiConfiguration.GroupCipher.varName, "percentSign", "minusSign", "plusSign", "exponential", "perMille", Camera.Parameters.FOCUS_MODE_INFINITY, "nan", "currencyDecimal", "currencyGroup", "superscriptingExponent"};
    ...
    public void setDigitStrings(String[] digitStrings) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (cc == digitStr.length()) {
                if (cc == 1 && tmpDigits2 != null) {
                    tmpDigits2[i] = (char) cp;
                } else {
                    tmpDigits2 = null;
                }
                if (i == 0) {
        ...
        this.zeroDigit = tmpDigits2[0];
        this.digits = tmpDigits2;
    }
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        if (this.serialVersionOnStream < 1) {
            ...
            this.exponential = android.text.format.DateFormat.DAY;
        }
