...
public class DecimalFormatSymbols implements Cloneable, Serializable {
    ...
    private static final String[] SYMBOL_DEFAULTS = {String.valueOf(DEF_DECIMAL_SEPARATOR), String.valueOf(','), String.valueOf(DEF_PERCENT), String.valueOf(DEF_MINUS_SIGN), String.valueOf(DEF_PLUS_SIGN), DateFormat.ABBR_WEEKDAY, String.valueOf(DEF_PERMILL), "∞", "NaN", null, null, "×"};
    /* access modifiers changed from: private */
    public static final String[] SYMBOL_KEYS = {"decimal", WifiConfiguration.GroupCipher.varName, "percentSign", "minusSign", "plusSign", "exponential", "perMille", Camera.Parameters.FOCUS_MODE_INFINITY, "nan", "currencyDecimal", "currencyGroup", "superscriptingExponent"};
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        if (this.serialVersionOnStream < 1) {
            ...
            this.exponential = DateFormat.DAY;
        }
