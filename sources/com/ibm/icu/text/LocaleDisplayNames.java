...
public abstract class LocaleDisplayNames {
    ...
    public static LocaleDisplayNames getInstance(ULocale locale, DialectHandling dialectHandling) {
        ...
        if (FACTORY_DIALECTHANDLING != null) {
            try {
                result = (LocaleDisplayNames) FACTORY_DIALECTHANDLING.invoke((Object) null, new Object[]{locale, dialectHandling});
    ...
    public static LocaleDisplayNames getInstance(ULocale locale, DisplayContext... contexts) {
        ...
        if (FACTORY_DISPLAYCONTEXT != null) {
            try {
                result = (LocaleDisplayNames) FACTORY_DISPLAYCONTEXT.invoke((Object) null, new Object[]{locale, contexts});
            } catch (IllegalAccessException | InvocationTargetException e) {
            }
        }
        if (result == null) {
