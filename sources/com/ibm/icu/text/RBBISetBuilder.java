...
class RBBISetBuilder {
    ...
    void buildRanges() {
        ...
        if (this.fRB.fDebugEnv != null && this.fRB.fDebugEnv.indexOf(Slice.SUBTYPE_RANGE) >= 0) {
            printRanges();
        }
    ...
    void printRangeGroups() {
        ...
        for (RangeDescriptor rlRange = this.fRangeList; rlRange != null; rlRange = rlRange.fNext) {
            ...
            if (groupNum > lastPrintedGroupNum) {
                ...
                System.out.print(groupNum + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
                ...
                for (RangeDescriptor tRange = rlRange; tRange != null; tRange = tRange.fNext) {
                    if (tRange.fNum == rlRange.fNum) {
                        ...
                        System.out.print(NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
