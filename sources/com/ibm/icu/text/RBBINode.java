...
class RBBINode {
    ...
    static final String[] nodeTypeNames = {"setRef", "uset", "varRef", "leafChar", "lookAhead", DropBoxManager.EXTRA_TAG, "endMark", "opStart", "opCat", "opOr", "opStar", "opPlus", "opQuestion", "opBreak", "opReverse", "opLParen"};
    ...
    static void printNode(RBBINode n) {
        if (n == null) {
            ...
            if (n.fType == 2) {
                ...
                printStream.print(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + n.fText);
            }
        }
        System.out.println("");
    }
