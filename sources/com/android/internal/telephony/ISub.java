            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 19:
                        ...
                        int _result18 = setOpportunistic(_arg1, data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 21:
                        ...
                        setPreferredDataSubscriptionId(_arg02, _arg1, ISetOpportunisticDataCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 24:
                        ...
                        removeSubscriptionsFromGroup(_arg03, _arg0, data.readString());
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        addSubscriptionsIntoGroup(_arg04, _arg0, data.readString());
                        reply.writeNoException();
                        return true;
                    case 26:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 41:
                        ...
                        boolean _result34 = setSubscriptionEnabled(_arg1, data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result34);
                        return true;
                    case 42:
                        data.enforceInterface(DESCRIPTOR);
                        boolean _result35 = isSubscriptionEnabled(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result35);
                        return true;
                    case 43:
                        data.enforceInterface(DESCRIPTOR);
                        int _result36 = getEnabledSubscriptionId(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result36);
                        return true;
                    case 44:
                        data.enforceInterface(DESCRIPTOR);
                        int _result37 = getSimStateForSlotIndex(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result37);
                        return true;
                    case 45:
                        data.enforceInterface(DESCRIPTOR);
                        boolean _result38 = isActiveSubId(data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 46:
                        ...
                        boolean _result39 = setAlwaysAllowMmsData(_arg05, _arg1);
                        reply.writeNoException();
                        reply.writeInt(_result39);
                        return true;
                    case 47:
                        data.enforceInterface(DESCRIPTOR);
                        int _result40 = getActiveDataSubscriptionId();
                        reply.writeNoException();
        ...
        private static class Proxy implements ISub {
            ...
            public SubscriptionInfo getActiveSubscriptionInfo(int subId, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    SubscriptionInfo _result2 = _result;
                    _reply.recycle();
                    _data.recycle();
                    return _result2;
                } finally {
