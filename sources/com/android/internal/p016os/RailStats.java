...
public final class RailStats {
    ...
    public static class RailInfoData {
        ...
        public void printData() {
            Slog.m58d(TAG, "Index = " + this.index);
            Slog.m58d(TAG, "RailName = " + this.railName);
            Slog.m58d(TAG, "SubSystemName = " + this.subSystemName);
            Slog.m58d(TAG, "TimestampSinceBootMs = " + this.timestampSinceBootMs);
            Slog.m58d(TAG, "EnergyUsedSinceBootuWs = " + this.energyUsedSinceBootuWs);
        }
    }
}
