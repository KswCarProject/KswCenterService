...
public class HandlerCaller {
    ...
    public HandlerCaller(Context context, Looper looper, Callback callback, boolean asyncHandler) {
        ...
        this.f2486mH = new MyHandler(this.mMainLooper, asyncHandler);
    ...
    public void executeOrSendMessage(Message msg) {
        ...
        this.f2486mH.sendMessage(msg);
    }

    public void sendMessageDelayed(Message msg, long delayMillis) {
        this.f2486mH.sendMessageDelayed(msg, delayMillis);
    }

    public boolean hasMessages(int what) {
        return this.f2486mH.hasMessages(what);
    }

    public void removeMessages(int what) {
        this.f2486mH.removeMessages(what);
    }

    public void removeMessages(int what, Object obj) {
        this.f2486mH.removeMessages(what, obj);
    }
    ...
    public SomeArgs sendMessageAndWait(Message msg) {
        if (Looper.myLooper() == this.f2486mH.getLooper()) {
    ...
    public Message obtainMessage(int what) {
        return this.f2486mH.obtainMessage(what);
    }

    public Message obtainMessageBO(int what, boolean arg1, Object arg2) {
        return this.f2486mH.obtainMessage(what, arg1 ? 1 : 0, 0, arg2);
    }
    ...
    public Message obtainMessageBOO(int what, boolean arg1, Object arg2, Object arg3) {
        ...
        args.arg1 = arg2;
        args.arg2 = arg3;
        return this.f2486mH.obtainMessage(what, arg1 ? 1 : 0, 0, args);
    }

    @UnsupportedAppUsage
    public Message obtainMessageO(int what, Object arg1) {
        return this.f2486mH.obtainMessage(what, 0, 0, arg1);
    }

    public Message obtainMessageI(int what, int arg1) {
        return this.f2486mH.obtainMessage(what, arg1, 0);
    }

    public Message obtainMessageII(int what, int arg1, int arg2) {
        return this.f2486mH.obtainMessage(what, arg1, arg2);
    }

    @UnsupportedAppUsage
    public Message obtainMessageIO(int what, int arg1, Object arg2) {
        return this.f2486mH.obtainMessage(what, arg1, 0, arg2);
    }

    public Message obtainMessageIIO(int what, int arg1, int arg2, Object arg3) {
        return this.f2486mH.obtainMessage(what, arg1, arg2, arg3);
    }
    ...
    public Message obtainMessageIIOO(int what, int arg1, int arg2, Object arg3, Object arg4) {
        ...
        args.arg1 = arg3;
        args.arg2 = arg4;
        return this.f2486mH.obtainMessage(what, arg1, arg2, args);
    }
    ...
    public Message obtainMessageIOO(int what, int arg1, Object arg2, Object arg3) {
        ...
        args.arg1 = arg2;
        args.arg2 = arg3;
        return this.f2486mH.obtainMessage(what, arg1, 0, args);
    }
    ...
    public Message obtainMessageOO(int what, Object arg1, Object arg2) {
        ...
        args.arg1 = arg1;
        args.arg2 = arg2;
        return this.f2486mH.obtainMessage(what, 0, 0, args);
    }
