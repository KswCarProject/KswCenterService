...
class AppZygoteInit {
    ...
    private static class AppZygoteConnection extends ZygoteConnection {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:10:0x0081 -> B:23:0x00a1). Please submit an issue!!! */
        @Override // com.android.internal.p016os.ZygoteConnection
        protected void handlePreloadApp(ApplicationInfo appInfo) {
            Log.m68i(AppZygoteInit.TAG, "Beginning application preload for " + appInfo.packageName);
            ...
            if (appInfo.zygotePreloadName != null) {
                try {
                    ...
                    if (!ZygotePreload.class.isAssignableFrom(cl)) {
                        Log.m70e(AppZygoteInit.TAG, preloadName.getClassName() + " does not implement " + ZygotePreload.class.getName());
                    } else {
                    ...
                    Log.m69e(AppZygoteInit.TAG, "AppZygote application preload failed for " + appInfo.zygotePreloadName, e);
                }
            } else {
                Log.m68i(AppZygoteInit.TAG, "No zygotePreloadName attribute specified.");
            }
            try {
                ...
                Log.m68i(AppZygoteInit.TAG, "Application preload done");
