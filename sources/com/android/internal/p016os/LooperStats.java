...
public class LooperStats implements Looper.Observer {
    ...
    @Override // android.p007os.Looper.Observer
    ...
    private Entry findEntry(Message msg, boolean allowCreateNew) {
        ...
        synchronized (this.mLock) {
            ...
            Entry entry2 = entry;
            if (entry2.workSourceUid != msg.workSourceUid || entry2.handler.getClass() != msg.getTarget().getClass() || entry2.handler.getLooper().getThread() != msg.getTarget().getLooper().getThread() || entry2.isInteractive != isInteractive) {
