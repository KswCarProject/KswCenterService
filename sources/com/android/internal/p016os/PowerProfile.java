...
import com.android.internal.p016os.PowerProfileProto;
...
public class PowerProfile {
    ...
    private void readPowerValuesFromXml(Context context, boolean forTest) {
        double d;
        int value;
        int id = forTest ? C3132R.xml.power_profile_test : C3132R.xml.power_profile;
        ...
        try {
            try {
                ...
                parser.close();
                int[] configResIds = {C3132R.integer.config_bluetooth_idle_cur_ma, C3132R.integer.config_bluetooth_rx_cur_ma, C3132R.integer.config_bluetooth_tx_cur_ma, C3132R.integer.config_bluetooth_operating_voltage_mv};
