...
public class ProcessCpuTracker {
    ...
    public void update() {
        ...
        boolean z = true;
        if (Process.readProcFile("/proc/stat", SYSTEM_CPU_FORMAT, (String[]) null, sysCpu, (float[]) null)) {
        ...
        try {
            ...
            if (Process.readProcFile("/proc/loadavg", LOAD_AVERAGE_FORMAT, (String[]) null, (long[]) null, loadAverages)) {
    ...
    private int[] collectStats(String statsFile, int parentPid, boolean first, int[] curPids, ArrayList<Stats> allProcs) {
        ...
        while (true) {
            ...
            if (st2 == null || st2.pid != pid2) {
                ...
                if (Process.readProcFile(path, PROCESS_FULL_STATS_FORMAT, procStatsString, procStats, (float[]) null)) {
                    ...
                    st4.baseName = MediaStore.UNKNOWN_STRING;
                    st4.base_stime = 0;
                    st4.base_utime = 0;
                ...
                if (st2.interesting != 0) {
                    ...
                    if (!Process.readProcFile(st2.statFile.toString(), PROCESS_STATS_FORMAT, (String[]) null, procStats2, (float[]) null)) {
                        pids2 = pids4;
                        NP = NP2;
                        NS = NS2;
                        i = i4;
    ...
    public long getCpuTimeForPid(int pid) {
        synchronized (this.mSinglePidStatsData) {
            ...
            if (!Process.readProcFile(statFile, PROCESS_STATS_FORMAT, (String[]) null, statsData, (float[]) null)) {
                return 0;
            }
    ...
    private void getName(com.android.internal.os.ProcessCpuTracker.Stats r6, java.lang.String r7) {
        /*
            r5 = this;
        ...
        L_0x001a:
            r1 = 0
            java.lang.String r1 = com.android.internal.os.ProcStatsUtil.readTerminatedProcFile(r7, r1)
        ...
        L_0x004e:
            r6.name = r0
            java.lang.String r1 = r6.name
            int r1 = r5.onMeasureProcessName(r1)
            r6.nameWidth = r1
        L_0x0058:
            return
        */
