...
public class KernelWakelockReader {
    ...
    public final KernelWakelockStats readKernelWakelockStats(KernelWakelockStats staleStats) {
        ...
        while (true) {
            try {
                int read = is.read(buffer, len, buffer.length - len);
                int cnt = read;
                if (read <= 0) {
                    break;
                }
            ...
            try {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        try {
                            boolean parsed = Process.parseProcLine(wlBuffer, startIndex3, endIndex3, iArr, nameStringArray, wlData, (float[]) null);
