...
class WebViewZygoteInit {
    ...
    private static class WebViewZygoteConnection extends ZygoteConnection {
        ...
        public void handlePreloadApp(ApplicationInfo appInfo) {
            ...
            doPreload(new LoadedApk((ActivityThread) null, appInfo, (CompatibilityInfo) null, (ClassLoader) null, false, true, false).getClassLoader(), WebViewFactory.getWebViewLibrary(appInfo));
        ...
        private void doPreload(ClassLoader loader, String libFileName) {
            ...
            try {
                ...
                if (preloadInZygote.getReturnType() != Boolean.TYPE) {
                    ...
                    preloadSucceeded = ((Boolean) providerClass.getMethod("preloadInZygote", new Class[0]).invoke((Object) null, new Object[0])).booleanValue();
                    if (!preloadSucceeded) {
