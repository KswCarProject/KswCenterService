...
public final class FloatingToolbar {
    ...
    private static final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View parent) {
            ...
            this.mMarginHorizontal = parent.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_horizontal_margin);
            this.mMarginVertical = parent.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_vertical_margin);
            this.mLineHeight = context.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_height);
            this.mIconTextSpacing = context.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_icon_text_spacing);
            ...
            this.mArrow = this.mContext.getResources().getDrawable(C3132R.C3133drawable.ft_avd_tooverflow, this.mContext.getTheme());
            this.mArrow.setAutoMirrored(true);
            this.mOverflow = this.mContext.getResources().getDrawable(C3132R.C3133drawable.ft_avd_toarrow, this.mContext.getTheme());
            this.mOverflow.setAutoMirrored(true);
            this.mToArrow = (AnimatedVectorDrawable) this.mContext.getResources().getDrawable(C3132R.C3133drawable.ft_avd_toarrow_animation, this.mContext.getTheme());
            this.mToArrow.setAutoMirrored(true);
            this.mToOverflow = (AnimatedVectorDrawable) this.mContext.getResources().getDrawable(C3132R.C3133drawable.ft_avd_tooverflow_animation, this.mContext.getTheme());
        ...
        public void show(Rect contentRectOnScreen) {
            ...
            preparePopupContent();
            this.mPopupWindow.showAtLocation(this.mParent, 0, this.mCoordsOnWindow.f59x, this.mCoordsOnWindow.f60y);
        ...
        public void updateCoordinates(Rect contentRectOnScreen) {
            ...
            refreshCoordinatesAndOverflowDirection(contentRectOnScreen);
            preparePopupContent();
            this.mPopupWindow.update(this.mCoordsOnWindow.f59x, this.mCoordsOnWindow.f60y, this.mPopupWindow.getWidth(), this.mPopupWindow.getHeight());
        }
        ...
        private void refreshCoordinatesAndOverflowDirection(Rect contentRectOnScreen) {
            ...
            if (!hasOverflow()) {
                if (availableHeightAboveContent >= toolbarHeightWithVerticalMargin) {
                    max = contentRectOnScreen.top - toolbarHeightWithVerticalMargin;
                } else if (availableHeightBelowContent >= toolbarHeightWithVerticalMargin) {
                    max = contentRectOnScreen.bottom;
                } else if (availableHeightBelowContent >= this.mLineHeight) {
                    max = contentRectOnScreen.bottom - this.mMarginVertical;
                } else {
                    max = Math.max(this.mViewPortOnScreen.top, contentRectOnScreen.top - toolbarHeightWithVerticalMargin);
                }
                y = max;
            } else {
        ...
        public void setPanelsStatesAtRestingPosition() {
            ...
            if (this.mIsOverflowOpen) {
                ...
                this.mOverflowButton.setContentDescription(this.mContext.getString(C3132R.string.floating_toolbar_close_overflow_description));
                if (isInRTLMode()) {
            ...
            this.mOverflowButton.setContentDescription(this.mContext.getString(C3132R.string.floating_toolbar_open_overflow_description));
            if (hasOverflow()) {
                if (isInRTLMode()) {
                    this.mContentContainer.setX(this.mMarginHorizontal);
                    this.mMainPanel.setX(0.0f);
        ...
        private int getAdjustedToolbarWidth(int suggestedWidth) {
            ...
            refreshViewPort();
            int maximumWidth = this.mViewPortOnScreen.width() - (this.mParent.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_horizontal_margin) * 2);
            if (width <= 0) {
                width = this.mParent.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_preferred_width);
            }
        ...
        private ImageButton createOverflowButton() {
            final ImageButton overflowButton = (ImageButton) LayoutInflater.from(this.mContext).inflate(C3132R.layout.floating_popup_overflow_button, (ViewGroup) null);
        ...
        /* loaded from: classes4.dex */
        class animationAnimation$AnimationListenerC333913 implements Animation.AnimationListener {
            animationAnimation$AnimationListenerC333913() {
            }
            ...
            public void onAnimationEnd(Animation animation) {
                FloatingToolbarPopup.this.mContentContainer.post(new Runnable() { // from class: com.android.internal.widget.-$$Lambda$FloatingToolbar$FloatingToolbarPopup$13$7WTSUuAWkzil48e0QxuKTn0YOXI
                    ...
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.animationAnimation$AnimationListenerC333913.lambda$onAnimationEnd$0(FloatingToolbar.FloatingToolbarPopup.animationAnimation$AnimationListenerC333913.this);
                    }
                });
            }

            public static /* synthetic */ void lambda$onAnimationEnd$0(animationAnimation$AnimationListenerC333913 animationanimation_animationlistenerc333913) {
                FloatingToolbarPopup.this.setPanelsStatesAtRestingPosition();
                FloatingToolbarPopup.this.setContentAreaAsTouchableSurface();
            }
        ...
        private Animation.AnimationListener createOverflowAnimationListener() {
            Animation.AnimationListener listener = new animationAnimation$AnimationListenerC333913();
            return listener;
        }
        ...
        private static final class OverflowPanelViewHelper {
            ...
            public OverflowPanelViewHelper(Context context, int iconTextSpacing) {
                ...
                this.mSidePadding = context.getResources().getDimensionPixelSize(C3132R.dimen.floating_toolbar_overflow_side_padding);
            }
    ...
    public static View createMenuItemButton(Context context, MenuItem menuItem, int iconTextSpacing, boolean showIcon) {
        View menuItemButton = LayoutInflater.from(context).inflate(C3132R.layout.floating_popup_menu_button, (ViewGroup) null);
        if (menuItem != null) {
    ...
    public static void updateMenuItemButton(View menuItemButton, MenuItem menuItem, int iconTextSpacing, boolean showIcon) {
        TextView buttonText = (TextView) menuItemButton.findViewById(C3132R.C3134id.floating_toolbar_menu_item_text);
        ...
        ImageView buttonIcon = (ImageView) menuItemButton.findViewById(C3132R.C3134id.floating_toolbar_menu_item_image);
    ...
    public static ViewGroup createContentContainer(Context context) {
        ViewGroup contentContainer = (ViewGroup) LayoutInflater.from(context).inflate(C3132R.layout.floating_popup_container, (ViewGroup) null);
