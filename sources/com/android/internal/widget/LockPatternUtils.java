...
public class LockPatternUtils {
    ...
    public DevicePolicyManager getDevicePolicyManager() {
        if (this.mDevicePolicyManager == null) {
            ...
            if (this.mDevicePolicyManager == null) {
                Log.m69e(TAG, "Can't get DevicePolicyManagerService: is it running?", new IllegalStateException("Stack trace:"));
            }
        }
    ...
    private TrustManager getTrustManager() {
        ...
        if (trust == null) {
            Log.m69e(TAG, "Can't get TrustManagerService: is it running?", new IllegalStateException("Stack trace:"));
        }
        return trust;
    }
    ...
    public byte[] getPasswordHistoryHashFactor(byte[] currentPassword, int userId) {
        try {
            ...
            Log.m69e(TAG, "failed to get hash factor", e);
            return null;
        }
    }
    ...
    public boolean checkPasswordHistory(byte[] passwordToCheck, byte[] hashFactor, int userId) {
        ...
        if (passwordToCheck == null || passwordToCheck.length == 0) {
            Log.m70e(TAG, "checkPasswordHistory: empty password");
            return false;
        }
    ...
    public void resetKeyStore(int userId) {
        try {
            ...
            Log.m70e(TAG, "Couldn't reset keystore " + e);
        }
    }
    ...
    public boolean clearLock(byte[] savedCredential, int userHandle, boolean allowUntrustedChange) {
        ...
        try {
            ...
            Log.m69e(TAG, "Failed to clear lock", e);
    ...
    public boolean isLockScreenDisabled(int userId) {
        ...
        boolean disabledByDefault = this.mContext.getResources().getBoolean(C3132R.bool.config_disableLockscreenByDefault);
    ...
    public boolean saveLockPattern(List<LockPatternView.Cell> pattern, byte[] savedPattern, int userId, boolean allowUntrustedChange) {
        ...
        try {
            ...
            Log.m69e(TAG, "Couldn't save lock pattern", e);
    ...
    public void sanitizePassword() {
        try {
            ...
            Log.m70e(TAG, "Couldn't sanitize password" + re);
        }
    }
    ...
    private void updateCryptoUserInfo(int userId) {
        ...
        if (service == null) {
            Log.m70e(TAG, "Could not find the mount service to update the user info");
            return;
        }
        IStorageManager storageManager = IStorageManager.Stub.asInterface(service);
        try {
            Log.m72d(TAG, "Setting owner info");
            storageManager.setField(StorageManager.OWNER_INFO_KEY, ownerInfo);
        } catch (RemoteException e) {
            Log.m69e(TAG, "Error changing user info", e);
        }
    }
    ...
    private void updateEncryptionPassword(final int type, byte[] password) {
        ...
        if (service == null) {
            Log.m70e(TAG, "Could not find the mount service to update the encryption password");
            return;
        }
        ...
        new AsyncTask<Void, Void, Void>() { // from class: com.android.internal.widget.LockPatternUtils.1
            ...
            public Void doInBackground(Void... dummy) {
                ...
                try {
                    ...
                    Log.m69e(LockPatternUtils.TAG, "Error changing encryption password", e);
                    return null;
                }
            }
        }.execute(new Void[0]);
    ...
    public boolean saveLockPassword(byte[] password, byte[] savedPassword, int requestedQuality, int userHandle, boolean allowUntrustedChange) {
        ...
        try {
            ...
            Log.m69e(TAG, "Unable to save lock password", e);
            setKeyguardStoredPasswordQuality(currentQuality, userHandle);
            return false;
        }
    }
    ...
    private void updatePasswordHistory(byte[] password, int userHandle) {
        ...
        if (passwordHistoryLength == 0) {
            ...
            if (hash == null) {
                Log.m70e(TAG, "Compute new style password hash failed, fallback to legacy style");
    ...
    public void setSeparateProfileChallengeEnabled(int userHandle, boolean enabled, byte[] managedUserPassword) {
        ...
        try {
            ...
            Log.m70e(TAG, "Couldn't update work profile challenge enabled");
        }
    }
    ...
    public boolean isSeparateProfileChallengeAllowedToUnify(int userHandle) {
        return getDevicePolicyManager().isProfileActivePasswordSufficientForParent(userHandle) && !getUserManager().hasUserRestriction(UserManager.DISALLOW_UNIFIED_PASSWORD, UserHandle.m110of(userHandle));
    }
    ...
    private boolean hasSeparateChallenge(int userHandle) {
        try {
            ...
            Log.m70e(TAG, "Couldn't get separate profile challenge enabled");
            return false;
        }
    }
    ...
    public static List<LockPatternView.Cell> byteArrayToPattern(byte[] bytes) {
        ...
        for (byte b : bytes) {
            byte b2 = (byte) (b - 49);
            result.add(LockPatternView.Cell.m23of(b2 / 3, b2 % 3));
        }
        return result;
    }
    ...
    private String getSalt(int userId) {
        ...
        if (salt == 0) {
            try {
                ...
                Log.m66v(TAG, "Initialized lock password salt for user: " + userId);
            } catch (NoSuchAlgorithmException e) {
    ...
    public void setVisiblePatternEnabled(boolean enabled, int userId) {
        ...
        try {
            ...
            Log.m69e(TAG, "Error changing pattern visible state", e);
        }
    }
    ...
    public void setVisiblePasswordEnabled(boolean enabled, int userId) {
        ...
        try {
            ...
            Log.m69e(TAG, "Error changing password visible state", e);
        }
    }
    ...
    private void setBoolean(String secureSettingKey, boolean enabled, int userId) {
        try {
            ...
            Log.m70e(TAG, "Couldn't write boolean " + secureSettingKey + re);
        }
    }
    ...
    private void setLong(String secureSettingKey, long value, int userHandle) {
        try {
            ...
            Log.m70e(TAG, "Couldn't write long " + secureSettingKey + re);
        }
    }
    ...
    private void setString(String secureSettingKey, String value, int userHandle) {
        try {
            ...
            Log.m70e(TAG, "Couldn't write string " + secureSettingKey + re);
        }
    }
    ...
    public void requireStrongAuth(int strongAuthReason, int userId) {
        try {
            ...
            Log.m70e(TAG, "Error while requesting strong auth: " + e);
        }
    }
    ...
    public void unregisterStrongAuthTracker(StrongAuthTracker strongAuthTracker) {
        try {
            ...
            Log.m69e(TAG, "Could not unregister StrongAuthTracker", e);
        }
    }
    ...
    public int getStrongAuthForUser(int userId) {
        try {
            ...
            Log.m69e(TAG, "Could not get StrongAuth", e);
    ...
    public static class StrongAuthTracker {
        ...
        private final HandlerC3358H mHandler;
        ...
        public StrongAuthTracker(Context context, Looper looper) {
            ...
            this.mHandler = new HandlerC3358H(looper);
            this.mDefaultStrongAuthFlags = getDefaultFlags(context);
        }

        public static int getDefaultFlags(Context context) {
            return context.getResources().getBoolean(C3132R.bool.config_strongAuthRequiredOnBoot) ? 1 : 0;
        }
        ...
        /* loaded from: classes4.dex */
        private class HandlerC3358H extends Handler {
            static final int MSG_ON_STRONG_AUTH_REQUIRED_CHANGED = 1;

            public HandlerC3358H(Looper looper) {
                super(looper);
            }
    ...
    public static boolean frpCredentialEnabled(Context context) {
        return context.getResources().getBoolean(C3132R.bool.config_enableCredentialFactoryResetProtection);
    }
