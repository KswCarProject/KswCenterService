    ...
    */
        ...
        if (keyCode != 5) {
            if (keyCode != 27) {
                                                ...
                                                if (event.getRepeatCount() == 0) {
                                                    ...
                                                    if (config.keyboard == 1 || config.hardKeyboardHidden == 2) {
                                                        if (isUserSetupComplete()) {
                                                            ...
                                                            Log.m68i(TAG, "Not dispatching SEARCH long press because user setup is in progress.");
                                                            break;
                                                        }
                                                    }
                                                }
                ...
                if (event.getRepeatCount() == 0) {
                    ...
                    if (isUserSetupComplete()) {
                        ...
                        Log.m68i(TAG, "Not dispatching CAMERA long press because user setup is in progress.");
                    }
                }
                return true;
            }
            ...
            if (event.getRepeatCount() == 0) {
                ...
                if (isUserSetupComplete()) {
                    ...
                    Log.m68i(TAG, "Not starting call activity because user setup is in progress.");
                }
            }
            return true;
        }
    ...
    void startCallActivity() {
        ...
        try {
            ...
            Log.m64w(TAG, "No activity found for android.intent.action.CALL_BUTTON.");
        }
    }
