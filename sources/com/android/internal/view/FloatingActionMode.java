...
public final class FloatingActionMode extends ActionMode {
    ...
    public FloatingActionMode(Context context, ActionMode.Callback2 callback, View originatingView, FloatingToolbar floatingToolbar) {
        ...
        this.mBottomAllowance = context.getResources().getDimensionPixelSize(C3132R.dimen.content_rect_bottom_clip_allowance);
    ...
    private boolean isContentRectWithinBounds() {
        ...
        this.mScreenRect.set(0, 0, this.mDisplaySize.f59x, this.mDisplaySize.f60y);
