...
public class LocalePicker extends ListFragment {
    ...
    public static String[] getSupportedLocales(Context context) {
        return context.getResources().getStringArray(C3132R.array.supported_locales);
    }
    ...
    public static List<LocaleInfo> getAllAssetLocales(Context context, boolean isInDeveloperMode) {
        ...
        String[] specialLocaleCodes = resources.getStringArray(C3132R.array.special_locale_codes);
        String[] specialLocaleNames = resources.getStringArray(C3132R.array.special_locale_names);
    ...
    public static ArrayAdapter<LocaleInfo> constructAdapter(Context context) {
        return constructAdapter(context, C3132R.layout.locale_picker_item, C3132R.C3134id.locale);
    }
