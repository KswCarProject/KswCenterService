            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg2 = VoiceInteractor.Prompt.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg2 = null;
                        }
                        if (data.readInt() != 0) {
                    ...
                    case 2:
                        ...
                        if (data.readInt() != 0) {
                            _arg22 = VoiceInteractor.Prompt.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg22 = null;
                        }
                    ...
                    case 3:
                        ...
                        if (data.readInt() != 0) {
                            _arg23 = VoiceInteractor.Prompt.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg23 = null;
                        }
                        if (data.readInt() != 0) {
                            _arg32 = Bundle.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg32 = null;
                        }
                    ...
                    case 4:
                        ...
                        if (data.readInt() != 0) {
                            _arg24 = VoiceInteractor.Prompt.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg24 = null;
                        }
                        if (data.readInt() != 0) {
                            _arg33 = Bundle.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg33 = null;
                        }
                    ...
                    case 5:
                        ...
                        if (data.readInt() != 0) {
                            _arg34 = Bundle.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg34 = null;
                        }
