...
public class UnlaunchableAppActivity extends Activity implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mUserId == -10000) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle((CharSequence) dialogTitle).setMessage((CharSequence) getResources().getString(R.string.work_mode_off_message)).setOnDismissListener(this);
            if (this.mReason == 1) {
                builder.setPositiveButton((int) R.string.work_mode_turn_on, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
            } else {
