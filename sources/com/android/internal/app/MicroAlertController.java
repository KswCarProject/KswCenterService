...
public class MicroAlertController extends AlertController {
    ...
    protected void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) this.mWindow.findViewById(C3132R.C3134id.scrollView);
        ...
        if (this.mListView != null) {
            View topPanel = this.mScrollView.findViewById(C3132R.C3134id.topPanel);
            ...
            View buttonPanel = this.mScrollView.findViewById(C3132R.C3134id.buttonPanel);
