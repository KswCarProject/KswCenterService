...
public final class DumpUtils {
    ...
    static {
        ...
        STATE_LABELS[3] = "    Imp Bg";
        STATE_LABELS[4] = "    Backup";
        STATE_LABELS[5] = "   Service";
        STATE_LABELS[6] = "Service Rs";
        STATE_LABELS[7] = "  Receiver";
        STATE_LABELS[8] = " Heavy Wgt";
        STATE_LABELS[9] = "    (Home)";
        STATE_LABELS[10] = "(Last Act)";
        ...
        STATE_NAMES_CSV[7] = IncidentManager.URI_PARAM_RECEIVER_CLASS;
