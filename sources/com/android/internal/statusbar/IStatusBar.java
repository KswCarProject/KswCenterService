        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    StatusBarIcon _arg1 = data.readInt() != 0 ? StatusBarIcon.CREATOR.createFromParcel(data) : null;
                    setIcon(_arg0, _arg1);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    setSystemUiVisibility(_arg06, _arg13, _arg22, _arg3, _arg4, _arg5, _arg6, _arg7);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg07 = data.readInt();
                    boolean _arg14 = data.readInt() != 0;
                    topAppWindowChanged(_arg07, _arg14);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setImeWindowStatus(_arg08, _arg15, _arg23, _arg32, _arg42);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setWindowState(_arg09, _arg16, _arg24);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 22:
                    ...
                    appTransitionPending(_arg014);
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg015 = data.readInt();
                    appTransitionCancelled(_arg015);
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    appTransitionStarting(_arg016, _arg18, _arg25);
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg017 = data.readInt();
                    appTransitionFinished(_arg017);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 28:
                    ...
                    onCameraLaunchGestureDetected(_arg019);
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 31:
                    ...
                    onProposedRotationChanged(_arg020, _arg19);
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    ComponentName _arg024 = data.readInt() != 0 ? ComponentName.CREATOR.createFromParcel(data) : null;
                    clickQsTile(_arg024);
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg025 = data.readInt();
                    handleSystemKey(_arg025);
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg026 = data.readInt() != 0;
                    showPinningEnterExitToast(_arg026);
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg027 = data.readInt() != 0;
                    String _arg110 = data.readString();
                    showShutdownUi(_arg027, _arg110);
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _arg028 = data.readInt() != 0 ? Bundle.CREATOR.createFromParcel(data) : null;
                    IBiometricServiceReceiverInternal _arg111 = IBiometricServiceReceiverInternal.Stub.asInterface(data.readStrongBinder());
                    int _arg26 = data.readInt();
                    boolean _arg33 = data.readInt() != 0;
                    int _arg43 = data.readInt();
                    showBiometricDialog(_arg028, _arg111, _arg26, _arg33, _arg43);
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg029 = data.readInt() != 0;
                    String _arg112 = data.readString();
                    onBiometricAuthenticated(_arg029, _arg112);
                    return true;
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg030 = data.readString();
                    onBiometricHelp(_arg030);
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg031 = data.readString();
                    onBiometricError(_arg031);
                    return true;
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    hideBiometricDialog();
                ...
                case 45:
                    ...
                    onDisplayReady(_arg032);
                    return true;
                case 46:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg033 = data.readInt() != 0;
                    onRecentsAnimationStateChanged(_arg033);
                    return true;
                default:
