...
public class ScrimDrawable extends Drawable {
        ...
        if (animated) {
            ...
            anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.colorextraction.drawable.-$$Lambda$ScrimDrawable$UWtyAZ9Ss5P5TukFNvAyvh0pNf0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ScrimDrawable.lambda$setColor$0(ScrimDrawable.this, mainFrom, mainColor, valueAnimator);
                }
            });
    ...
    public static /* synthetic */ void lambda$setColor$0(ScrimDrawable scrimDrawable, int mainFrom, int mainColor, ValueAnimator animation) {
        ...
        scrimDrawable.mMainColor = ColorUtils.blendARGB(mainFrom, mainColor, ratio);
