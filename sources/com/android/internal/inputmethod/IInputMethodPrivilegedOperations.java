        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    setImeWindowStatus(_arg03, _arg1);
                ...
                case 3:
                    ...
                    IInputContentUriToken _result = createInputContentUriToken(_arg0, _arg12);
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    InputMethodSubtype _arg13 = data.readInt() != 0 ? InputMethodSubtype.CREATOR.createFromParcel(data) : null;
                    setInputMethodAndSubtype(_arg04, _arg13);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    updateStatusIcon(_arg05, _arg14);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    EditorInfo _arg06 = data.readInt() != 0 ? EditorInfo.CREATOR.createFromParcel(data) : null;
                    reportPreRendered(_arg06);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
