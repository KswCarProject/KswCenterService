            ...
            switch (i) {
                ...
                case 3:
                    while (true) {
                        int i3 = i2;
                        if (i3 < arrayLength) {
                            dataSize += CodedOutputByteBufferNano.computeInt64SizeNoTag(Array.getLong(array, i3));
                            i2 = i3 + 1;
                        } else {
                            return dataSize;
                        }
                ...
                case 4:
                    while (true) {
                        int i4 = i2;
                        if (i4 < arrayLength) {
                            dataSize += CodedOutputByteBufferNano.computeUInt64SizeNoTag(Array.getLong(array, i4));
                            i2 = i4 + 1;
                        } else {
                            return dataSize;
                        }
                ...
                case 5:
                    while (true) {
                        int i5 = i2;
                        if (i5 < arrayLength) {
                            dataSize += CodedOutputByteBufferNano.computeInt32SizeNoTag(Array.getInt(array, i5));
                            i2 = i5 + 1;
                        } else {
                            return dataSize;
                        }
                    ...
                    switch (i) {
                        case 13:
                            while (true) {
                                int i6 = i2;
                                if (i6 < arrayLength) {
                                    dataSize += CodedOutputByteBufferNano.computeUInt32SizeNoTag(Array.getInt(array, i6));
                                    i2 = i6 + 1;
                                } else {
                                    return dataSize;
                                }
                        ...
                        case 14:
                            while (true) {
                                int i7 = i2;
                                if (i7 < arrayLength) {
                                    dataSize += CodedOutputByteBufferNano.computeEnumSizeNoTag(Array.getInt(array, i7));
                                    i2 = i7 + 1;
                                } else {
                                    return dataSize;
                                }
                        ...
                        case 17:
                            while (true) {
                                int i8 = i2;
                                if (i8 < arrayLength) {
                                    dataSize += CodedOutputByteBufferNano.computeSInt32SizeNoTag(Array.getInt(array, i8));
                                    i2 = i8 + 1;
                                } else {
                                    return dataSize;
                                }
                        ...
                        case 18:
                            while (true) {
                                int i9 = i2;
                                if (i9 < arrayLength) {
                                    dataSize += CodedOutputByteBufferNano.computeSInt64SizeNoTag(Array.getLong(array, i9));
                                    i2 = i9 + 1;
                                } else {
                                    return dataSize;
                                }
