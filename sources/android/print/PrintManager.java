...
public final class PrintManager {
    ...
    public PrintManager getGlobalPrintManagerForUser(int userId) {
        if (this.mService == null) {
            Log.m64w(LOG_TAG, "Feature android.software.print not available");
            return null;
        }
            ...
            try {
                ...
                if (result != null) {
                    ...
                    try {
                        ...
                        Log.m69e(LOG_TAG, "Couldn't start print job config activity.", sie);
                    }
                }
                return null;
            } catch (RemoteException re) {
    ...
    public void removePrintServicesChangeListener(PrintServicesChangeListener listener) {
        ...
        if (this.mService == null) {
            ...
            try {
                ...
                Log.m69e(LOG_TAG, "Error removing print services change listener", re);
            }
        }
    }
    ...
    public void setPrintServiceEnabled(ComponentName service, boolean isEnabled) {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error enabling or disabling " + service, re);
        }
    }
    ...
    public static final class PrintDocumentAdapterDelegate extends IPrintDocumentAdapter.Stub implements Application.ActivityLifecycleCallbacks {
        ...
        public void setObserver(IPrintDocumentAdapterObserver observer) {
            ...
            if (destroyed && observer != null) {
                try {
                    ...
                    Log.m69e(PrintManager.LOG_TAG, "Error announcing destroyed state", re);
                }
            }
        }
        ...
        public void layout(PrintAttributes oldAttributes, PrintAttributes newAttributes, ILayoutResultCallback callback, Bundle metadata, int sequence) {
            ...
            try {
                ...
                Log.m69e(PrintManager.LOG_TAG, "Error notifying for layout start", re);
            }
        }
        ...
        public void write(PageRange[] pages, ParcelFileDescriptor fd, IWriteResultCallback callback, int sequence) {
            ...
            try {
                ...
                Log.m69e(PrintManager.LOG_TAG, "Error notifying for write start", re);
            }
        }
        ...
        private final class MyLayoutResultCallback extends PrintDocumentAdapter.LayoutResultCallback implements DestroyableCallback {
            ...
            public void onLayoutFinished(PrintDocumentInfo info, boolean changed) {
                ...
                if (callback == null) {
                    Log.m70e(PrintManager.LOG_TAG, "PrintDocumentAdapter is destroyed. Did you finish the printing activity before print completion or did you invoke a callback after finish?");
                    return;
                }
                try {
                    if (info == null) {
                    ...
                    try {
                        ...
                        Log.m69e(PrintManager.LOG_TAG, "Error calling onLayoutFinished", re);
                    }
                } finally {
                    destroy();
                }
            ...
            public void onLayoutFailed(CharSequence error) {
                ...
                try {
                    try {
                        ...
                        Log.m69e(PrintManager.LOG_TAG, "Error calling onLayoutFailed", re);
                    }
                } finally {
                    destroy();
                }
            ...
            public void onWriteFinished(PageRange[] pages) {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.m69e(PrintManager.LOG_TAG, "Error calling onWriteFinished", re);
                    }
                } finally {
                    destroy();
                }
            ...
            public void onWriteFailed(CharSequence error) {
                ...
                try {
                    try {
                        ...
                        Log.m69e(PrintManager.LOG_TAG, "Error calling onWriteFailed", re);
                    }
                } finally {
                    destroy();
                }
            ...
            public void onWriteCancelled() {
                ...
                try {
                    try {
                        ...
                        Log.m69e(PrintManager.LOG_TAG, "Error calling onWriteCanceled", re);
                    }
                } finally {
                    destroy();
                }
