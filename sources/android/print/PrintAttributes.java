...
public final class PrintAttributes implements Parcelable {
    ...
    public int hashCode() {
        int i = 0;
        int result = ((((((((1 * 31) + this.mColorMode) * 31) + this.mDuplexMode) * 31) + (this.mMinMargins == null ? 0 : this.mMinMargins.hashCode())) * 31) + (this.mMediaSize == null ? 0 : this.mMediaSize.hashCode())) * 31;
        if (this.mResolution != null) {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_INDEX_3X5 = new MediaSize("NA_INDEX_3X5", "android", R.string.mediasize_na_index_3x5, PathInterpolatorCompat.MAX_NUM_POINTS, 5000);
        ...
        public MediaSize(String id, String packageName, int labelResId, int widthMils, int heightMils) {
            this(id, (String) null, packageName, widthMils, heightMils, labelResId);
            sIdToMediaSizeMap.put(this.mId, this);
        }

        public MediaSize(String id, String label, int widthMils, int heightMils) {
            this(id, label, (String) null, widthMils, heightMils, 0);
        }
