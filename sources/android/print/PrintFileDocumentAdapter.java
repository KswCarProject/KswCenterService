    ...
    private final class WriteFileAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Void... r7) {
            /*
                r6 = this;
                r0 = 0
                java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
                android.print.PrintFileDocumentAdapter r2 = android.print.PrintFileDocumentAdapter.this     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
                java.io.File r2 = android.print.PrintFileDocumentAdapter.access$000(r2)     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
                r1.<init>(r2)     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
                ...
                android.p007os.FileUtils.copy(r1, r2, r3, r0, r0)     // Catch: java.lang.Throwable -> L27
                $closeResource(r0, r2)     // Catch: java.lang.Throwable -> L34
                $closeResource(r0, r1)     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
                goto L5a
            L24:
                r3 = move-exception
                r4 = r0
            ...
            L36:
                ...
                r2 = r5
            L3a:
                $closeResource(r3, r1)     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
                throw r2     // Catch: java.io.IOException -> L3e android.p007os.OperationCanceledException -> L59
            L3e:
                r1 = move-exception
                java.lang.String r2 = "PrintedFileDocAdapter"
                java.lang.String r3 = "Error writing data!"
                android.util.Log.m69e(r2, r3, r1)
        ...
        public void onCancelled(Void result) {
            this.mResultCallback.onWriteFailed(PrintFileDocumentAdapter.this.mContext.getString(C3132R.string.write_fail_reason_cancelled));
        }
    }
}
