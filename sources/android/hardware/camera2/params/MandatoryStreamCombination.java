    ...
    public static final class Builder {
        ...
        private Size getMaxRecordingSize() {
            ...
            if (!CamcorderProfile.hasProfile(this.mCameraId, 8)) {
                i = CamcorderProfile.hasProfile(this.mCameraId, 6) ? 6 : CamcorderProfile.hasProfile(this.mCameraId, 5) ? 5 : CamcorderProfile.hasProfile(this.mCameraId, 4) ? 4 : CamcorderProfile.hasProfile(this.mCameraId, 7) ? 7 : CamcorderProfile.hasProfile(this.mCameraId, 3) ? 3 : CamcorderProfile.hasProfile(this.mCameraId, 2) ? 2 : -1;
            }
            int quality = i;
            if (quality < 0) {
                return null;
