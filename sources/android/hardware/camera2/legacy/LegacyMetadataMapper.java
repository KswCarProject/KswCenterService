...
public class LegacyMetadataMapper {
    ...
    private static void mapControlAe(CameraMetadataNative m, Camera.Parameters p) {
        ...
        if (fpsRanges != null) {
            ...
            if (rangesSize > 0) {
                ...
                int[] aeAvail = ArrayUtils.convertStringListToIntArray(p.getSupportedFlashModes(), new String[]{"off", "auto", "on", Camera.Parameters.FLASH_MODE_RED_EYE, Camera.Parameters.FLASH_MODE_TORCH}, new int[]{1, 2, 3, 4});
    ...
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0065 A[RETURN] */
    ...
    private static int convertAntiBandingMode(java.lang.String r7) {
        /*
            r0 = -1
        ...
        L_0x0004:
            ...
            r2 = 1628397(0x18d8ed, float:2.28187E-39)
            if (r1 == r2) goto L_0x0035
            r2 = 1658188(0x194d4c, float:2.323616E-39)
        ...
        L_0x004d:
            java.lang.String r1 = "LegacyMetadataMapper"
            java.lang.StringBuilder r2 = new java.lang.StringBuilder
            r2.<init>()
            java.lang.String r3 = "convertAntiBandingMode - Unknown antibanding mode "
            r2.append(r3)
            r2.append(r7)
