...
public class CameraDeviceImpl extends CameraDevice implements IBinder.DeathRecipient {
    ...
    public void setRemoteFailure(ServiceSpecificException failure) {
        ...
        if (i == 4) {
            ...
            switch (i) {
                ...
                default:
                    String str = this.TAG;
                    Log.m70e(str, "Unexpected failure in opening camera device: " + failure.errorCode + failure.getMessage());
                    break;
            }
        } else {
            failureCode = 4;
                ...
                try {
                    try {
                        ...
                        if (sessionParams != null) {
                            ...
                            this.mRemoteDevice.endConfigure(operatingMode2, null);
                        }
                    ...
                    Log.m64w(this.TAG, "Stream configuration failed due to: " + e2.getMessage());
    ...
    public void checkEarlyTriggerSequenceComplete(final int requestId, long lastFrameNumber, int[] repeatingRequestTypes) {
        if (lastFrameNumber == -1) {
            ...
            Log.m64w(this.TAG, String.format("did not register callback to request %d", Integer.valueOf(requestId)));
            return;
        }
    ...
    private void checkInputConfiguration(InputConfiguration inputConfig) {
        if (inputConfig != null) {
            ...
            if (isPrivilegedApp()) {
                Log.m64w(this.TAG, "ignore input format/size check for white listed app");
                return;
            }
        ...
        public void updateTracker(long frameNumber, boolean isError, int requestType) {
            if (isError) {
                ...
                try {
                    ...
                    Log.m70e(CameraDeviceImpl.this.TAG, e.getMessage());
                }
            }
            update();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:47:0x00ad -> B:45:0x00ab). Please submit an issue!!! */
    public void checkAndFireSequenceComplete() {
        ...
        while (true) {
            ...
            synchronized (this.mInterfaceLock) {
                try {
                    if (this.mRemoteDevice == null) {
                        Log.m64w(this.TAG, "Camera closed while checking sequences");
                        return;
                    }
                    int index = this.mCaptureCallbackMap.indexOfKey(requestId);
                    if (index >= 0) {
    ...
    public class CameraDeviceCallbacks extends ICameraDeviceCallbacks.Stub {
        ...
        @Override // android.hardware.camera2.ICameraDeviceCallbacks.Stub, android.p007os.IInterface
            ...
            synchronized (CameraDeviceImpl.this.mInterfaceLock) {
                ...
                switch (errorCode) {
                    ...
                    default:
                        ...
                        Log.m70e(str, "Unknown error from camera device: " + errorCode);
                    ...
                    try {
                        try {
                            ...
                            if (holder2 == null) {
                                ...
                                final CameraMetadataNative resultCopy = cameraMetadataNative;
                                if (!isPartialResult) {
        ...
        public void onPrepared(int streamId) {
            ...
            if (output == null) {
                Log.m64w(CameraDeviceImpl.this.TAG, "onPrepared invoked for unknown output Surface");
                return;
            }
    ...
    public void binderDied() {
        String str = this.TAG;
        Log.m64w(str, "CameraDevice " + this.mCameraId + " died unexpectedly");
        if (this.mRemoteDevice == null) {
            return;
        }
        this.mInError = true;
