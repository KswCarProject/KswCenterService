...
public final class SetupDataCallResult {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ...
            hwParcel.readEmbeddedBuffer((long) (_hidl_vec_element.getBytes().length + 1), childBlob.handle(), (long) ((_hidl_index_0 * 16) + i), false);
            this.addresses.add(_hidl_vec_element);
            _hidl_index_0++;
            _hidl_vec_size = _hidl_vec_size;
            i = 0;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_05 < _hidl_vec_size4) {
                childBlob4.putString((long) (_hidl_index_05 * 16), this.pcscf.get(_hidl_index_05));
