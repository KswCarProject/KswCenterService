...
public final class CellIdentity {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size3 * 80), _hidl_blob.handle(), _hidl_offset + 24 + 0, true);
        ...
        HwBlob childBlob3 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size4 * 56), _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
        ...
        HwBlob childBlob4 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size5 * 88), _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        ...
        HwBlob childBlob5 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size6 * 88), _hidl_blob.handle(), 0 + _hidl_offset + 72, true);
