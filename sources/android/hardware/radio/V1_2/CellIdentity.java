...
public final class CellIdentity {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_02 * 80);
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size2; _hidl_index_03++) {
            ...
            _hidl_vec_element2.readEmbeddedFromParcel(parcel, childBlob2, _hidl_index_03 * 80);
        ...
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size3; _hidl_index_04++) {
            ...
            _hidl_vec_element3.readEmbeddedFromParcel(parcel, childBlob3, _hidl_index_04 * 56);
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size4; _hidl_index_05++) {
            ...
            _hidl_vec_element4.readEmbeddedFromParcel(parcel, childBlob4, _hidl_index_05 * 88);
            this.cellIdentityLte.add(_hidl_vec_element4);
        }
        int _hidl_vec_size5 = _hidl_blob.getInt32(_hidl_offset + 72 + 8);
        HwBlob childBlob5 = parcel.readEmbeddedBuffer(_hidl_vec_size5 * 88, _hidl_blob.handle(), 0 + _hidl_offset + 72, true);
        ...
        while (true) {
            ...
            if (_hidl_index_06 < _hidl_vec_size5) {
                ...
                _hidl_vec_element5.readEmbeddedFromParcel(parcel, childBlob5, _hidl_index_06 * 88);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            this.cellIdentityGsm.get(_hidl_index_02).writeEmbeddedToBlob(childBlob, _hidl_index_02 * 80);
        }
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size2; _hidl_index_03++) {
            this.cellIdentityWcdma.get(_hidl_index_03).writeEmbeddedToBlob(childBlob2, _hidl_index_03 * 80);
        }
        ...
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size3; _hidl_index_04++) {
            this.cellIdentityCdma.get(_hidl_index_04).writeEmbeddedToBlob(childBlob3, _hidl_index_04 * 56);
        }
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size4; _hidl_index_05++) {
            this.cellIdentityLte.get(_hidl_index_05).writeEmbeddedToBlob(childBlob4, _hidl_index_05 * 88);
        }
        ...
        while (true) {
            int _hidl_index_06 = _hidl_index_0;
            if (_hidl_index_06 < _hidl_vec_size5) {
                this.cellIdentityTdscdma.get(_hidl_index_06).writeEmbeddedToBlob(childBlob5, _hidl_index_06 * 88);
                _hidl_index_0 = _hidl_index_06 + 1;
            } else {
