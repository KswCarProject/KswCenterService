...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_02 * 96);
        ...
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size3; _hidl_index_04++) {
            ...
            _hidl_vec_element3.readEmbeddedFromParcel(parcel, childBlob3, _hidl_index_04 * 112);
        ...
        for (int _hidl_index_05 = 0; _hidl_index_05 < _hidl_vec_size4; _hidl_index_05++) {
            ...
            _hidl_vec_element4.readEmbeddedFromParcel(parcel, childBlob4, _hidl_index_05 * 96);
            this.wcdma.add(_hidl_vec_element4);
        }
        int _hidl_vec_size5 = _hidl_blob.getInt32(_hidl_offset + 88 + 8);
        HwBlob childBlob5 = parcel.readEmbeddedBuffer(_hidl_vec_size5 * 104, _hidl_blob.handle(), 0 + _hidl_offset + 88, true);
        this.tdscdma.clear();
        while (true) {
            ...
            _hidl_vec_element5.readEmbeddedFromParcel(parcel, childBlob5, _hidl_index_06 * 104);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_06 < _hidl_vec_size5) {
                this.tdscdma.get(_hidl_index_06).writeEmbeddedToBlob(childBlob5, _hidl_index_06 * 104);
