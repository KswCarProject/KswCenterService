...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size3 * 80), _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
        this.cdma.clear();
        ...
        HwBlob childBlob3 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size4 * 112), _hidl_blob.handle(), _hidl_offset + 56 + 0, true);
        this.lte.clear();
        ...
        HwBlob childBlob4 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size5 * 96), _hidl_blob.handle(), _hidl_offset + 72 + 0, true);
        this.wcdma.clear();
        ...
        HwBlob childBlob5 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size6 * 104), _hidl_blob.handle(), 0 + _hidl_offset + 88, true);
        this.tdscdma.clear();
        while (true) {
            int _hidl_index_06 = _hidl_index_0;
            if (_hidl_index_06 < _hidl_vec_size6) {
                CellInfoTdscdma _hidl_vec_element5 = new CellInfoTdscdma();
                _hidl_vec_element5.readEmbeddedFromParcel(hwParcel, childBlob5, (long) (_hidl_index_06 * 104));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_06 < _hidl_vec_size5) {
                this.tdscdma.get(_hidl_index_06).writeEmbeddedToBlob(childBlob5, (long) (_hidl_index_06 * 104));
