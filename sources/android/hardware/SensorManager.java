        ...
        if ((X & 124) == 0 && (Y & 124) == 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (i3 < i) {
                        if (x == i3) {
                            outR[offset + i3] = sx ? -inR[offset + 0] : inR[offset + 0];
                        }
                        if (y == i3) {
                            outR[offset + i3] = sy ? -inR[offset + 1] : inR[offset + 1];
                        }
                        if (z == i3) {
                            outR[offset + i3] = sz ? -inR[offset + 2] : inR[offset + 2];
                        }
                        i2 = i3 + 1;
                        i = 3;
                    }
    ...
    private LegacySensorManager getLegacySensorManager() {
        ...
        synchronized (this.mSensorListByType) {
            if (this.mLegacySensorManager == null) {
                Log.m68i(TAG, "This application is using deprecated SensorManager API which will be removed someday.  Please consider switching to the new API.");
