    ...
    public static abstract class Stub extends Binder implements IUsbManager {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    UsbDevice _arg04 = data.readInt() != 0 ? UsbDevice.CREATOR.createFromParcel(data) : null;
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    UsbAccessory _arg05 = data.readInt() != 0 ? UsbAccessory.CREATOR.createFromParcel(data) : null;
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    boolean hasDevicePermission = hasDevicePermission(data.readInt() != 0 ? UsbDevice.CREATOR.createFromParcel(data) : null, data.readString());
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    requestDevicePermission(_arg0, _arg14, _arg23);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    requestAccessoryPermission(_arg02, _arg15, _arg24);
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    grantDevicePermission(data.readInt() != 0 ? UsbDevice.CREATOR.createFromParcel(data) : null, data.readInt());
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    grantAccessoryPermission(data.readInt() != 0 ? UsbAccessory.CREATOR.createFromParcel(data) : null, data.readInt());
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    ...
                    setCurrentFunction(_arg06, _arg1);
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 24:
                    ...
                    setPortRoles(_arg07, _arg16, _arg25);
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _arg1 = data.readInt() != 0;
                    enableContaminantDetection(_arg08, _arg1);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
