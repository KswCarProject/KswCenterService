        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    IFaceServiceReceiver _arg24 = IFaceServiceReceiver.Stub.asInterface(data.readStrongBinder());
                    String _arg34 = data.readString();
                    int[] _arg44 = data.createIntArray();
                    enroll(_arg06, _arg15, _arg24, _arg34, _arg44);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    ...
                    remove(_arg08, _arg16, _arg25, _arg35);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 20:
                    ...
                    setFeature(_arg020, _arg112, _arg27, _arg36);
                    reply.writeNoException();
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg021 = data.readInt();
                    IFaceServiceReceiver _arg113 = IFaceServiceReceiver.Stub.asInterface(data.readStrongBinder());
                    getFeature(_arg021, _arg113);
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
