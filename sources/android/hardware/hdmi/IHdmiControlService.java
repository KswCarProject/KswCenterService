        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        int _result6 = getPhysicalAddress();
                        reply.writeNoException();
                    ...
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        List<HdmiDeviceInfo> _result7 = getInputDevices();
                        reply.writeNoException();
                        reply.writeTypedList(_result7);
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        List<HdmiDeviceInfo> _result8 = getDeviceList();
                        reply.writeNoException();
        ...
        private static class Proxy implements IHdmiControlService {
            ...
            public HdmiDeviceInfo getActiveSource() throws RemoteException {
                ...
                try {
                    ...
                    HdmiDeviceInfo _result2 = _result;
                    _reply.recycle();
                    _data.recycle();
                    return _result2;
                } finally {
