        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    boolean appSaturationLevel = setAppSaturationLevel(_arg02, _arg1);
                    reply.writeNoException();
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    boolean nightDisplayActivated = setNightDisplayActivated(data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0 ? Time.CREATOR.createFromParcel(data) : null;
                ...
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0 ? Time.CREATOR.createFromParcel(data) : null;
                    boolean nightDisplayCustomEndTime = setNightDisplayCustomEndTime(_arg0);
                    reply.writeNoException();
