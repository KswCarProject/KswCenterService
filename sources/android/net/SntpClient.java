...
public class SntpClient {
    ...
    public boolean requestTime(String host, int timeout, Network network) {
        ...
        try {
            ...
            Log.m72d(TAG, "request time failed: " + e);
            return false;
        }
    }
    ...
    public boolean requestTime(InetAddress address, int port, int timeout, Network network) {
        ...
        try {
            try {
                ...
                Log.m72d(TAG, "round trip: " + roundTripTime + "ms, clock offset: " + clockOffset + DateFormat.MINUTE_SECOND);
    ...
    public boolean requestTime(String host, int timeout) {
        Log.m64w(TAG, "Shame on you for calling the hidden API requestTime()!");
        return false;
    }
    ...
    private long read32(byte[] buffer, int offset) {
        ...
        int i0 = (b0 & 128) == 128 ? (b0 & Bidi.LEVEL_DEFAULT_RTL) + 128 : b0;
        int i1 = (b1 & 128) == 128 ? (b1 & Bidi.LEVEL_DEFAULT_RTL) + 128 : b1;
        int i2 = (b2 & 128) == 128 ? (b2 & Bidi.LEVEL_DEFAULT_RTL) + 128 : b2;
        int i3 = (b3 & 128) == 128 ? 128 + (b3 & Bidi.LEVEL_DEFAULT_RTL) : b3;
