...
public class WifiAwareManager {
    ...
    public NetworkSpecifier createNetworkSpecifier(int clientId, int role, int sessionId, PeerHandle peerHandle, byte[] pmk, String passphrase) {
        ...
        return new WifiAwareNetworkSpecifier(peerHandle == null ? 1 : 0, role, clientId, sessionId, peerHandle != null ? peerHandle.peerId : 0, null, pmk, passphrase, 0, -1, Process.myUid());
    }
    ...
    */
    public NetworkSpecifier createNetworkSpecifier(int clientId, int role, byte[] peer, byte[] pmk, String passphrase) {
        ...
        return new WifiAwareNetworkSpecifier(peer == null ? 3 : 2, role, clientId, 0, 0, peer, pmk, passphrase, 0, -1, Process.myUid());
    }
        ...
        WifiAwareEventCallbackProxy(WifiAwareManager mgr, Looper looper, Binder binder, final AttachCallback attachCallback, final IdentityChangedListener identityChangedListener) {
            ...
            this.mHandler = new Handler(looper) { // from class: android.net.wifi.aware.WifiAwareManager.WifiAwareEventCallbackProxy.1
                ...
                public void handleMessage(Message msg) {
                    ...
                    if (mgr2 == null) {
                        Log.m64w(WifiAwareManager.TAG, "WifiAwareEventCallbackProxy: handleMessage post GC");
                        return;
                    }
                    switch (msg.what) {
                        case 0:
                        ...
                        case 2:
                            if (identityChangedListener == null) {
                                Log.m70e(WifiAwareManager.TAG, "CALLBACK_IDENTITY_CHANGED: null listener.");
                                return;
                            } else {
    ...
    private static class WifiAwareDiscoverySessionCallbackProxy extends IWifiAwareDiscoverySessionCallback.Stub {
            ...
            this.mHandler = new Handler(looper) { // from class: android.net.wifi.aware.WifiAwareManager.WifiAwareDiscoverySessionCallbackProxy.1
                ...
                public void handleMessage(Message msg) {
                    ...
                    if (WifiAwareDiscoverySessionCallbackProxy.this.mAwareManager.get() == null) {
                        Log.m64w(WifiAwareManager.TAG, "WifiAwareDiscoverySessionCallbackProxy: handleMessage post GC");
                        return;
                    }
                    switch (msg.what) {
                        case 0:
                        ...
                        case 8:
                            ...
                            try {
                                ...
                                matchFilter = null;
                                Log.m70e(WifiAwareManager.TAG, "onServiceDiscovered: invalid match filter byte array '" + new String(HexEncoding.encode(arg)) + "' - cannot be parsed: e=" + e);
                            }
                            if (msg.what == 4) {
        ...
        public void onProxySessionStarted(int sessionId) {
            if (this.mSession != null) {
                Log.m70e(WifiAwareManager.TAG, "onSessionStarted: sessionId=" + sessionId + ": session already created!?");
            ...
            if (mgr == null) {
                Log.m64w(WifiAwareManager.TAG, "onProxySessionStarted: mgr GC'd");
        ...
        public void onProxySessionTerminated(int reason) {
            if (this.mSession != null) {
                ...
                Log.m64w(WifiAwareManager.TAG, "Proxy: onSessionTerminated called but mSession is null!?");
            }
