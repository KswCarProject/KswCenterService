        ...
        public WifiAwareNetworkSpecifier build() {
            if (this.mDiscoverySession == null) {
                ...
                if (!(this.mPskPassphrase != null) || !(this.mPmk != null)) {
                    ...
                    return new WifiAwareNetworkSpecifier(0, role, this.mDiscoverySession.mClientId, this.mDiscoverySession.mSessionId, this.mPeerHandle.peerId, (byte[]) null, this.mPmk, this.mPskPassphrase, this.mPort, this.mTransportProtocol, Process.myUid());
                }
