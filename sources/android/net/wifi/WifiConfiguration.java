...
public class WifiConfiguration implements Parcelable {
    ...
    public static class KeyMgmt {
        ...
        public static final String[] strings = {KeyProperties.DIGEST_NONE, "WPA_PSK", "WPA_EAP", "IEEE8021X", "WPA2_PSK", "OSEN", "FT_PSK", "FT_EAP", "SAE", "OWE", "SUITE_B_192", "WPA_PSK_SHA256", "WPA_EAP_SHA256", "FILS_SHA256", "FILS_SHA384", "DPP"};
    ...
    public boolean isEnterprise() {
        return ((!this.allowedKeyManagement.get(2) && !this.allowedKeyManagement.get(3) && !this.allowedKeyManagement.get(10)) || this.enterpriseConfig == null || this.enterpriseConfig.getEapMethod() == -1) ? false : true;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.shareThisAp ? 1 : 0);
