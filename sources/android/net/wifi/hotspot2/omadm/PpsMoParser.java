    ...
    public static PasspointConfiguration parseMoText(String xmlString) {
        ...
        try {
            ...
            if (root.getTag() != TAG_MANAGEMENT_TREE) {
                Log.m70e(TAG, "Root is not a MgmtTree");
                return null;
            }
            String verDtd = null;
            ...
            for (XMLNode child : root.getChildren()) {
                ...
                switch (c) {
                    case 0:
                        if (verDtd != null) {
                            Log.m70e(TAG, "Duplicate VerDTD element");
                            return null;
                        }
                    ...
                    case 1:
                        if (config != null) {
                            Log.m70e(TAG, "Unexpected multiple Node element under MgmtTree");
                            return null;
                        }
                        try {
                    ...
                    default:
                        Log.m70e(TAG, "Unknown node: " + child.getTag());
                        return null;
                }
            }
            return config;
        ...
        for (PPSNode child : root.getChildren()) {
            ...
            switch (c) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    Log.m72d(TAG, "Ignore Extension node for vendor specific information");
                    break;
                default:
    ...
    private static void parseEAPMethod(PPSNode node, Credential.UserCredential userCred) throws ParsingException {
        ...
        for (PPSNode child : node.getChildren()) {
            ...
            switch (c) {
                ...
                case 5:
                case 6:
                    Log.m72d(TAG, "Ignore unsupported EAP method parameter: " + child.getName());
                    break;
                default:
        ...
        for (PPSNode child : node.getChildren()) {
            ...
            switch (c) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    Log.m72d(TAG, "Ignore unsupported paramter: " + child.getName());
                    break;
                default:
