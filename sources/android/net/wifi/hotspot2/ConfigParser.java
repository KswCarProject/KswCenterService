...
public final class ConfigParser {
    ...
    public static PasspointConfiguration parsePasspointConfig(String mimeType, byte[] data) {
        if (!TextUtils.equals(mimeType, TYPE_WIFI_CONFIG)) {
            Log.m70e(TAG, "Unexpected MIME type: " + mimeType);
            return null;
        }
        try {
            ...
            Log.m70e(TAG, "Failed to parse installation file: " + e.getMessage());
            return null;
        }
    }
        ...
        for (Map.Entry<String, String> entry : headers.entrySet()) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                default:
                    Log.m72d(TAG, "Ignore header: " + entry.getKey());
                    break;
            }
        }
        return header;
    ...
    private static Pair<String, String> parseContentType(String contentType) throws IOException {
        ...
        for (int i = 1; i < attributes.length; i++) {
            ...
            if (!attribute.startsWith(BOUNDARY)) {
                Log.m72d(TAG, "Ignore Content-Type attribute: " + attributes[i]);
            } else {
