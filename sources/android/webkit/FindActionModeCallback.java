...
public class FindActionModeCallback implements ActionMode.Callback, TextWatcher, View.OnClickListener, WebView.FindListener {
    ...
    public FindActionModeCallback(Context context) {
        this.mCustomView = LayoutInflater.from(context).inflate(C3132R.layout.webview_find, (ViewGroup) null);
        ...
        setText("");
        this.mMatches = (TextView) this.mCustomView.findViewById(C3132R.C3134id.matches);
    ...
    private void updateMatchesString() {
        if (this.mNumberOfMatches == 0) {
            this.mMatches.setText(C3132R.string.no_matches);
        } else {
            this.mMatches.setText(this.mResources.getQuantityString(C3132R.plurals.matches_found, this.mNumberOfMatches, Integer.valueOf(this.mActiveMatchIndex + 1), Integer.valueOf(this.mNumberOfMatches)));
        }
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        if (mode.isUiFocusable()) {
            ...
            mode.getMenuInflater().inflate(C3132R.C3135menu.webview_find, menu);
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        ...
        switch (item.getItemId()) {
            case C3132R.C3134id.find_next /* 16908919 */:
                findNext(true);
                break;
            case C3132R.C3134id.find_prev /* 16908920 */:
                findNext(false);
                break;
            default:
                return false;
