...
public class Surface implements Parcelable {
    public static final Parcelable.Creator<Surface> CREATOR = new Parcelable.Creator<Surface>() { // from class: android.view.Surface.1
        ...
        public Surface createFromParcel(Parcel source) {
            try {
                ...
                Log.m69e(Surface.TAG, "Exception creating surface from parcel", e);
                return null;
            }
        }
    ...
    private void unlockSwCanvasAndPost(Canvas canvas) {
        ...
        if (this.mNativeObject != this.mLockedObject) {
            Log.m64w(TAG, "WARNING: Surface's mNativeObject (0x" + Long.toHexString(this.mNativeObject) + ") != mLockedObject (0x" + Long.toHexString(this.mLockedObject) + ")");
        }
        if (this.mLockedObject == 0) {
