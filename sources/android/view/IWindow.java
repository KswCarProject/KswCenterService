    ...
    public static abstract class Stub extends Binder implements IWindow {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    insetsChanged(data.readInt() != 0 ? InsetsState.CREATOR.createFromParcel(data) : null);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    InsetsState _arg04 = data.readInt() != 0 ? InsetsState.CREATOR.createFromParcel(data) : null;
                ...
                case 8:
                    ...
                    _arg02 = data.readInt() != 0;
                    windowFocusChanged(_arg06, _arg02);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 10:
                    ...
                    dispatchWallpaperOffsets(_arg07, _arg16, _arg23, _arg32, _arg42);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    dispatchWallpaperCommand(_arg08, _arg17, _arg24, _arg33, _arg43, _arg52);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    DragEvent _arg09 = data.readInt() != 0 ? DragEvent.CREATOR.createFromParcel(data) : null;
                    dispatchDragEvent(_arg09);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    float _arg010 = data.readFloat();
                    float _arg18 = data.readFloat();
                    updatePointerIcon(_arg010, _arg18);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    dispatchSystemUiVisibilityChanged(_arg011, _arg19, _arg25, _arg34);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    dispatchWindowShown();
                ...
                case 16:
                    ...
                    requestAppKeyboardShortcuts(_arg012, _arg110);
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt() != 0;
