...
public class FocusFinder {
    ...
    */
    public View findNearestTouchable(ViewGroup root, int x, int y, int direction, int[] deltas) {
        ...
        int minDistance2 = 0;
        while (minDistance2 < numTouchables) {
            View touchable = touchables.get(minDistance2);
            ...
            if (focusFinder.isTouchCandidate(x, y, touchableBounds, direction)) {
                ...
                if (direction == 17) {
                    distance2 = (x - touchableBounds.right) + 1;
                } else if (direction == 33) {
                    int distance3 = touchableBounds.bottom;
                    distance2 = (y - distance3) + 1;
                } else {
                    if (direction == 66) {
