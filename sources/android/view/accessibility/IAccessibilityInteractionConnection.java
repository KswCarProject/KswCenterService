        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    Region _arg1 = data.readInt() != 0 ? Region.CREATOR.createFromParcel(data) : null;
                    ...
                    MagnificationSpec _arg7 = data.readInt() != 0 ? MagnificationSpec.CREATOR.createFromParcel(data) : null;
                    Bundle _arg8 = data.readInt() != 0 ? Bundle.CREATOR.createFromParcel(data) : null;
                    findAccessibilityNodeInfoByAccessibilityId(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7, _arg8);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    long _arg02 = data.readLong();
                    String _arg12 = data.readString();
                    Region _arg22 = data.readInt() != 0 ? Region.CREATOR.createFromParcel(data) : null;
                    ...
                    findAccessibilityNodeInfosByViewId(_arg02, _arg12, _arg22, _arg32, _arg42, _arg52, _arg62, _arg72, _arg82);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    long _arg03 = data.readLong();
                    String _arg13 = data.readString();
                    Region _arg23 = data.readInt() != 0 ? Region.CREATOR.createFromParcel(data) : null;
                    ...
                    findAccessibilityNodeInfosByText(_arg03, _arg13, _arg23, _arg33, _arg43, _arg53, _arg63, _arg73, _arg83);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    long _arg04 = data.readLong();
                    int _arg14 = data.readInt();
                    Region _arg24 = data.readInt() != 0 ? Region.CREATOR.createFromParcel(data) : null;
                    ...
                    findFocus(_arg04, _arg14, _arg24, _arg34, _arg44, _arg54, _arg64, _arg74, _arg84);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    long _arg05 = data.readLong();
                    int _arg15 = data.readInt();
                    Region _arg25 = data.readInt() != 0 ? Region.CREATOR.createFromParcel(data) : null;
                    ...
                    focusSearch(_arg05, _arg15, _arg25, _arg35, _arg45, _arg55, _arg65, _arg75, _arg85);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
