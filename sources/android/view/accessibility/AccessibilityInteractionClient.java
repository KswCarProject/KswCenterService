...
public final class AccessibilityInteractionClient extends IAccessibilityInteractionConnectionCallback.Stub {
    ...
    public AccessibilityWindowInfo getWindow(int connectionId, int accessibilityWindowId) {
        try {
            ...
            Log.m69e(LOG_TAG, "Error while calling remote getWindow", re);
            return null;
        }
    }
    ...
    public List<AccessibilityWindowInfo> getWindows(int connectionId) {
        try {
            ...
            Log.m69e(LOG_TAG, "Error while calling remote getWindows", re);
        }
                ...
                if (!bypassCache) {
                    try {
                        try {
                            ...
                            re = e;
                            Log.m69e(LOG_TAG, "Error while calling remote findAccessibilityNodeInfoByAccessibilityId", re);
                            return null;
                        }
        ...
        try {
            ...
            if (connection != null) {
                ...
                try {
                    ...
                    re = e;
                    Log.m63w(LOG_TAG, "Error while calling remote findAccessibilityNodeInfoByViewIdInActiveWindow", re);
                    return Collections.emptyList();
                }
            }
        } catch (RemoteException e2) {
        ...
        try {
            ...
            if (connection != null) {
                ...
                try {
                    ...
                    re = e;
                    Log.m63w(LOG_TAG, "Error while calling remote findAccessibilityNodeInfosByViewText", re);
                    return Collections.emptyList();
                }
            }
        } catch (RemoteException e2) {
        ...
        try {
            ...
            if (connection != null) {
                ...
                try {
                    ...
                    re = e;
                    Log.m63w(LOG_TAG, "Error while calling remote findFocus", re);
                    return null;
                }
            }
            return null;
        ...
        try {
            ...
            if (connection != null) {
                ...
                try {
                    ...
                    re = e;
                    Log.m63w(LOG_TAG, "Error while calling remote accessibilityFocusSearch", re);
                    return null;
                }
            }
            return null;
    ...
    public boolean performAccessibilityAction(int connectionId, int accessibilityWindowId, long accessibilityNodeId, int action, Bundle arguments) {
        try {
            ...
            Log.m63w(LOG_TAG, "Error while calling remote performAccessibilityAction", re);
            return false;
        }
    }
    ...
    private void checkFindAccessibilityNodeInfoResultIntegrity(List<AccessibilityNodeInfo> infos) {
        ...
        while (!fringe.isEmpty()) {
            ...
            if (!seen.add(current)) {
                Log.m70e(LOG_TAG, "Duplicate node.");
                return;
            }
        ...
        if (disconnectedCount > 0) {
            Log.m70e(LOG_TAG, disconnectedCount + " Disconnected nodes.");
        }
    }
}
