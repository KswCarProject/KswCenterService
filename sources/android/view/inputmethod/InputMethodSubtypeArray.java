...
public class InputMethodSubtypeArray {
    ...
    public void writeToParcel(Parcel dest) {
            ...
            synchronized (this.mLockObject) {
                ...
                if (compressedData == null && decompressedSize == 0) {
                    ...
                    if (compressedData == null) {
                        decompressedSize = -1;
                        Slog.m54i(TAG, "Failed to compress data.");
                    } else {
        ...
        Slog.m54i(TAG, "Unexpected state. Behaving as an empty array.");
        dest.writeInt(0);
    }
            ...
            synchronized (this.mLockObject) {
                ...
                if (instance == null) {
                    ...
                    if (decompressedData != null) {
                        ...
                        Slog.m56e(TAG, "Failed to decompress data. Returns null as fallback.");
    ...
    private static byte[] compress(byte[] r6) {
        ...
        L37:
            ...
            android.util.Slog.m55e(r2, r3, r1)
            return r0
        */
