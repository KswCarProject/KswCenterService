...
public final class DisplayCutout {
    ...
    public static DisplayCutout fromResourcesRectApproximation(Resources res, int displayWidth, int displayHeight) {
        return fromSpec(res.getString(C3132R.string.config_mainBuiltInDisplayCutoutRectApproximation), displayWidth, displayHeight, DisplayMetrics.DENSITY_DEVICE_STABLE / 160.0f);
    }

    public static Path pathFromResources(Resources res, int displayWidth, int displayHeight) {
        return pathAndDisplayCutoutFromSpec(res.getString(C3132R.string.config_mainBuiltInDisplayCutout), displayWidth, displayHeight, DisplayMetrics.DENSITY_DEVICE_STABLE / 160.0f).first;
    }
    ...
    private static void toRectAndAddToRegion(Path p, Region inoutRegion, Rect inoutRect) {
        ...
        inoutRegion.m125op(inoutRect, Region.EnumC0685Op.UNION);
    }
