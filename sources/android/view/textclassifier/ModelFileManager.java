...
public final class ModelFileManager {
    ...
    public static final class ModelFileSupplierImpl implements Supplier<List<ModelFile>> {
        ...
        /* JADX WARN: Type inference failed for: r1v0, types: [android.view.textclassifier.ModelFileManager$ModelFile, android.os.ParcelFileDescriptor] */
        private ModelFile createModelFile(File file) {
            String[] split;
            ParcelFileDescriptor modelFd = 0;
            if (file.exists()) {
                try {
                    ...
                    if (supportedLocalesStr.isEmpty()) {
                        Log.m40d(TextClassifier.DEFAULT_LOG_TAG, "Ignoring " + file.getAbsolutePath());
                        return modelFd;
                    }
                    ...
                    Log.m39e(TextClassifier.DEFAULT_LOG_TAG, "Failed to find " + file.getAbsolutePath(), e);
                    return modelFd;
                } finally {
        ...
        private static void maybeCloseAndLogError(ParcelFileDescriptor fd) {
            ...
            try {
                ...
                Log.m39e(TextClassifier.DEFAULT_LOG_TAG, "Error closing file.", e);
            }
        }
    }
