...
public final class LegacyClassificationIntentFactory implements ClassificationIntentFactory {
    ...
    private static List<LabeledIntent> createForEmail(Context context, String text) {
        ...
        actions.add(new LabeledIntent(context2.getString(R.string.email), (String) null, context2.getString(R.string.email_desc), (String) null, new Intent(Intent.ACTION_SENDTO).setData(Uri.parse(String.format("mailto:%s", new Object[]{str}))), 0));
        actions.add(new LabeledIntent(context2.getString(R.string.add_contact), (String) null, context2.getString(R.string.add_contact_desc), (String) null, new Intent(Intent.ACTION_INSERT_OR_EDIT).setType(ContactsContract.Contacts.CONTENT_ITEM_TYPE).putExtra("email", str), text.hashCode()));
        return actions;
    }
    ...
    private static List<LabeledIntent> createForPhone(Context context, String text) {
        ...
        if (!userRestrictions.getBoolean(UserManager.DISALLOW_OUTGOING_CALLS, false)) {
            actions.add(new LabeledIntent(context2.getString(R.string.dial), (String) null, context2.getString(R.string.dial_desc), (String) null, new Intent(Intent.ACTION_DIAL).setData(Uri.parse(String.format("tel:%s", new Object[]{str}))), 0));
        }
        actions.add(new LabeledIntent(context2.getString(R.string.add_contact), (String) null, context2.getString(R.string.add_contact_desc), (String) null, new Intent(Intent.ACTION_INSERT_OR_EDIT).setType(ContactsContract.Contacts.CONTENT_ITEM_TYPE).putExtra("phone", str), text.hashCode()));
        if (!userRestrictions.getBoolean(UserManager.DISALLOW_SMS, false)) {
            actions.add(new LabeledIntent(context2.getString(R.string.sms), (String) null, context2.getString(R.string.sms_desc), (String) null, new Intent(Intent.ACTION_SENDTO).setData(Uri.parse(String.format("smsto:%s", new Object[]{str}))), 0));
        }
        return actions;
    }
    ...
    private static List<LabeledIntent> createForAddress(Context context, String text) {
        ...
        try {
            ...
            actions.add(new LabeledIntent(context.getString(R.string.map), (String) null, context.getString(R.string.map_desc), (String) null, new Intent("android.intent.action.VIEW").setData(Uri.parse(String.format("geo:0,0?q=%s", new Object[]{encText}))), 0));
    ...
    private static List<LabeledIntent> createForUrl(Context context, String text) {
        ...
        List<LabeledIntent> actions = new ArrayList<>();
        actions.add(new LabeledIntent(context.getString(R.string.browse), (String) null, context.getString(R.string.browse_desc), (String) null, new Intent("android.intent.action.VIEW").setDataAndNormalize(Uri.parse(text)).putExtra(Browser.EXTRA_APPLICATION_ID, context.getPackageName()), 0));
        return actions;
    }
    ...
    private static List<LabeledIntent> createForFlight(Context context, String text) {
        List<LabeledIntent> actions = new ArrayList<>();
        actions.add(new LabeledIntent(context.getString(R.string.view_flight), (String) null, context.getString(R.string.view_flight_desc), (String) null, new Intent(Intent.ACTION_WEB_SEARCH).putExtra("query", text), text.hashCode()));
        return actions;
    }
    ...
    private static LabeledIntent createCalendarViewIntent(Context context, Instant parsedTime) {
        ...
        return new LabeledIntent(context.getString(R.string.view_calendar), (String) null, context.getString(R.string.view_calendar_desc), (String) null, new Intent("android.intent.action.VIEW").setData(builder.build()), 0);
    }

    private static LabeledIntent createCalendarCreateEventIntent(Context context, Instant parsedTime, String type) {
        return new LabeledIntent(context.getString(R.string.add_calendar_event), (String) null, context.getString(R.string.add_calendar_event_desc), (String) null, new Intent("android.intent.action.INSERT").setData(CalendarContract.Events.CONTENT_URI).putExtra("allDay", "date".equals(type)).putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME, parsedTime.toEpochMilli()).putExtra(CalendarContract.EXTRA_EVENT_END_TIME, parsedTime.toEpochMilli() + DEFAULT_EVENT_DURATION), parsedTime.hashCode());
    }

    private static List<LabeledIntent> createForDictionary(Context context, String text) {
        List<LabeledIntent> actions = new ArrayList<>();
        actions.add(new LabeledIntent(context.getString(R.string.define), (String) null, context.getString(R.string.define_desc), (String) null, new Intent(Intent.ACTION_DEFINE).putExtra(Intent.EXTRA_TEXT, text), text.hashCode()));
        return actions;
    }
}
