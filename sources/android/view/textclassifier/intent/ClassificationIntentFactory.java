...
public interface ClassificationIntentFactory {
    ...
    static void insertTranslateAction(List<LabeledIntent> actions, Context context, String text) {
        actions.add(new LabeledIntent(context.getString(R.string.translate), (String) null, context.getString(R.string.translate_desc), (String) null, new Intent(Intent.ACTION_TRANSLATE).putExtra(Intent.EXTRA_TEXT, text), text.hashCode()));
    }
}
