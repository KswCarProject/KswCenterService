...
public final class TextClassificationConstants {
    ...
    public void dump(IndentingPrintWriter pw) {
        ...
        pw.increaseIndent();
        pw.printPair(CLASSIFY_TEXT_MAX_RANGE_LENGTH, (Object) Integer.valueOf(getClassifyTextMaxRangeLength())).println();
        pw.printPair("detect_language_from_text_enabled", (Object) Boolean.valueOf(isDetectLanguagesFromTextEnabled())).println();
        pw.printPair(ENTITY_LIST_DEFAULT, (Object) getEntityListDefault()).println();
        pw.printPair(ENTITY_LIST_EDITABLE, (Object) getEntityListEditable()).println();
        pw.printPair(ENTITY_LIST_NOT_EDITABLE, (Object) getEntityListNotEditable()).println();
        pw.printPair(GENERATE_LINKS_LOG_SAMPLE_RATE, (Object) Integer.valueOf(getGenerateLinksLogSampleRate())).println();
        pw.printPair(GENERATE_LINKS_MAX_TEXT_LENGTH, (Object) Integer.valueOf(getGenerateLinksMaxTextLength())).println();
        pw.printPair(IN_APP_CONVERSATION_ACTION_TYPES_DEFAULT, (Object) getInAppConversationActionTypes()).println();
        pw.printPair(LANG_ID_CONTEXT_SETTINGS, (Object) Arrays.toString(getLangIdContextSettings())).println();
        pw.printPair(LANG_ID_THRESHOLD_OVERRIDE, (Object) Float.valueOf(getLangIdThresholdOverride())).println();
        pw.printPair(LOCAL_TEXT_CLASSIFIER_ENABLED, (Object) Boolean.valueOf(isLocalTextClassifierEnabled())).println();
        pw.printPair(MODEL_DARK_LAUNCH_ENABLED, (Object) Boolean.valueOf(isModelDarkLaunchEnabled())).println();
        pw.printPair(NOTIFICATION_CONVERSATION_ACTION_TYPES_DEFAULT, (Object) getNotificationConversationActionTypes()).println();
        pw.printPair(SMART_LINKIFY_ENABLED, (Object) Boolean.valueOf(isSmartLinkifyEnabled())).println();
        pw.printPair(SMART_SELECT_ANIMATION_ENABLED, (Object) Boolean.valueOf(isSmartSelectionAnimationEnabled())).println();
        pw.printPair(SMART_SELECTION_ENABLED, (Object) Boolean.valueOf(isSmartSelectionEnabled())).println();
        pw.printPair(SMART_TEXT_SHARE_ENABLED, (Object) Boolean.valueOf(isSmartTextShareEnabled())).println();
        pw.printPair(SUGGEST_SELECTION_MAX_RANGE_LENGTH, (Object) Integer.valueOf(getSuggestSelectionMaxRangeLength())).println();
        pw.printPair(SYSTEM_TEXT_CLASSIFIER_ENABLED, (Object) Boolean.valueOf(isSystemTextClassifierEnabled())).println();
        pw.printPair(TEMPLATE_INTENT_FACTORY_ENABLED, (Object) Boolean.valueOf(isTemplateIntentFactoryEnabled())).println();
        pw.printPair(TRANSLATE_IN_CLASSIFICATION_ENABLED, (Object) Boolean.valueOf(isTranslateInClassificationEnabled())).println();
        pw.decreaseIndent();
    }
}
