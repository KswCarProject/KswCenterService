...
public class Spinner extends AbsSpinner implements DialogInterface.OnClickListener {
    ...
    public Spinner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, int mode, Resources.Theme popupTheme) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C3132R.styleable.Spinner, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C3132R.styleable.Spinner, attrs, a, defStyleAttr, defStyleRes);
        if (popupTheme != null) {
        ...
        switch (mode == -1 ? a.getInt(5, 0) : mode) {
            ...
            case 1:
                ...
                TypedArray pa = this.mPopupContext.obtainStyledAttributes(attrs, C3132R.styleable.Spinner, defStyleAttr, defStyleRes);
    ...
    public void setPopupBackgroundDrawable(Drawable background) {
        if (!(this.mPopup instanceof DropdownPopup)) {
            Log.m70e(TAG, "setPopupBackgroundDrawable: incompatible spinner mode; ignoring...");
        } else {
    ...
    public void setDropDownWidth(int pixels) {
        if (!(this.mPopup instanceof DropdownPopup)) {
            Log.m70e(TAG, "Cannot set dropdown width for MODE_DIALOG, ignoring");
        } else {
    ...
    static class SavedState extends AbsSpinner.SavedState {
        ...
        @Override // android.widget.AbsSpinner.SavedState, android.view.View.BaseSavedState, android.view.AbsSavedState, android.p007os.Parcelable
    ...
    private class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void setBackgroundDrawable(Drawable bg) {
            Log.m70e(Spinner.TAG, "Cannot set popup background for MODE_DIALOG, ignoring");
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public void setVerticalOffset(int px) {
            Log.m70e(Spinner.TAG, "Cannot set vertical offset for MODE_DIALOG, ignoring");
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public void setHorizontalOffset(int px) {
            Log.m70e(Spinner.TAG, "Cannot set horizontal offset for MODE_DIALOG, ignoring");
        }
