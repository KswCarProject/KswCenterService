...
class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        View view = ((LayoutInflater) context2.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(layoutResourceId, (ViewGroup) this.mDelegator, true);
        ...
        AnonymousClass1 r19 = r2;
        init(this.mCurrentDate.get(1), this.mCurrentDate.get(2), this.mCurrentDate.get(5), (DatePicker.OnDateChangedListener) null);
        reorderSpinners();
