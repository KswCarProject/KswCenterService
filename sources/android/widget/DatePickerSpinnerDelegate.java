...
class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C3132R.styleable.DatePicker, defStyleAttr, defStyleRes);
        ...
        int layoutResourceId = attributesArray.getResourceId(20, C3132R.layout.date_picker_legacy);
        ...
        this.mSpinners = (LinearLayout) view2.findViewById(C3132R.C3134id.pickers);
        this.mCalendarView = (CalendarView) this.mDelegator.findViewById(C3132R.C3134id.calendar_view);
        ...
        this.mDaySpinner = (NumberPicker) this.mDelegator.findViewById(C3132R.C3134id.day);
        ...
        this.mDaySpinnerInput = (EditText) this.mDaySpinner.findViewById(C3132R.C3134id.numberpicker_input);
        this.mMonthSpinner = (NumberPicker) this.mDelegator.findViewById(C3132R.C3134id.month);
        ...
        this.mMonthSpinnerInput = (EditText) this.mMonthSpinner.findViewById(C3132R.C3134id.numberpicker_input);
        this.mYearSpinner = (NumberPicker) this.mDelegator.findViewById(C3132R.C3134id.year);
        this.mYearSpinner.setOnLongPressUpdateInterval(100L);
        this.mYearSpinner.setOnValueChangedListener(onChangeListener);
        this.mYearSpinnerInput = (EditText) this.mYearSpinner.findViewById(C3132R.C3134id.numberpicker_input);
    ...
    private void setImeOptions(NumberPicker spinner, int spinnerCount, int spinnerIndex) {
        ...
        TextView input = (TextView) spinner.findViewById(C3132R.C3134id.numberpicker_input);
        input.setImeOptions(imeOptions);
    }

    private void setContentDescriptions() {
        trySetContentDescription(this.mDaySpinner, C3132R.C3134id.increment, C3132R.string.date_picker_increment_day_button);
        trySetContentDescription(this.mDaySpinner, C3132R.C3134id.decrement, C3132R.string.date_picker_decrement_day_button);
        trySetContentDescription(this.mMonthSpinner, C3132R.C3134id.increment, C3132R.string.date_picker_increment_month_button);
        trySetContentDescription(this.mMonthSpinner, C3132R.C3134id.decrement, C3132R.string.date_picker_decrement_month_button);
        trySetContentDescription(this.mYearSpinner, C3132R.C3134id.increment, C3132R.string.date_picker_increment_year_button);
        trySetContentDescription(this.mYearSpinner, C3132R.C3134id.decrement, C3132R.string.date_picker_decrement_year_button);
    }
