...
class DatePickerCalendarDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C3132R.styleable.DatePicker, defStyleAttr, defStyleRes);
        LayoutInflater inflater = (LayoutInflater) this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        int layoutResourceId = a.getResourceId(19, C3132R.layout.date_picker_material);
        ...
        ViewGroup header = (ViewGroup) this.mContainer.findViewById(C3132R.C3134id.date_picker_header);
        this.mHeaderYear = (TextView) header.findViewById(C3132R.C3134id.date_picker_header_year);
        this.mHeaderYear.setOnClickListener(this.mOnHeaderClickListener);
        this.mHeaderMonthDay = (TextView) header.findViewById(C3132R.C3134id.date_picker_header_date);
        ...
        a.recycle();
        this.mAnimator = (ViewAnimator) this.mContainer.findViewById(C3132R.C3134id.animator);
        this.mDayPickerView = (DayPickerView) this.mAnimator.findViewById(C3132R.C3134id.date_picker_day_picker);
        ...
        this.mYearPickerView = (YearPickerView) this.mAnimator.findViewById(C3132R.C3134id.date_picker_year_picker);
        ...
        this.mSelectDay = res.getString(C3132R.string.select_day);
        this.mSelectYear = res.getString(C3132R.string.select_year);
    ...
    public static /* synthetic */ void lambda$new$0(DatePickerCalendarDelegate datePickerCalendarDelegate, View v) {
        ...
        switch (v.getId()) {
            case C3132R.C3134id.date_picker_header_date /* 16908861 */:
                datePickerCalendarDelegate.setCurrentView(0);
                return;
            case C3132R.C3134id.date_picker_header_year /* 16908862 */:
