...
public abstract class CompoundButton extends Button implements Checkable {
    ...
    public CompoundButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C3132R.styleable.CompoundButton, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C3132R.styleable.CompoundButton, attrs, a, defStyleAttr, defStyleRes);
