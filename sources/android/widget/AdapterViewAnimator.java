    ...
    public void refreshChildren() {
        if (this.mAdapter != null) {
            for (int i = this.mCurrentWindowStart; i <= this.mCurrentWindowEnd; i++) {
                ...
                View updatedChild = this.mAdapter.getView(modulo(i, getCount()), (View) null, this);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (action != 6) {
            switch (action) {
                case 0:
                    View v = getCurrentView();
                    if (v != null && isTransformedTouchPointInView(ev.getX(), ev.getY(), v, (PointF) null)) {
                ...
                case 1:
                    if (this.mTouchMode == 1) {
                        ...
                        if (v2 != null && isTransformedTouchPointInView(ev.getX(), ev.getY(), v2, (PointF) null)) {
