...
public class RelativeLayout extends ViewGroup {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = context.obtainStyledAttributes(attrs, C3132R.styleable.RelativeLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C3132R.styleable.RelativeLayout, attrs, a, defStyleAttr, defStyleRes);
    ...
    */
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int count4 = getContext().getApplicationInfo().targetSdkVersion;
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (isWrapContentWidth) {
                    if (isLayoutRtl()) {
                        ...
                        myHeight = myHeight2;
                        width3 = count4 < 19 ? Math.max(width3, params2.mRight) : Math.max(width3, params2.mRight + params2.rightMargin);
                    }
                } else {
                    myHeight = myHeight2;
                }
                if (isWrapContentHeight2) {
                    height3 = count4 < 19 ? Math.max(height3, params2.mBottom) : Math.max(height3, params2.mBottom + params2.bottomMargin);
                }
                if (child2 != ignore2 || verticalGravity) {
                    left = Math.min(left, params2.mLeft - params2.leftMargin);
                    bottom = Math.min(bottom, params2.mTop - params2.topMargin);
                }
                if (child2 != ignore2 || horizontalGravity) {
                    ...
                    bottom2 = Math.max(bottom2, right3 + top2);
                    right = right2;
                    bottom = top;
                }
            } else {
        ...
        int i6 = 0;
        while (true) {
            int targetSdkVersion2 = count4;
            targetSdkVersion = count6;
            if (i6 >= targetSdkVersion) {
                break;
            }
            View child3 = views5[i6];
            int myWidth2 = myWidth;
            int myWidth3 = child3.getVisibility();
            ...
            i6++;
            count6 = targetSdkVersion;
            count4 = targetSdkVersion2;
            myWidth = myWidth2;
            ignore2 = ignore3;
        }
        ...
        if (isWrapContentWidth) {
            ...
            if (offsetHorizontalAxis) {
                int i7 = 0;
                while (i7 < targetSdkVersion) {
                    View child4 = views5[i7];
        ...
        if (isWrapContentHeight2) {
            ...
            if (offsetVerticalAxis) {
                int i8 = 0;
                while (i8 < targetSdkVersion) {
                    View child5 = views5[i8];
                    if (child5.getVisibility() == 8) {
                        ...
                        int[] rules2 = params4.getRules(layoutDirection4);
                        if (rules2[13] != 0) {
                            isWrapContentHeight = isWrapContentHeight2;
                        } else if (rules2[15] != 0) {
                            isWrapContentHeight = isWrapContentHeight2;
        ...
        if (horizontalGravity || verticalGravity) {
            ...
            Gravity.apply(this.mGravity, right4 - left, bottom3 - bottom, selfBounds, contentBounds, layoutDirection4);
            int horizontalOffset = contentBounds.left - left;
            int verticalOffset = contentBounds.top - bottom;
            if (horizontalOffset != 0 || verticalOffset != 0) {
                int i9 = 0;
                while (i9 < targetSdkVersion) {
                    Rect selfBounds2 = selfBounds;
                    View child6 = views5[i9];
                    int top3 = bottom;
                    int top4 = child6.getVisibility();
                ...
                if (isLayoutRtl()) {
                    int offsetWidth = myWidth4 - width3;
                    int i10 = 0;
                    while (true) {
                        int i11 = i10;
                        if (i11 >= targetSdkVersion) {
                            break;
                        }
                        View child7 = views5[i11];
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        @UnsupportedAppUsage
        private int mRight;
        @ViewDebug.ExportedProperty(category = TtmlUtils.TAG_LAYOUT, indexMapping = {@ViewDebug.IntToString(from = 2, m46to = "above"), @ViewDebug.IntToString(from = 4, m46to = "alignBaseline"), @ViewDebug.IntToString(from = 8, m46to = "alignBottom"), @ViewDebug.IntToString(from = 5, m46to = "alignLeft"), @ViewDebug.IntToString(from = 12, m46to = "alignParentBottom"), @ViewDebug.IntToString(from = 9, m46to = "alignParentLeft"), @ViewDebug.IntToString(from = 11, m46to = "alignParentRight"), @ViewDebug.IntToString(from = 10, m46to = "alignParentTop"), @ViewDebug.IntToString(from = 7, m46to = "alignRight"), @ViewDebug.IntToString(from = 6, m46to = "alignTop"), @ViewDebug.IntToString(from = 3, m46to = "below"), @ViewDebug.IntToString(from = 14, m46to = "centerHorizontal"), @ViewDebug.IntToString(from = 13, m46to = "center"), @ViewDebug.IntToString(from = 15, m46to = "centerVertical"), @ViewDebug.IntToString(from = 0, m46to = "leftOf"), @ViewDebug.IntToString(from = 1, m46to = "rightOf"), @ViewDebug.IntToString(from = 18, m46to = "alignStart"), @ViewDebug.IntToString(from = 19, m46to = "alignEnd"), @ViewDebug.IntToString(from = 20, m46to = "alignParentStart"), @ViewDebug.IntToString(from = 21, m46to = "alignParentEnd"), @ViewDebug.IntToString(from = 16, m46to = "startOf"), @ViewDebug.IntToString(from = 17, m46to = "endOf")}, mapping = {@ViewDebug.IntToString(from = -1, m46to = "true"), @ViewDebug.IntToString(from = 0, m46to = "false/NO_ID")}, resolveId = true)
        private int[] mRules;
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, C3132R.styleable.RelativeLayout_Layout);
