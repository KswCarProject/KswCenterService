...
public class RcsMessageStore {
    ...
    public RcsThreadQueryResult getRcsThreads(final RcsThreadQueryParams queryParameters) throws RcsMessageStoreException {
        return new RcsThreadQueryResult(this.mRcsControllerCall, (RcsThreadQueryResultParcelable) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$z090Zf4wxRrBwUxXanwm4N3vb7w
    ...
    public RcsThreadQueryResult getRcsThreads(final RcsQueryContinuationToken continuationToken) throws RcsMessageStoreException {
        return new RcsThreadQueryResult(this.mRcsControllerCall, (RcsThreadQueryResultParcelable) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$XArwINUevYo-Ol_OgZskFwRkGhs
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
    ...
    public RcsParticipantQueryResult getRcsParticipants(final RcsParticipantQueryParams queryParameters) throws RcsMessageStoreException {
        return new RcsParticipantQueryResult(this.mRcsControllerCall, (RcsParticipantQueryResultParcelable) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$720PbSnOJzhKXiqHw1UEfx5w-6A
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
    ...
    public RcsParticipantQueryResult getRcsParticipants(final RcsQueryContinuationToken continuationToken) throws RcsMessageStoreException {
        return new RcsParticipantQueryResult(this.mRcsControllerCall, (RcsParticipantQueryResultParcelable) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$tSyQsX68KutSWLEXxfgNSJ47ep0
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
    ...
    public RcsMessageQueryResult getRcsMessages(final RcsMessageQueryParams queryParams) throws RcsMessageStoreException {
        return new RcsMessageQueryResult(this.mRcsControllerCall, (RcsMessageQueryResultParcelable) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$5QXAY7bGFdmsWgLF0pk1tyYYovg
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
    ...
    public RcsMessageQueryResult getRcsMessages(final RcsQueryContinuationToken continuationToken) throws RcsMessageStoreException {
        return new RcsMessageQueryResult(this.mRcsControllerCall, (RcsMessageQueryResultParcelable) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$fs2V7Gtqd2gkYR7NanLG2NjZNho
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
    ...
    public Rcs1To1Thread createRcs1To1Thread(final RcsParticipant recipient) throws RcsMessageStoreException {
        return new Rcs1To1Thread(this.mRcsControllerCall, ((Integer) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$eOFObBGn-N5PMKJvVTBw06iJWQ4
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
                Integer valueOf;
    ...
    public RcsParticipant createRcsParticipant(final String canonicalAddress, final String alias) throws RcsMessageStoreException {
        return new RcsParticipant(this.mRcsControllerCall, ((Integer) this.mRcsControllerCall.call(new RcsControllerCall.RcsServiceCall() { // from class: android.telephony.ims.-$$Lambda$RcsMessageStore$d1Om4XlR70Dyh7qD9d6F4NZZkQI
            @Override // android.telephony.ims.RcsControllerCall.RcsServiceCall
            public final Object methodOnIRcs(IRcs iRcs, String str) {
                Integer valueOf;
