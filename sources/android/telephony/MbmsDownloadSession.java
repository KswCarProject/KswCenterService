...
public class MbmsDownloadSession implements AutoCloseable {
    ...
    /* access modifiers changed from: private */
    public AtomicReference<IMbmsDownloadService> mService = new AtomicReference<>((Object) null);
    /* access modifiers changed from: private */
    ...
    public static MbmsDownloadSession create(Context context, Executor executor, int subscriptionId, final MbmsDownloadSessionCallback callback) {
        if (sIsInitialized.compareAndSet(false, true)) {
            ...
            executor.execute(new Runnable() {
                public void run() {
                    MbmsDownloadSessionCallback.this.onError(result, (String) null);
                }
            });
            return null;
        }
    ...
    private int bindAndInitialize() {
        return MbmsUtils.startBinding(this.mContext, MBMS_DOWNLOAD_SERVICE_ACTION, new ServiceConnection() {
            ...
            public void onServiceDisconnected(ComponentName name) {
                ...
                MbmsDownloadSession.sIsInitialized.set(false);
                MbmsDownloadSession.this.mService.set((Object) null);
            }
        });
    }
    ...
    public void requestUpdateFileServices(List<String> classList) {
        ...
        if (downloadService != null) {
            try {
                ...
                if (returnCode != -1) {
                    if (returnCode != 0) {
                        sendErrorToApp(returnCode, (String) null);
                    }
                    return;
                }
                close();
                ...
                try {
                    ...
                    try {
                        ...
                        if (result == -1) {
                            ...
                            sendErrorToApp(result, (String) null);
                        } else {
    ...
    public File getTempFileRootDirectory() {
        String path = this.mContext.getSharedPreferences(MbmsTempFileProvider.TEMP_FILE_ROOT_PREF_FILE_NAME, 0).getString(MbmsTempFileProvider.TEMP_FILE_ROOT_PREF_NAME, (String) null);
        if (path != null) {
    ...
    public void download(DownloadRequest request) {
        IMbmsDownloadService downloadService = this.mService.get();
        if (downloadService != null) {
            if (this.mContext.getSharedPreferences(MbmsTempFileProvider.TEMP_FILE_ROOT_PREF_FILE_NAME, 0).getString(MbmsTempFileProvider.TEMP_FILE_ROOT_PREF_NAME, (String) null) == null) {
