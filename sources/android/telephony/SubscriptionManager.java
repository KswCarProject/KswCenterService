...
public class SubscriptionManager {
    ...
    public static class OnSubscriptionsChangedListener {
        ...
        private void log(String s) {
            Rlog.m88d(SubscriptionManager.LOG_TAG, s);
        }
    }
    ...
    public void addOnSubscriptionsChangedListener(OnSubscriptionsChangedListener listener) {
        ...
        try {
            ...
            Log.m70e(LOG_TAG, "Remote exception ITelephonyRegistry " + ex);
        }
    }
    ...
    public static class OnOpportunisticSubscriptionsChangedListener {
        IOnSubscriptionsChangedListener callback = new BinderC24171();
        ...
        /* renamed from: android.telephony.SubscriptionManager$OnOpportunisticSubscriptionsChangedListener$1 */
        /* loaded from: classes.dex */
        class BinderC24171 extends IOnSubscriptionsChangedListener.Stub {
            BinderC24171() {
            }
    ...
    public List<SubscriptionInfo> getActiveSubscriptionInfoList(boolean userVisibleOnly) {
        ...
        return (List) activeList.stream().filter(new Predicate() { // from class: android.telephony.-$$Lambda$SubscriptionManager$R_uORt9bKcmEo6JnjiGP2KgjIOQ
            ...
            public final boolean test(Object obj) {
                boolean isSubscriptionVisible;
                isSubscriptionVisible = SubscriptionManager.this.isSubscriptionVisible((SubscriptionInfo) obj);
    ...
    public void addSubscriptionInfoRecord(String uniqueId, String displayName, int slotIndex, int subscriptionType) {
        if (uniqueId == null) {
            Log.m70e(LOG_TAG, "[addSubscriptionInfoRecord]- uniqueId is null");
            return;
        }
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
            if (iSub == null) {
                Log.m70e(LOG_TAG, "[addSubscriptionInfoRecord]- ISub service is null");
                return;
            }
            int result = iSub.addSubInfo(uniqueId, displayName, slotIndex, subscriptionType);
            if (result < 0) {
                Log.m70e(LOG_TAG, "Adding of subscription didn't succeed: error = " + result);
                return;
            }
    ...
    public void removeSubscriptionInfoRecord(String uniqueId, int subscriptionType) {
        ...
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
            if (iSub == null) {
                Log.m70e(LOG_TAG, "[removeSubscriptionInfoRecord]- ISub service is null");
                return;
            }
            int result = iSub.removeSubInfo(uniqueId, subscriptionType);
            if (result < 0) {
                Log.m70e(LOG_TAG, "Removal of subscription didn't succeed: error = " + result);
                return;
            }
    ...
    private static void logd(String msg) {
        Rlog.m88d(LOG_TAG, msg);
    }

    private static void loge(String msg) {
        Rlog.m86e(LOG_TAG, msg);
    }
    ...
    public void setPreferredDataSubscriptionId(int subId, boolean needValidation, Executor executor, Consumer<Integer> callback) {
        try {
            ...
            ISetOpportunisticDataCallback callbackStub = new BinderC24161(executor, callback);
    ...
    /* loaded from: classes.dex */
    class BinderC24161 extends ISetOpportunisticDataCallback.Stub {
        final /* synthetic */ Consumer val$callback;
        final /* synthetic */ Executor val$executor;

        BinderC24161(Executor executor, Consumer consumer) {
    ...
    public boolean setOpportunistic(final boolean opportunistic, final int subId) {
        return setSubscriptionPropertyHelper(subId, "setOpportunistic", new CallISubMethodHelper() { // from class: android.telephony.-$$Lambda$SubscriptionManager$NazcIP1h3U0cfnY--L174e3u4tk
            ...
            public final int callMethod(ISub iSub) {
                int opportunistic2;
                opportunistic2 = iSub.setOpportunistic(opportunistic, subId, SubscriptionManager.this.mContext.getOpPackageName());
                return opportunistic2;
            }
        }) == 1;
    }
    ...
    public boolean isSubscriptionVisible(SubscriptionInfo info) {
        ...
        return TelephonyManager.from(this.mContext).hasCarrierPrivileges(info.getSubscriptionId()) || (info.isEmbedded() && canManageSubscription(info));
    }
