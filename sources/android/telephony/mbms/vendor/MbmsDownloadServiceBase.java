...
public class MbmsDownloadServiceBase extends IMbmsDownloadService.Stub {
    ...
    @Override // android.telephony.mbms.vendor.IMbmsDownloadService.Stub, android.p007os.IInterface
    @SystemApi
    public IBinder asBinder() {
        return super.asBinder();
    }

    @Override // android.telephony.mbms.vendor.IMbmsDownloadService.Stub, android.p007os.Binder
    @SystemApi
