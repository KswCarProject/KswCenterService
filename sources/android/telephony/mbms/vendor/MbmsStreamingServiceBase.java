...
public class MbmsStreamingServiceBase extends IMbmsStreamingService.Stub {
    ...
    @Override // android.telephony.mbms.vendor.IMbmsStreamingService.Stub, android.p007os.IInterface
    @SystemApi
    public IBinder asBinder() {
        return super.asBinder();
    }

    @Override // android.telephony.mbms.vendor.IMbmsStreamingService.Stub, android.p007os.Binder
    @SystemApi
