...
public class MbmsGroupCallSession implements AutoCloseable {
    ...
    /* access modifiers changed from: private */
    public AtomicReference<IMbmsGroupCallService> mService = new AtomicReference<>((Object) null);
    /* access modifiers changed from: private */
    ...
    public static MbmsGroupCallSession create(Context context, int subscriptionId, Executor executor, final MbmsGroupCallSessionCallback callback) {
        if (sIsInitialized.compareAndSet(false, true)) {
            ...
            executor.execute(new Runnable() {
                public void run() {
                    MbmsGroupCallSessionCallback.this.onError(result, (String) null);
                }
            });
            return null;
        }
        ...
        if (groupCallService != null) {
            ...
            try {
                ...
                if (returnCode == -1) {
                    ...
                    this.mInternalCallback.onError(returnCode, (String) null);
                    return null;
                }
            } catch (RemoteException e) {
                ...
                this.mService.set((Object) null);
                sIsInitialized.set(false);
                this.mInternalCallback.onError(3, (String) null);
                return null;
            }
        } else {
    ...
    private int bindAndInitialize() {
        return MbmsUtils.startBinding(this.mContext, MBMS_GROUP_CALL_SERVICE_ACTION, new ServiceConnection() {
            ...
            public void onServiceDisconnected(ComponentName name) {
                MbmsGroupCallSession.sIsInitialized.set(false);
                MbmsGroupCallSession.this.mService.set((Object) null);
            }
        });
    }
}
