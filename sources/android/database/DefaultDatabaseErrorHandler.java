...
public final class DefaultDatabaseErrorHandler implements DatabaseErrorHandler {
    ...
    public void onCorruption(SQLiteDatabase dbObj) {
        Log.m70e(TAG, "Corruption reported by sqlite on database: " + dbObj.getPath());
    ...
    private void deleteDatabaseFile(String fileName) {
        ...
        Log.m70e(TAG, "deleting the database file: " + fileName);
        try {
            SQLiteDatabase.deleteDatabase(new File(fileName), false);
        } catch (Exception e) {
            Log.m64w(TAG, "delete failed: " + e.getMessage());
        }
    }
}
