...
public final class SQLiteConnection implements CancellationSignal.OnCancelListener {
    ...
    private void maybeTruncateWalFile() {
        ...
        Log.m68i(TAG, walFile.getAbsolutePath() + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + size + " bytes: Bigger than " + threshold + "; truncating");
        try {
            executeForString("PRAGMA wal_checkpoint(TRUNCATE)", null, null);
        } catch (SQLiteException e) {
            Log.m63w(TAG, "Failed to truncate the -wal file", e);
        }
    }
    ...
    private void setJournalMode(String newValue) {
        ...
        if (!value.equalsIgnoreCase(newValue)) {
            ...
            Log.m64w(TAG, "Could not change the database journal mode of '" + this.mConfiguration.label + "' from '" + value + "' to '" + newValue + "' because the database is locked.  This usually means that there are other open connections to the database which prevents the database from enabling or disabling write-ahead logging mode.  Proceeding without changing the journal mode.");
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v1, types: [android.os.CancellationSignal, java.lang.Object[]] */
    private void setLocaleFromConfiguration() {
        ...
        try {
            ...
            try {
                ...
                execute(success != 0 ? "COMMIT" : "ROLLBACK", null, null);
            }
        } catch (SQLiteException ex) {
            throw ex;
    ...
    /* JADX WARN: Type inference failed for: r19v0, types: [android.database.sqlite.SQLiteConnection] */
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        ...
        */
    void collectDbStats(java.util.ArrayList<android.database.sqlite.SQLiteDebug.DbStats> r28) {
        /*
    ...
    private static final class OperationLog {
        ...
        public int beginOperation(String kind, String sql, Object[] bindArgs) {
            ...
            synchronized (this.mOperations) {
                ...
                int i4 = newOperationCookieLocked(index);
                operation.mCookie = i4;
        ...
        private void logOperationLocked(int cookie, String detail) {
            ...
            Log.m72d(SQLiteConnection.TAG, msg.toString());
        }
            ...
            synchronized (this.mOperations) {
                ...
                if (operation != null) {
                    ...
                    do {
                        ...
                        n++;
                        operation = this.mOperations[index2];
                        if (operation == null) {
                            break;
                        }
                    } while (n < 20);
