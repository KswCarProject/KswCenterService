    ...
    */
    public boolean onMove(int oldPosition, int newPosition) {
        ...
        try {
            ...
            Log.m70e(TAG, "Unable to get window because the remote process is dead");
            return false;
        }
    }
    ...
    public void deactivate() {
        ...
        if (this.mBulkCursor != null) {
            try {
                ...
                Log.m64w(TAG, "Remote process exception when deactivating");
            }
        }
    }
        ...
        if (this.mBulkCursor != null) {
            try {
                try {
                    ...
                    Log.m64w(TAG, "Remote process exception when closing");
                }
            } finally {
    ...
    public boolean requery() {
        ...
        try {
            ...
            Log.m70e(TAG, "Unable to requery because the remote process exception " + ex.getMessage());
            deactivate();
            return false;
        }
    }
    ...
    public Bundle respond(Bundle extras) {
        ...
        try {
            ...
            Log.m63w(TAG, "respond() threw RemoteException, returning an empty bundle.", e);
            return Bundle.EMPTY;
        }
    }
}
