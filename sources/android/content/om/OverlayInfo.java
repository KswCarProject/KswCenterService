...
public final class OverlayInfo implements Parcelable {
    ...
    public int hashCode() {
        int i = 0;
        int result = ((((((((((((1 * 31) + this.userId) * 31) + this.state) * 31) + (this.packageName == null ? 0 : this.packageName.hashCode())) * 31) + (this.targetPackageName == null ? 0 : this.targetPackageName.hashCode())) * 31) + (this.targetOverlayableName == null ? 0 : this.targetOverlayableName.hashCode())) * 31) + (this.category == null ? 0 : this.category.hashCode())) * 31;
