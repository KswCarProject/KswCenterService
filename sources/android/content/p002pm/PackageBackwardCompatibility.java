...
import android.content.p002pm.PackageBackwardCompatibility;
...
@VisibleForTesting
/* renamed from: android.content.pm.PackageBackwardCompatibility */
...
public class PackageBackwardCompatibility extends PackageSharedLibraryUpdater {
    ...
    private static boolean addOptionalUpdater(List<PackageSharedLibraryUpdater> packageUpdaters, String className, Supplier<PackageSharedLibraryUpdater> defaultUpdater) {
        ...
        try {
            ...
            String str = TAG;
            Log.m68i(str, "Loaded " + className);
        } catch (ClassNotFoundException e) {
            String str2 = TAG;
            Log.m68i(str2, "Could not find " + className + ", ignoring");
            cls = null;
        }
    ...
    @VisibleForTesting
    /* renamed from: android.content.pm.PackageBackwardCompatibility$AndroidTestRunnerSplitUpdater */
    /* loaded from: classes.dex */
    ...
    @VisibleForTesting
    /* renamed from: android.content.pm.PackageBackwardCompatibility$RemoveUnnecessaryOrgApacheHttpLegacyLibrary */
    /* loaded from: classes.dex */
    ...
    @VisibleForTesting
    /* renamed from: android.content.pm.PackageBackwardCompatibility$RemoveUnnecessaryAndroidTestBaseLibrary */
    /* loaded from: classes.dex */
