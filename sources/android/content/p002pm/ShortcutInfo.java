...
public final class ShortcutInfo implements Parcelable {
    ...
    public static String getDisabledReasonForRestoreIssue(Context context, int disabledReason) {
        ...
        if (disabledReason != 3) {
            switch (disabledReason) {
                case 100:
                    return res.getString(C3132R.string.shortcut_restored_on_lower_version);
                case 101:
                    return res.getString(C3132R.string.shortcut_restore_not_supported);
                case 102:
                    return res.getString(C3132R.string.shortcut_restore_signature_mismatch);
                case 103:
                    return res.getString(C3132R.string.shortcut_restore_unknown_issue);
                default:
                    return null;
            }
        }
        return res.getString(C3132R.string.shortcut_disabled_reason_unknown);
    }
    ...
    private CharSequence getResourceString(Resources res, int resId, CharSequence defValue) {
        try {
            ...
            Log.m70e(TAG, "Resource for ID=" + resId + " not found in package " + this.mPackageName);
            return defValue;
        }
    }
    ...
    public static String lookUpResourceName(Resources res, int resId, boolean withType, String packageName) {
        ...
        try {
            ...
            Log.m70e(TAG, "Resource name for ID=" + resId + " not found in package " + packageName + ". Resource IDs may change when the application is upgraded, and the system may not be able to find the correct resource.");
            return null;
        }
    }
    ...
    public static int lookUpResourceId(Resources res, String resourceName, String resourceType, String packageName) {
        try {
            ...
            Log.m70e(TAG, "Resource ID for name=" + resourceName + " not found in package " + packageName);
            return 0;
        }
    }
    ...
    public UserHandle getUserHandle() {
        return UserHandle.m110of(this.mUserId);
    }
