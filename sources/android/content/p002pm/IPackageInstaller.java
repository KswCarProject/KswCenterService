        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    PackageInstaller.SessionParams _arg0 = data.readInt() != 0 ? PackageInstaller.SessionParams.CREATOR.createFromParcel(data) : null;
                    PackageInstaller.SessionParams _arg02 = _arg0;
                    String _arg1 = data.readString();
                    int _arg2 = data.readInt();
                    int _result = createSession(_arg02, _arg1, _arg2);
                ...
                case 2:
                    ...
                    updateSessionAppIcon(_arg03, _arg12);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    VersionedPackage _arg012 = data.readInt() != 0 ? VersionedPackage.CREATOR.createFromParcel(data) : null;
                    String _arg16 = data.readString();
                    int _arg22 = data.readInt();
                    IntentSender _arg3 = data.readInt() != 0 ? IntentSender.CREATOR.createFromParcel(data) : null;
                    int _arg4 = data.readInt();
                    uninstall(_arg012, _arg16, _arg22, _arg3, _arg4);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    IntentSender _arg32 = data.readInt() != 0 ? IntentSender.CREATOR.createFromParcel(data) : null;
                    int _arg42 = data.readInt();
                    List<String> _arg5 = data.createStringArrayList();
                    installExistingPackage(_arg013, _arg17, _arg23, _arg32, _arg42, _arg5);
                    reply.writeNoException();
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setPermissionsResult(_arg014, _arg18);
                    reply.writeNoException();
                    return true;
                default:
