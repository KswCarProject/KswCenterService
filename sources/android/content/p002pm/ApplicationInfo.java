...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    public static CharSequence getCategoryTitle(Context context, int category) {
        switch (category) {
            case 0:
                return context.getText(C3132R.string.app_category_game);
            case 1:
                return context.getText(C3132R.string.app_category_audio);
            case 2:
                return context.getText(C3132R.string.app_category_video);
            case 3:
                return context.getText(C3132R.string.app_category_image);
            case 4:
                return context.getText(C3132R.string.app_category_social);
            case 5:
                return context.getText(C3132R.string.app_category_news);
            case 6:
                return context.getText(C3132R.string.app_category_maps);
            case 7:
                return context.getText(C3132R.string.app_category_productivity);
            default:
                return null;
        }
    }
    ...
    @Override // android.content.p002pm.PackageItemInfo, android.p007os.Parcelable
    ...
    public Drawable loadDefaultIcon(PackageManager pm) {
        if ((this.flags & 262144) != 0 && isPackageUnavailable(pm)) {
            return Resources.getSystem().getDrawable(C3132R.C3133drawable.sym_app_on_sd_unavailable_icon);
        }
