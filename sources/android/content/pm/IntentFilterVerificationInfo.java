...
public final class IntentFilterVerificationInfo implements Parcelable {
    ...
    public void readFromXml(XmlPullParser parser) throws XmlPullParserException, IOException {
        this.mPackageName = getStringFromXml(parser, "packageName", (String) null);
        ...
        while (true) {
            ...
            if (!(type == 3 || type == 4)) {
                ...
                if (tagName.equals(TAG_DOMAIN)) {
                    String name = getStringFromXml(parser, "name", (String) null);
    ...
    public void writeToXml(XmlSerializer serializer) throws IOException {
        serializer.attribute((String) null, "packageName", this.mPackageName);
        serializer.attribute((String) null, "status", String.valueOf(this.mMainStatus));
        Iterator<String> it = this.mDomains.iterator();
        while (it.hasNext()) {
            serializer.startTag((String) null, TAG_DOMAIN);
            serializer.attribute((String) null, "name", it.next());
            serializer.endTag((String) null, TAG_DOMAIN);
        }
    }
