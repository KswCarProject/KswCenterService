...
public final class ShortcutInfo implements Parcelable {
    ...
    public static Person[] clonePersons(Person[] persons) {
        ...
        for (int i = 0; i < ret.length; i++) {
            if (persons[i] != null) {
                ret[i] = persons[i].toBuilder().setIcon((Icon) null).build();
            }
        }
        return ret;
    }
    ...
    public void lookupAndFillInResourceIds(Resources res) {
        if (this.mTitleResName != null || this.mTextResName != null || this.mDisabledMessageResName != null || this.mIconResName != null) {
            ...
            this.mIconResId = lookUpResourceId(res, this.mIconResName, (String) null, this.mPackageName);
        }
    }
    ...
    public String toString() {
        return toStringInner(true, false, (String) null);
    }

    public String toInsecureString() {
        return toStringInner(false, true, (String) null);
    }
