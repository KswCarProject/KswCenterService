...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    public void dump(Printer pw, String prefix, int dumpFlags) {
        ...
        if (!ArrayUtils.isEmpty((T[]) this.splitSourceDirs)) {
            pw.println(prefix + "splitSourceDirs=" + Arrays.toString(this.splitSourceDirs));
        }
        if (!ArrayUtils.isEmpty((T[]) this.splitPublicSourceDirs) && !Arrays.equals(this.splitSourceDirs, this.splitPublicSourceDirs)) {
        ...
        if (!ArrayUtils.isEmpty((T[]) this.splitClassLoaderNames)) {
    ...
    public void writeToProto(ProtoOutputStream proto, long fieldId, int dumpFlags) {
        ...
        if (!ArrayUtils.isEmpty((T[]) this.splitClassLoaderNames)) {
            for (String name : this.splitClassLoaderNames) {
                protoOutputStream.write((long) ApplicationInfoProto.SPLIT_CLASS_LOADER_NAMES, name);
            }
        }
    ...
    private ApplicationInfo(Parcel source) {
        ...
        this.splitDependencies = source.readSparseArray((ClassLoader) null);
