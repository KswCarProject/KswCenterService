...
public abstract class PackageManager {
    ...
    public Intent buildRequestPermissionsIntent(String[] permissions) {
        if (!ArrayUtils.isEmpty((T[]) permissions)) {
    ...
    public PackageInfo getPackageArchiveInfo(String archiveFilePath, int flags) {
        ...
        try {
            ...
            return PackageParser.generatePackageInfo(pkg, (int[]) null, flags, 0, 0, (Set<String>) null, new PackageUserState());
    ...
    public void freeStorageAndNotify(long freeStorageSize, IPackageDataObserver observer) {
        freeStorageAndNotify((String) null, freeStorageSize, observer);
    }

    @UnsupportedAppUsage
    public void freeStorage(long freeStorageSize, IntentSender pi) {
        freeStorage((String) null, freeStorageSize, pi);
    }
