...
public class LabeledIntent extends Intent {
    ...
    public CharSequence loadLabel(PackageManager pm) {
        ...
        if (this.mLabelRes == 0 || this.mSourcePackage == null || (label = pm.getText(this.mSourcePackage, this.mLabelRes, (ApplicationInfo) null)) == null) {
            return null;
        }
        return label;
    }
    ...
    public Drawable loadIcon(PackageManager pm) {
        Drawable icon;
        if (this.mIcon == 0 || this.mSourcePackage == null || (icon = pm.getDrawable(this.mSourcePackage, this.mIcon, (ApplicationInfo) null)) == null) {
            return null;
        }
        return icon;
    }
