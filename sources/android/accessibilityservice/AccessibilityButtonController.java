...
public final class AccessibilityButtonController {
    ...
    public boolean isAccessibilityButtonAvailable() {
        if (this.mServiceConnection != null) {
            try {
                ...
                Slog.m49w(LOG_TAG, "Failed to get accessibility button availability.", re);
    ...
    void dispatchAccessibilityButtonClicked() {
        synchronized (this.mLock) {
            ...
            Slog.m50w(LOG_TAG, "Received accessibility button click with no callbacks!");
        }
    }
    ...
    void dispatchAccessibilityButtonAvailabilityChanged(final boolean available) {
        synchronized (this.mLock) {
            ...
            Slog.m50w(LOG_TAG, "Received accessibility button availability change with no callbacks!");
        }
    }
