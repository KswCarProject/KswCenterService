...
public class RenderScript {
        ...
        if (!SystemProperties.getBoolean("config.disable_renderscript", false)) {
            try {
                ...
                try {
                    ...
                    Log.m70e(LOG_TAG, "Error loading RS jni library: " + e);
                    throw new RSRuntimeException("Error loading RS jni library: " + e);
                }
            } catch (Exception e2) {
                Log.m70e(LOG_TAG, "Error loading GC methods: " + e2);
            ...
            while (this.mRun) {
                ...
                if (msg == 4) {
                    ...
                    if (subID >= 4096 || (subID >= 2048 && (this.mRS.mContextType != ContextType.DEBUG || this.mRS.mErrorCallback == null))) {
                        ...
                        Log.m70e(RenderScript.LOG_TAG, "non fatal RS error, " + e);
                    }
                } else if (msg != 5) {
                    try {
                        sleep(1L, 0);
    ...
    RenderScript(Context ctx) {
        ...
        try {
            ...
            Log.m70e(LOG_TAG, "Couldn't invoke registerNativeAllocation:" + e);
    ...
    private static RenderScript internalCreate(Context ctx, int sdkVersion, ContextType ct, int flags) {
        if (!sInitialized) {
            Log.m70e(LOG_TAG, "RenderScript.create() called when disabled; someone is likely to crash");
            return null;
        } else if ((flags & (-15)) != 0) {
    ...
    private void helpDestroy() {
        ...
        if (shouldDestroy) {
            ...
            if (interrupted) {
                Log.m66v(LOG_TAG, "Interrupted during wait for MessageThread to join");
