...
public class Canvas extends BaseCanvas {
    ...
    @UnsupportedAppUsage
    @Deprecated
    protected InterfaceC3683GL getGL() {
        return null;
    }
    ...
    private static void checkValidClipOp(Region.EnumC0685Op op) {
        if (sCompatiblityVersion >= 28 && op != Region.EnumC0685Op.INTERSECT && op != Region.EnumC0685Op.DIFFERENCE) {
            throw new IllegalArgumentException("Invalid Region.Op - only INTERSECT and DIFFERENCE are allowed");
        }
    }

    @Deprecated
    public boolean clipRect(RectF rect, Region.EnumC0685Op op) {
        checkValidClipOp(op);
        return nClipRect(this.mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, op.nativeInt);
    }

    @Deprecated
    public boolean clipRect(Rect rect, Region.EnumC0685Op op) {
        checkValidClipOp(op);
        return nClipRect(this.mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, op.nativeInt);
    }

    public boolean clipRectUnion(Rect rect) {
        return nClipRect(this.mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, Region.EnumC0685Op.UNION.nativeInt);
    }

    public boolean clipRect(RectF rect) {
        return nClipRect(this.mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, Region.EnumC0685Op.INTERSECT.nativeInt);
    }

    public boolean clipOutRect(RectF rect) {
        return nClipRect(this.mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, Region.EnumC0685Op.DIFFERENCE.nativeInt);
    }
    ...
    @Deprecated
    public boolean clipRect(float left, float top, float right, float bottom, Region.EnumC0685Op op) {
        checkValidClipOp(op);
        return nClipRect(this.mNativeCanvasWrapper, left, top, right, bottom, op.nativeInt);
    }

    public boolean clipRect(float left, float top, float right, float bottom) {
        return nClipRect(this.mNativeCanvasWrapper, left, top, right, bottom, Region.EnumC0685Op.INTERSECT.nativeInt);
    }

    public boolean clipOutRect(float left, float top, float right, float bottom) {
        return nClipRect(this.mNativeCanvasWrapper, left, top, right, bottom, Region.EnumC0685Op.DIFFERENCE.nativeInt);
    }
    ...
    @Deprecated
    public boolean clipPath(Path path, Region.EnumC0685Op op) {
        checkValidClipOp(op);
        return nClipPath(this.mNativeCanvasWrapper, path.readOnlyNI(), op.nativeInt);
    }

    public boolean clipPath(Path path) {
        return clipPath(path, Region.EnumC0685Op.INTERSECT);
    }

    public boolean clipOutPath(Path path) {
        return clipPath(path, Region.EnumC0685Op.DIFFERENCE);
    }

    @Deprecated
    public boolean clipRegion(Region region, Region.EnumC0685Op op) {
        return false;
    }
