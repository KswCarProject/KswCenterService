...
public abstract class BaseCanvas {
    ...
    public void drawBitmap(Bitmap bitmap, Matrix matrix, Paint paint) {
        throwIfHasHwBitmapInSwMode(paint);
        nDrawBitmapMatrix(this.mNativeCanvasWrapper, bitmap.getNativeInstance(), matrix.m130ni(), paint != null ? paint.getNativeInstance() : 0L);
    }
    ...
    public void drawBitmap(Bitmap bitmap, Rect src, Rect dst, Paint paint) {
        ...
        int left2 = dst.right;
        int top2 = dst.bottom;
        nDrawBitmap(this.mNativeCanvasWrapper, bitmap.getNativeInstance(), left, top, right2, bottom, dst.left, dst.top, left2, top2, nativePaint, this.mScreenDensity, bitmap.mDensity);
    }
