...
public class ShapeDrawable extends Drawable {
    ...
    protected boolean inflateTag(String name, Resources r, XmlPullParser parser, AttributeSet attrs) {
        if ("padding".equals(name)) {
            TypedArray a = r.obtainAttributes(attrs, C3132R.styleable.ShapeDrawablePadding);
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        TypedArray a = obtainAttributes(r, theme, attrs, C3132R.styleable.ShapeDrawable);
        ...
        while (true) {
            ...
            if (type == 1 || (type == 3 && parser.getDepth() <= outerDepth)) {
                ...
                if (!inflateTag(name, r, parser, attrs)) {
                    Log.m64w("drawable", "Unknown element: " + name + " for ShapeDrawable " + this);
                }
            }
        }
        updateLocalState();
    ...
    public void applyTheme(Resources.Theme t) {
        ...
        if (state.mThemeAttrs != null) {
            TypedArray a = t.resolveAttributes(state.mThemeAttrs, C3132R.styleable.ShapeDrawable);
            updateStateFromTypedArray(a);
            a.recycle();
        }
    ...
    static final class ShapeState extends Drawable.ConstantState {
        ...
        ShapeState(ShapeState orig) {
            ...
            if (orig.mShape != null) {
                try {
                    this.mShape = orig.mShape.mo159clone();
