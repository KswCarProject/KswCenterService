        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    TextClassifierEvent _arg15 = data.readInt() != 0 ? TextClassifierEvent.CREATOR.createFromParcel(data) : null;
                ...
                case 6:
                    ...
                    TextClassificationSessionId _arg16 = data.readInt() != 0 ? TextClassificationSessionId.CREATOR.createFromParcel(data) : null;
                    onCreateTextClassificationSession(_arg06, _arg16);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    TextClassificationSessionId _arg09 = data.readInt() != 0 ? TextClassificationSessionId.CREATOR.createFromParcel(data) : null;
                    onDestroyTextClassificationSession(_arg09);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    TextLanguage.Request _arg17 = data.readInt() != 0 ? TextLanguage.Request.CREATOR.createFromParcel(data) : null;
                    ITextClassifierCallback _arg24 = ITextClassifierCallback.Stub.asInterface(data.readStrongBinder());
                    onDetectLanguage(_arg07, _arg17, _arg24);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    ConversationActions.Request _arg18 = data.readInt() != 0 ? ConversationActions.Request.CREATOR.createFromParcel(data) : null;
                    ITextClassifierCallback _arg25 = ITextClassifierCallback.Stub.asInterface(data.readStrongBinder());
                    onSuggestConversationActions(_arg08, _arg18, _arg25);
                    return true;
                default:
