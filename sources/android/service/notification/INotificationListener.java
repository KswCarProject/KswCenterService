        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    NotificationStats _arg22 = data.readInt() != 0 ? NotificationStats.CREATOR.createFromParcel(data) : null;
                    int _arg3 = data.readInt();
                    onNotificationRemoved(_arg03, _arg1, _arg22, _arg3);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    ...
                    NotificationChannel _arg23 = data.readInt() != 0 ? NotificationChannel.CREATOR.createFromParcel(data) : null;
                    int _arg32 = data.readInt();
                    onNotificationChannelModification(_arg07, _arg12, _arg23, _arg32);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    NotificationChannelGroup _arg24 = data.readInt() != 0 ? NotificationChannelGroup.CREATOR.createFromParcel(data) : null;
                    int _arg33 = data.readInt();
                    onNotificationChannelGroupModification(_arg08, _arg13, _arg24, _arg33);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    IStatusBarNotificationHolder _arg09 = IStatusBarNotificationHolder.Stub.asInterface(data.readStrongBinder());
                    NotificationChannel _arg15 = data.readInt() != 0 ? NotificationChannel.CREATOR.createFromParcel(data) : null;
                ...
                case 11:
                    ...
                    onNotificationSnoozedUntilContext(_arg010, _arg16);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 13:
                    ...
                    _arg2 = data.readInt() != 0;
                    onNotificationExpansionChanged(_arg012, _arg17, _arg2);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 15:
                    ...
                    CharSequence _arg18 = data.readInt() != 0 ? TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(data) : null;
                    onSuggestedReplySent(_arg014, _arg18, data.readInt());
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg015 = data.readString();
                    Notification.Action _arg19 = data.readInt() != 0 ? Notification.Action.CREATOR.createFromParcel(data) : null;
                    onActionClicked(_arg015, _arg19, data.readInt());
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
