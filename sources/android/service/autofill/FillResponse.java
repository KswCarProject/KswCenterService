...
public final class FillResponse implements Parcelable {
    public static final Parcelable.Creator<FillResponse> CREATOR = new Parcelable.Creator<FillResponse>() {
        public FillResponse createFromParcel(Parcel parcel) {
            ...
            ParceledListSlice<Dataset> datasetSlice = (ParceledListSlice) parcel2.readParcelable((ClassLoader) null);
            ...
            builder.setSaveInfo((SaveInfo) parcel2.readParcelable((ClassLoader) null));
            builder.setClientState((Bundle) parcel2.readParcelable((ClassLoader) null));
            AutofillId[] authenticationIds = (AutofillId[]) parcel2.readParcelableArray((ClassLoader) null, AutofillId.class);
            IntentSender authentication = (IntentSender) parcel2.readParcelable((ClassLoader) null);
            RemoteViews presentation = (RemoteViews) parcel2.readParcelable((ClassLoader) null);
            if (authenticationIds != null) {
                builder.setAuthentication(authenticationIds, authentication, presentation);
            }
            RemoteViews header = (RemoteViews) parcel2.readParcelable((ClassLoader) null);
            if (header != null) {
                builder.setHeader(header);
            }
            RemoteViews footer = (RemoteViews) parcel2.readParcelable((ClassLoader) null);
            if (footer != null) {
                builder.setFooter(footer);
            }
            UserData userData = (UserData) parcel2.readParcelable((ClassLoader) null);
            if (userData != null) {
                builder.setUserData(userData);
            }
            builder.setIgnoredIds((AutofillId[]) parcel2.readParcelableArray((ClassLoader) null, AutofillId.class));
            long disableDuration = parcel.readLong();
            if (disableDuration > 0) {
                builder.disableAutofill(disableDuration);
            }
            AutofillId[] fieldClassifactionIds = (AutofillId[]) parcel2.readParcelableArray((ClassLoader) null, AutofillId.class);
