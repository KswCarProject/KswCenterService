...
public class VoiceInteractionSession implements KeyEvent.Callback, ComponentCallbacks2 {
                    ...
                    public void run() {
                        ...
                        if (structure != null) {
                            try {
                                ...
                                Log.m63w(VoiceInteractionSession.TAG, "Failure retrieving AssistStructure", e);
                                failure = e;
                            }
                        }
            ...
            if (showCallback != null) {
                if (this.mUiEnabled) {
                    ...
                    this.mRootView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: android.service.voice.VoiceInteractionSession.4
                        ...
                        public boolean onPreDraw() {
                            ...
                            try {
                                ...
                                Log.m63w(VoiceInteractionSession.TAG, "Error calling onShown", e);
                                return true;
                            }
                        }
                    });
                    ...
                    try {
                        ...
                        Log.m63w(TAG, "Error calling onShown", e);
                    }
                }
            }
        } finally {
    ...
    void ensureWindowCreated() {
        ...
        this.mRootView = this.mInflater.inflate(C3132R.layout.voice_interaction_session, (ViewGroup) null);
    ...
    public final void requestDirectActions(ActivityId activityId, final CancellationSignal cancellationSignal, final Executor resultExecutor, final Consumer<List<DirectAction>> callback) {
        ...
        RemoteCallback cancellationCallback = cancellationSignal != null ? new RemoteCallback(new RemoteCallback.OnResultListener() { // from class: android.service.voice.-$$Lambda$VoiceInteractionSession$KRmvXWbKzOj6uOiuAkDjhkUvQiw
    ...
    static /* synthetic */ void lambda$requestDirectActions$2(Executor resultExecutor, final Consumer callback, Bundle result) {
    ...
    public final void performDirectAction(DirectAction action, Bundle extras, final CancellationSignal cancellationSignal, final Executor resultExecutor, final Consumer<Bundle> resultListener) {
        ...
        RemoteCallback cancellationCallback = cancellationSignal != null ? new RemoteCallback(createSafeResultListener(new Consumer() { // from class: android.service.voice.-$$Lambda$VoiceInteractionSession$2YI2merL0-kdgL83g93OW541J8w
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    static /* synthetic */ void lambda$performDirectAction$6(Executor resultExecutor, final Consumer resultListener, final Bundle b) {
        if (b != null) {
    ...
    private void doOnCreate() {
        this.mTheme = this.mTheme != 0 ? this.mTheme : C3132R.C3136style.Theme_DeviceDefault_VoiceInteractionSession;
    }
