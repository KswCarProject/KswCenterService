...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    public interface GLWrapper {
        InterfaceC3683GL wrap(InterfaceC3683GL interfaceC3683GL);
    }
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        public void destroyContext(EGL10 egl, javax.microedition.khronos.egl.EGLDisplay display, javax.microedition.khronos.egl.EGLContext context) {
            if (!egl.eglDestroyContext(display, context)) {
                Log.m70e("DefaultContextFactory", "display:" + display + " context: " + context);
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        public javax.microedition.khronos.egl.EGLSurface createWindowSurface(EGL10 egl, javax.microedition.khronos.egl.EGLDisplay display, javax.microedition.khronos.egl.EGLConfig config, Object nativeWindow) {
            try {
                ...
                Log.m69e(GLSurfaceView.TAG, "eglCreateWindowSurface", e);
                return null;
            }
        }
    ...
    private static class EglHelper {
        ...
        public boolean createSurface() {
            ...
            if (this.mEglSurface == null || this.mEglSurface == EGL10.EGL_NO_SURFACE) {
                ...
                if (error == 12299) {
                    Log.m70e("EglHelper", "createWindowSurface returned EGL_BAD_NATIVE_WINDOW.");
                }
                return false;
        ...
        InterfaceC3683GL createGL() {
            InterfaceC3683GL gl = this.mEglContext.getGL();
            GLSurfaceView view = this.mGLSurfaceViewWeakRef.get();
            if (view != null) {
        ...
        public static void logEglErrorAsWarning(String tag, String function, int error) {
            Log.m64w(tag, formatEglError(function, error));
        }
    ...
    static class GLThread extends Thread {
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
            jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:155:0x0238
    ...
    static class LogWriter extends Writer {
        ...
        private void flushBuilder() {
            if (this.mBuilder.length() > 0) {
                Log.m66v(GLSurfaceView.TAG, this.mBuilder.toString());
