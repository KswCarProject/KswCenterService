...
public class BaseBundle {
    ...
    public String getPairValue() {
        ...
        if (size > 1) {
            Log.m64w(TAG, "getPairValue() used on Bundle with multiple pairs.");
        }
        if (size == 0) {
            return null;
        }
    ...
    */
    private void initializeFromParcelLocked(Parcel parcelledData, boolean recycleParcel, boolean parcelledByNative) {
        ...
        try {
            try {
                ...
                Log.m63w(TAG, "Failed to parse Bundle, but defusing quietly", e);
                map.erase();
                this.mMap = map;
            }
        } catch (Throwable th) {
    ...
    void typeWarning(String key, Object value, String className, Object defaultValue, ClassCastException e) {
        Log.m64w(TAG, "Key " + key + " expected " + className + " but value was a " + value.getClass().getName() + ".  The default value " + defaultValue + " was returned.");
        Log.m63w(TAG, "Attempt to cast generated internal exception:", e);
    }
