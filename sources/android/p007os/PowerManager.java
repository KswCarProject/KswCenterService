...
import android.p007os.IDeviceIdleController;
import android.p007os.IThermalService;
import android.p007os.IThermalStatusListener;
...
public final class PowerManager {
    ...
    public int getMinimumScreenBrightnessSetting() {
        return this.mContext.getResources().getInteger(C3132R.integer.config_screenBrightnessSettingMinimum);
    }

    @UnsupportedAppUsage
    public int getMaximumScreenBrightnessSetting() {
        return this.mContext.getResources().getInteger(C3132R.integer.config_screenBrightnessSettingMaximum);
    }

    @UnsupportedAppUsage
    public int getDefaultScreenBrightnessSetting() {
        return this.mContext.getResources().getInteger(C3132R.integer.config_screenBrightnessSettingDefault);
    }

    public int getMinimumScreenBrightnessForVrSetting() {
        return this.mContext.getResources().getInteger(C3132R.integer.config_screenBrightnessForVrSettingMinimum);
    }

    public int getMaximumScreenBrightnessForVrSetting() {
        return this.mContext.getResources().getInteger(C3132R.integer.config_screenBrightnessForVrSettingMaximum);
    }

    public int getDefaultScreenBrightnessForVrSetting() {
        return this.mContext.getResources().getInteger(C3132R.integer.config_screenBrightnessForVrSettingDefault);
    }
    ...
    public boolean isSustainedPerformanceModeSupported() {
        return this.mContext.getResources().getBoolean(C3132R.bool.config_sustainedPerformanceModeSupported);
    }
    ...
    public void addThermalStatusListener(Executor executor, OnThermalStatusChangedListener listener) {
        ...
        synchronized (this) {
            ...
            Preconditions.checkArgument(!this.mListenerMap.containsKey(listener), "Listener already registered: " + listener);
            IThermalStatusListener internalListener = new IThermalStatusListener$StubC15061(executor, listener);
            try {
    ...
    /* loaded from: classes3.dex */
    class IThermalStatusListener$StubC15061 extends IThermalStatusListener.Stub {
        final /* synthetic */ Executor val$executor;
        final /* synthetic */ OnThermalStatusChangedListener val$listener;

        IThermalStatusListener$StubC15061(Executor executor, OnThermalStatusChangedListener onThermalStatusChangedListener) {
