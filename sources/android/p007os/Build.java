...
import android.p007os.IDeviceIdentifiersPolicyService;
...
public class Build {
    ...
    /* renamed from: ID */
    public static final String f137ID = getString("ro.build.id");
    ...
    public static class VERSION_CODES {
        ...
        /* renamed from: L */
        public static final int f138L = 21;
        public static final int LOLLIPOP = 21;
        public static final int LOLLIPOP_MR1 = 22;

        /* renamed from: M */
        public static final int f139M = 23;

        /* renamed from: N */
        public static final int f140N = 24;
        public static final int N_MR1 = 25;

        /* renamed from: O */
        public static final int f141O = 26;
        public static final int O_MR1 = 27;

        /* renamed from: P */
        public static final int f142P = 28;

        /* renamed from: Q */
        public static final int f143Q = 29;
    }
    ...
    public static void ensureFingerprintProperty() {
        if (TextUtils.isEmpty(SystemProperties.get("ro.build.fingerprint"))) {
            try {
                ...
                Slog.m55e(TAG, "Failed to set fingerprint property", e);
            }
        }
    }
    ...
    public static boolean isBuildConsistent() {
        ...
        if (IS_TREBLE_ENABLED) {
            ...
            if (result != 0) {
                Slog.m56e(TAG, "Vendor interface is incompatible, error=" + String.valueOf(result));
            }
            return result == 0;
        }
        ...
        if (TextUtils.isEmpty(system)) {
            Slog.m56e(TAG, "Required ro.build.fingerprint is empty!");
            return false;
        } else if (TextUtils.isEmpty(vendor) || Objects.equals(system, vendor)) {
            return true;
        } else {
            Slog.m56e(TAG, "Mismatched fingerprints; system reported " + system + " but vendor reported " + vendor);
            return false;
        }
    }
