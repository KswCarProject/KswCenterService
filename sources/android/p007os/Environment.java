...
public class Environment {
    ...
    public static boolean isExternalStorageLegacy(File path) {
        ...
        if (packageManager.checkPermission(Manifest.C0000permission.WRITE_MEDIA_STORAGE, context.getPackageName()) == 0 || packageManager.checkPermission(Manifest.C0000permission.INSTALL_PACKAGES, context.getPackageName()) == 0) {
            return true;
        }
