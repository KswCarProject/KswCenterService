...
import android.p007os.IIncidentReportStatusListener;
...
public interface IIncidentManager extends IInterface {
    ...
    public static class Default implements IIncidentManager {
        @Override // android.p007os.IIncidentManager
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    List<String> _result = getIncidentReportList(_arg02, _arg12);
                ...
                case 5:
                    ...
                    IncidentManager.IncidentReport _result2 = getIncidentReport(_arg03, _arg13, _arg22);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 6:
                    ...
                    deleteIncidentReports(_arg04, _arg14, _arg23);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
