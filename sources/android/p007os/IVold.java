...
import android.p007os.IVoldListener;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 33:
                    ...
                    fdeChangePassword(_arg027, _arg17, _arg26);
                    reply.writeNoException();
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 46:
                    ...
                    _arg1 = data.readInt() != 0;
                    createUserKey(_arg033, _arg18, _arg1);
                    reply.writeNoException();
                    return true;
                case 47:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 48:
                    ...
                    addUserKeyAuth(_arg035, _arg19, _arg27, _arg3);
                    reply.writeNoException();
                    return true;
                case 49:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    clearUserKeyAuth(_arg036, _arg110, _arg28, _arg32);
                    reply.writeNoException();
                    return true;
                case 50:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 51:
                    ...
                    unlockUserKey(_arg038, _arg111, _arg29, _arg33);
                    reply.writeNoException();
                    return true;
                case 52:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 53:
                    ...
                    prepareUserStorage(_arg040, _arg112, _arg210, _arg34);
                    reply.writeNoException();
                    return true;
                case 54:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    destroyUserStorage(_arg041, _arg113, _arg211);
                    reply.writeNoException();
                    return true;
                case 55:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    prepareSandboxForApp(_arg042, _arg114, _arg212, _arg35);
                    reply.writeNoException();
                    return true;
                case 56:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    destroySandboxForApp(_arg043, _arg115, _arg213);
                    reply.writeNoException();
                    return true;
                case 57:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 63:
                    ...
                    restoreCheckpoint(_arg046);
                    reply.writeNoException();
                    return true;
                case 64:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg047 = data.readString();
                    restoreCheckpointPart(_arg047, data.readInt());
                    reply.writeNoException();
                    return true;
                case 65:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 69:
                    ...
                    String _result7 = createStubVolume(_arg048, _arg116, _arg214, _arg36, _arg4);
                    reply.writeNoException();
                ...
                case 71:
                    ...
                    FileDescriptor _result8 = openAppFuseFile(_arg050, _arg117, _arg215, _arg37);
                    reply.writeNoException();
