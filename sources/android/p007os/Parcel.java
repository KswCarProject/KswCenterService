...
public final class Parcel {
    ...
    public final int readExceptionCode() {
        ...
        if (code == -128) {
            ...
            if (headerSize == 0) {
                Log.m70e(TAG, "Unexpected zero-sized Parcel reply header.");
                return 0;
            }
    ...
    public final void readException(int code, String msg) {
        ...
        if (remoteStackTrace != null) {
            ...
            try {
                ...
                Log.m69e(TAG, "Cannot set cause " + cause + " for " + e, ex);
            }
        }
                ...
                if (loader != null) {
                    ...
                    try {
                        try {
                            ...
                            Log.m69e(TAG, "Class not found when unmarshalling: " + name, e);
                            throw new BadParcelableException("ClassNotFoundException when unmarshalling: " + name);
                        } catch (IllegalAccessException e2) {
                            Log.m69e(TAG, "Illegal access when unmarshalling: " + name, e2);
