...
public class AutoText {
        ...
        for (int here = start; here < end; here++) {
            ...
            while (true) {
                if (c == '\uffff') {
                    ...
                    c = this.mTrie[c + 3];
                } else if (here == end - 1 && this.mTrie[c + 1] != '\uffff') {
    ...
    private void init(Resources r) {
        char off;
        XmlResourceParser parser = r.getXml(C3132R.xml.autotext);
    ...
    private void add(String src, char off) {
        ...
        for (int herep2 = 0; herep2 < slen; herep2++) {
            ...
            if (found) {
                ...
                this.mTrie[this.mTrie[herep3] + 1] = '\uffff';
                this.mTrie[this.mTrie[herep3] + 3] = '\uffff';
                this.mTrie[this.mTrie[herep3] + 2] = '\uffff';
                if (herep2 == slen - 1) {
                    this.mTrie[this.mTrie[herep3] + 1] = off;
                    return;
                }
