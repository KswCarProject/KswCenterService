...
public class TimeKeyListener extends NumberKeyListener {
    ...
    public TimeKeyListener(Locale locale) {
        ...
        boolean success = NumberKeyListener.addDigits(chars, locale) && NumberKeyListener.addAmPmChars(chars, locale) && NumberKeyListener.addFormatCharsFromSkeleton(chars, locale, SKELETON_12HOUR, SYMBOLS_TO_IGNORE) && NumberKeyListener.addFormatCharsFromSkeleton(chars, locale, "Hms", SYMBOLS_TO_IGNORE);
        if (success) {
