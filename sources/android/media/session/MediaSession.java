...
public final class MediaSession {
    ...
    public MediaSession(Context context, String tag, Bundle sessionInfo) {
        ...
        this.mMaxBitmapSize = context.getResources().getDimensionPixelSize(C3132R.dimen.config_mediaMetadataBitmapMaxSize);
    ...
    public void setRatingType(int type) {
        try {
            ...
            Log.m69e(TAG, "Error in setRatingType.", e);
        }
    }
            ...
            if (provider != null) {
                if (provider == this.mVolumeProvider) {
                    try {
                        ...
                        Log.m69e(TAG, "Error in notifyVolumeChanged", e);
                        return;
                    }
                }
            }
            Log.m64w(TAG, "Received update from stale volume provider");
        }
    }
    ...
    static boolean hasCustomParcelable(Bundle bundle) {
        ...
        try {
            try {
                ...
                Log.m71d(TAG, "Custom parcelable in bundle.", e);
                if (parcel != null) {
                    parcel.recycle();
                }
                return true;
