...
public class MediaMetadataRetriever implements AutoCloseable {
    ...
    public List<Bitmap> getFramesAtIndex(int frameIndex, int numFrames) {
        return getFramesAtIndexInternal(frameIndex, numFrames, (BitmapParams) null);
    }
    ...
    public Bitmap getImageAtIndex(int imageIndex) {
        return getImageAtIndexInternal(imageIndex, (BitmapParams) null);
    }
    ...
    public Bitmap getPrimaryImage() {
        return getImageAtIndexInternal(-1, (BitmapParams) null);
    }
