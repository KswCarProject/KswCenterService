...
public final class MediaProjectionManager {
    ...
    public Intent createScreenCaptureIntent() {
        Intent i = new Intent();
        ComponentName mediaProjectionPermissionDialogComponent = ComponentName.unflattenFromString(this.mContext.getResources().getString(C3132R.string.config_mediaProjectionPermissionDialogComponent));
    ...
    public MediaProjectionInfo getActiveProjectionInfo() {
        try {
            ...
            Log.m69e(TAG, "Unable to get the active projection info", e);
            return null;
        }
    }
    ...
    public void stopActiveProjection() {
        try {
            ...
            Log.m69e(TAG, "Unable to stop the currently active media projection", e);
        }
    }
    ...
    public void addCallback(Callback callback, Handler handler) {
        ...
        try {
            ...
            Log.m69e(TAG, "Unable to add callbacks to MediaProjection service", e);
        }
    }
