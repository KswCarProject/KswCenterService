        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    AudioAttributes _arg23 = data.readInt() != 0 ? AudioAttributes.CREATOR.createFromParcel(data) : null;
                    float _arg3 = data.readFloat();
                    boolean _arg4 = data.readInt() != 0;
                    play(_arg02, _arg1, _arg23, _arg3, _arg4);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    VolumeShaper.Configuration _arg5 = data.readInt() != 0 ? VolumeShaper.Configuration.CREATOR.createFromParcel(data) : null;
                    playWithVolumeShaping(_arg03, _arg12, _arg2, _arg32, _arg42, _arg5);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 4:
                    ...
                    boolean isPlaying = isPlaying(_arg05);
                ...
                case 5:
                    ...
                    setPlaybackProperties(_arg06, _arg14, _arg22);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    _arg22 = data.readInt() != 0;
                    AudioAttributes _arg33 = data.readInt() != 0 ? AudioAttributes.CREATOR.createFromParcel(data) : null;
                    playAsync(_arg0, _arg13, _arg22, _arg33);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    stopAsync();
                ...
                case 8:
                    ...
                    String _result = getTitle(_arg07);
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    ParcelFileDescriptor _result2 = openRingtone(_arg08);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
