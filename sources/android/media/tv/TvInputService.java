        ...
        public final void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    if (sessionImpl == null) {
                        try {
                            cb.onSessionCreated((ITvInputSession) null, (IBinder) null);
                            return;
                        } catch (RemoteException e) {
                ...
                case 3:
                    ...
                    if (recordingSessionImpl == null) {
                        try {
                            cb3.onSessionCreated((ITvInputSession) null, (IBinder) null);
                            return;
                        ...
                        try {
                            cb3.onSessionCreated(new ITvInputSessionWrapper(TvInputService.this, recordingSessionImpl), (IBinder) null);
