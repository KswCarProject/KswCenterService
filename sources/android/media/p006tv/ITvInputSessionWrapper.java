...
import android.media.p006tv.TvInputService;
...
public class ITvInputSessionWrapper extends ITvInputSession.Stub implements HandlerCaller.Callback {
    ...
    public void executeMessage(Message msg) {
        ...
        if (durationMs > 50) {
            Log.m64w(TAG, "Handling message (" + msg.what + ") took too long time (duration=" + durationMs + "ms)");
    ...
    @Override // android.media.p006tv.ITvInputSession
    public void release() {
        if (!this.mIsRecordingSession) {
