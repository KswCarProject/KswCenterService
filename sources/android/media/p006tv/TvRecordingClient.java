...
public class TvRecordingClient {
    ...
    public void stopRecording() {
        if (!this.mIsRecordingStarted) {
            Log.m64w(TAG, "stopRecording failed - recording not yet started");
        }
        if (this.mSession != null) {
    ...
    private class MySessionCallback extends TvInputManager.SessionCallback {
        ...
        public void onSessionCreated(TvInputManager.Session session) {
            ...
            Log.m64w(TvRecordingClient.TAG, "onSessionCreated - session already created");
            if (session != null) {
                session.release();
            }
        }
        ...
        void onTuned(TvInputManager.Session session, Uri channelUri) {
            ...
            Log.m64w(TvRecordingClient.TAG, "onTuned - session not created");
        }
        ...
        public void onSessionReleased(TvInputManager.Session session) {
            ...
            Log.m64w(TvRecordingClient.TAG, "onSessionReleased - session not created");
        }
        ...
        public void onRecordingStopped(TvInputManager.Session session, Uri recordedProgramUri) {
            ...
            Log.m64w(TvRecordingClient.TAG, "onRecordingStopped - session not created");
        }
        ...
        public void onError(TvInputManager.Session session, int error) {
            if (this == TvRecordingClient.this.mSessionCallback) {
                ...
                Log.m64w(TvRecordingClient.TAG, "onError - session not created");
            }
        }
        ...
        public void onSessionEvent(TvInputManager.Session session, String eventType, Bundle eventArgs) {
            ...
            Log.m64w(TvRecordingClient.TAG, "onSessionEvent - session not created");
        }
    }
}
