...
import android.media.p006tv.ITvInputService;
import android.media.p006tv.TvInputManager;
...
public abstract class TvInputService extends Service {
    ...
    public final IBinder onBind(Intent intent) {
        return new ITvInputService.Stub() { // from class: android.media.tv.TvInputService.1
            ...
            public void createSession(InputChannel channel, ITvInputSessionCallback cb, String inputId) {
                if (channel == null) {
                    Log.m64w(TvInputService.TAG, "Creating session without input channel");
                }
                if (cb == null) {
                    return;
                }
    ...
    public static abstract class Session implements KeyEvent.Callback {
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.2
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in sending event (event=" + eventType + ")", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.3
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyChannelRetuned", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.4
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyTracksChanged", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.5
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyTrackSelected", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.6
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyVideoAvailable", e);
                    }
                }
            });
        }
        ...
        public void notifyVideoUnavailable(final int reason) {
            if (reason < 0 || reason > 5) {
                Log.m70e(TvInputService.TAG, "notifyVideoUnavailable - unknown reason: " + reason);
            }
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.7
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyVideoUnavailable", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.8
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyContentAllowed", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.9
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyContentBlocked", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.10
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyTimeShiftStatusChanged", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.11
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyTimeShiftStartPositionChanged", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.12
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyTimeShiftCurrentPositionChanged", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.Session.13
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in layoutSurface", e);
                    }
                }
            });
        }
        ...
        void relayoutOverlayView(Rect frame) {
            ...
            this.mWindowParams.f2425x = frame.left;
            this.mWindowParams.f2426y = frame.top;
        ...
        private final class TimeShiftPositionTrackingRunnable implements Runnable {
            ...
            public void run() {
                ...
                if (currentPositionMs < Session.this.mStartPositionMs) {
                    Log.m64w(TvInputService.TAG, "Current position (" + currentPositionMs + ") cannot be earlier than start position (" + Session.this.mStartPositionMs + "). Reset to the start position.");
        ...
        public Void doInBackground(View... views) {
            ...
            try {
                ...
                if (!isCancelled() && overlayViewParent.isAttachedToWindow()) {
                    Log.m70e(TvInputService.TAG, "Time out on releasing overlay view. Killing " + overlayViewParent.getContext().getPackageName());
    ...
    public static abstract class RecordingSession {
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.1
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyTuned", e);
                    }
                }
            });
        }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.2
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyRecordingStopped", e);
                    }
                }
            });
        }
        ...
        public void notifyError(int error) {
            if (error < 0 || error > 2) {
                Log.m64w(TvInputService.TAG, "notifyError - invalid error code (" + error + ") is changed to RECORDING_ERROR_UNKNOWN.");
                error = 0;
            }
            ...
            executeOrPostRunnableOnMainThread(new Runnable() { // from class: android.media.tv.TvInputService.RecordingSession.3
                ...
                public void run() {
                    try {
                        ...
                        Log.m63w(TvInputService.TAG, "error in notifyError", e);
                    }
                }
            });
        }
    ...
    public static abstract class HardwareSession extends Session {
        ...
        public HardwareSession(Context context) {
            ...
            this.mHardwareSessionCallback = new TvInputManager.SessionCallback() { // from class: android.media.tv.TvInputService.HardwareSession.1
                @Override // android.media.p006tv.TvInputManager.SessionCallback
        ...
        @Override // android.media.p006tv.TvInputService.Session
        public final boolean onSetSurface(Surface surface) {
            Log.m70e(TvInputService.TAG, "onSetSurface() should not be called in HardwareProxySession.");
            return false;
        }
        ...
        private void broadcastAddHardwareInput(int deviceId, TvInputInfo inputInfo) {
            ...
            for (int i = 0; i < n; i++) {
                try {
                    ...
                    Log.m69e(TvInputService.TAG, "error in broadcastAddHardwareInput", e);
                }
            }
        ...
        private void broadcastAddHdmiInput(int id, TvInputInfo inputInfo) {
            ...
            for (int i = 0; i < n; i++) {
                try {
                    ...
                    Log.m69e(TvInputService.TAG, "error in broadcastAddHdmiInput", e);
                }
            }
            TvInputService.this.mCallbacks.finishBroadcast();
        }
        ...
        private void broadcastRemoveHardwareInput(String inputId) {
            ...
            for (int i = 0; i < n; i++) {
                try {
                    ...
                    Log.m69e(TvInputService.TAG, "error in broadcastRemoveHardwareInput", e);
                }
            }
            TvInputService.this.mCallbacks.finishBroadcast();
        }
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (sessionImpl == null) {
                        try {
                            ...
                            Log.m69e(TvInputService.TAG, "error in onSessionCreated", e);
                            return;
                        }
                    }
                    ...
                    if (sessionImpl instanceof HardwareSession) {
                        ...
                        if (TextUtils.isEmpty(hardwareInputId)) {
                            Log.m64w(TvInputService.TAG, "Hardware input id is not setup yet.");
                        } else {
                            Log.m64w(TvInputService.TAG, "Invalid hardware input id : " + hardwareInputId);
                        }
                        ...
                        try {
                            ...
                            Log.m69e(TvInputService.TAG, "error in onSessionCreated", e2);
                            return;
                        }
                    }
                ...
                case 2:
                    ...
                    try {
                        ...
                        Log.m69e(TvInputService.TAG, "error in onSessionCreated", e3);
                    }
                ...
                case 3:
                    ...
                    if (recordingSessionImpl == null) {
                        try {
                            ...
                            Log.m69e(TvInputService.TAG, "error in onSessionCreated", e4);
                            return;
                        }
                    }
                    try {
                        ...
                        Log.m69e(TvInputService.TAG, "error in onSessionCreated", e5);
                    }
                ...
                case 7:
                    ...
                    return;
                default:
                    Log.m64w(TvInputService.TAG, "Unhandled message code: " + msg.what);
                    return;
            }
        }
    }
