    ...
    public Drawable loadIcon(Context context) {
        ...
        if (this.mIconUri != null) {
            try {
                ...
                Log.m63w(TAG, "Loading the default icon due to a failure on loading " + this.mIconUri, e);
            }
        }
    ...
    public static final class Builder {
        ...
        public Builder setHdmiDeviceInfo(HdmiDeviceInfo hdmiDeviceInfo) {
            if (this.mTvInputHardwareInfo != null) {
                Log.m64w(TvInputInfo.TAG, "TvInputHardwareInfo will not be used to build this TvInputInfo");
        ...
        public Builder setTvInputHardwareInfo(TvInputHardwareInfo tvInputHardwareInfo) {
            if (this.mHdmiDeviceInfo != null) {
                Log.m64w(TvInputInfo.TAG, "mHdmiDeviceInfo will not be used to build this TvInputInfo");
        ...
        public TvInputInfo build() {
            ...
            return new TvInputInfo(this.mResolveInfo, id, type, isHardwareInput, this.mLabel, this.mLabelResId, this.mIcon, this.mIconStandby, this.mIconDisconnected, this.mSetupActivity, this.mCanRecord == null ? false : this.mCanRecord.booleanValue(), this.mTunerCount != null ? this.mTunerCount.intValue() : 0, this.mHdmiDeviceInfo, isConnectedToHdmiSwitch, hdmiConnectionRelativePosition, this.mParentId, this.mExtras);
        }
        ...
        private void parseServiceMetadata(int inputType) {
            ...
            try {
                ...
                TypedArray sa = res.obtainAttributes(attrs, C3132R.styleable.TvInputService);
