...
public final class BluetoothLeAdvertiser {
    ...
    public void startAdvertising(AdvertiseSettings settings, AdvertiseData advertiseData, AdvertiseCallback callback) {
        startAdvertising(settings, advertiseData, (AdvertiseData) null, callback);
    }
                ...
                if (advertiseCallback != null) {
                    ...
                    try {
                        ...
                        if (totalBytes(advertiseData, isConnectable) > 31) {
                            AdvertiseData advertiseData2 = scanResponse;
                            ...
                            startAdvertisingSet(parameters.build(), advertiseData, scanResponse, (PeriodicAdvertisingParameters) null, (AdvertiseData) null, duration2, 0, wrapped);
                            return;
                        }
        ...
        return new IAdvertisingSetCallback.Stub() {
            public void onAdvertisingSetStarted(final int advertiserId, final int txPower, final int status) {
                handler.post(new Runnable() {
                    public void run() {
                        if (status != 0) {
                            callback.onAdvertisingSetStarted((AdvertisingSet) null, 0, status);
    ...
    private void postStartSetFailure(Handler handler, final AdvertisingSetCallback callback, final int error) {
        handler.post(new Runnable() {
            public void run() {
                callback.onAdvertisingSetStarted((AdvertisingSet) null, 0, error);
            }
        });
    }
