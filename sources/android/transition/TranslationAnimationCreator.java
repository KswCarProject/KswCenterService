...
class TranslationAnimationCreator {
    ...
    static Animator createAnimation(View view, TransitionValues values, int viewPosX, int viewPosY, float startX, float startY, float endX, float endY, TimeInterpolator interpolator, Transition transition) {
        ...
        int[] startPosition = (int[]) values.view.getTag(C3132R.C3134id.transitionPosition);
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        private TransitionPositionListener(View movingView, View viewInHierarchy, int startX, int startY, float terminalX, float terminalY) {
            ...
            this.mTransitionPosition = (int[]) this.mViewInHierarchy.getTag(C3132R.C3134id.transitionPosition);
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTagInternal(C3132R.C3134id.transitionPosition, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animation) {
            ...
            this.mViewInHierarchy.setTagInternal(C3132R.C3134id.transitionPosition, this.mTransitionPosition);
        }
