...
public class TransitionInflater {
    ...
    public Transition inflateTransition(int resource) {
        ...
        try {
            try {
                ...
                InflateException ex = new InflateException(parser.getPositionDescription() + PluralRules.KEYWORD_RULE_SEPARATOR + e.getMessage());
                ex.initCause(e);
                throw ex;
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    if (name.equals("target")) {
                        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C3132R.styleable.TransitionTarget);
    ...
    */
    ...
    private void loadTransition(AttributeSet attrs, ViewGroup sceneRoot, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C3132R.styleable.TransitionManager);
