...
public class ChangeBounds extends Transition {
    ...
    private static final Property<Drawable, PointF> DRAWABLE_ORIGIN_PROPERTY = new Property<Drawable, PointF>(PointF.class, "boundsOrigin") { // from class: android.transition.ChangeBounds.1
        ...
        public void set(Drawable object, PointF value) {
            ...
            this.mBounds.offsetTo(Math.round(value.f61x), Math.round(value.f62y));
    ...
    private static final Property<View, PointF> BOTTOM_RIGHT_ONLY_PROPERTY = new Property<View, PointF>(PointF.class, "bottomRight") { // from class: android.transition.ChangeBounds.4
        ...
        public void set(View view, PointF bottomRight) {
            ...
            int top = view.getTop();
            int right = Math.round(bottomRight.f61x);
            int bottom = Math.round(bottomRight.f62y);
    ...
    private static final Property<View, PointF> TOP_LEFT_ONLY_PROPERTY = new Property<View, PointF>(PointF.class, "topLeft") { // from class: android.transition.ChangeBounds.5
        ...
        public void set(View view, PointF topLeft) {
            int left = Math.round(topLeft.f61x);
            int top = Math.round(topLeft.f62y);
    ...
    public ChangeBounds(Context context, AttributeSet attrs) {
        ...
        this.mResizeClip = false;
        this.mReparent = false;
        TypedArray a = context.obtainStyledAttributes(attrs, C3132R.styleable.ChangeBounds);
        ...
        if (startParent != null && endParent != null) {
            ...
            if (numChanges > 0) {
                ...
                if (changeBounds.mResizeClip) {
                    ...
                    Rect endClip3 = endClip == null ? new Rect(i, i, endWidth, endHeight2) : endClip;
    ...
    private static class ViewBounds {
        ...
        public void setTopLeft(PointF topLeft) {
            this.mLeft = Math.round(topLeft.f61x);
            this.mTop = Math.round(topLeft.f62y);
            this.mTopLeftCalls++;
        ...
        public void setBottomRight(PointF bottomRight) {
            this.mRight = Math.round(bottomRight.f61x);
            this.mBottom = Math.round(bottomRight.f62y);
