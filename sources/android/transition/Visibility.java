...
public abstract class Visibility extends Transition {
    ...
    public Visibility(Context context, AttributeSet attrs) {
        ...
        this.mMode = 3;
        this.mSuppressLayout = true;
        TypedArray a = context.obtainStyledAttributes(attrs, C3132R.styleable.VisibilityTransition);
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if ((this.mMode & 2) == 2 && startValues != null) {
            ...
            View savedOverlayView = (View) startView.getTag(C3132R.C3134id.transition_overlay_view_tag);
            ...
            if (overlayView != null) {
                ...
                if (!reusingOverlayView) {
                    if (animator == null) {
                        ...
                        startView.setTagInternal(C3132R.C3134id.transition_overlay_view_tag, overlayView);
                        ...
                        addListener(new TransitionListenerAdapter() { // from class: android.transition.Visibility.1
                            ...
                            public void onTransitionEnd(Transition transition) {
                                startView.setTagInternal(C3132R.C3134id.transition_overlay_view_tag, null);
                                overlay3.remove(finalOverlayView);
