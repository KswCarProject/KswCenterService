...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        if (PermissionChecker.checkSelfPermission(this.mContext, Manifest.permission.ACCESS_COARSE_LOCATION) == 0) {
            coarseLoc = getLastKnownLocationForProvider(LocationManager.NETWORK_PROVIDER);
        }
        if (PermissionChecker.checkSelfPermission(this.mContext, Manifest.permission.ACCESS_FINE_LOCATION) == 0) {
