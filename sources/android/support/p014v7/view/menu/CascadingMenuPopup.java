...
import android.support.p014v7.widget.MenuItemHoverListener;
import android.support.p014v7.widget.MenuPopupWindow;
...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: android.support.v7.view.menu.CascadingMenuPopup.3
        @Override // android.support.p014v7.widget.MenuItemHoverListener
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C2132R.dimen.abc_config_prefDialogWidth));
        this.mSubMenuHoverHandler = new Handler();
    }

    @Override // android.support.p014v7.view.menu.MenuPopup
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentView != null) {
            ...
            int parentOffsetTop3 = this.mDropDownGravity;
            if ((parentOffsetTop3 & 5) == 5) {
                if (showOnRight) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C2132R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
