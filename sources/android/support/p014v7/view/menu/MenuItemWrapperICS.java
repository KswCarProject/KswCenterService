...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
    ...
    public ActionProvider getActionProvider() {
        android.support.p011v4.view.ActionProvider provider = ((SupportMenuItem) this.mWrappedObject).getSupportActionProvider();
    ...
    public void setExclusiveCheckable(boolean checkable) {
        try {
            ...
            Log.m63w(LOG_TAG, "Error while calling setExclusiveCheckable", e);
        }
    }
    ...
    /* loaded from: classes3.dex */
    class ActionProviderWrapper extends android.support.p011v4.view.ActionProvider {
    ...
    /* loaded from: classes3.dex */
    static class CollapsibleActionViewWrapper extends FrameLayout implements android.support.p014v7.view.CollapsibleActionView {
