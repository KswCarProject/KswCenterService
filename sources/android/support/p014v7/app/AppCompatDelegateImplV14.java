...
import android.support.p014v7.app.AppCompatDelegateImplBase;
import android.support.p014v7.view.SupportActionModeWrapper;
...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11 {
    ...
    @Override // android.support.p014v7.app.AppCompatDelegateImplV9, android.support.p014v7.app.AppCompatDelegateImplBase, android.support.p014v7.app.AppCompatDelegate
    public void onStop() {
        super.onStop();
    ...
    public void setLocalNightMode(int mode) {
        switch (mode) {
            ...
            case 2:
                ...
                return;
            default:
                Log.m68i("AppCompatDelegate", "setLocalNightMode() called with an unknown mode");
                return;
        }
    }
    ...
    private boolean shouldRecreateOnNightModeChange() {
        if (this.mApplyDayNightCalled && (this.mContext instanceof Activity)) {
            ...
            try {
                ...
                Log.m71d("AppCompatDelegate", "Exception while getting ActivityInfo", e);
                return true;
            }
        }
        return false;
    ...
    class AppCompatWindowCallbackV14 extends AppCompatDelegateImplBase.AppCompatWindowCallbackBase {
        ...
        final ActionMode startAsSupportActionMode(ActionMode.Callback callback) {
            ...
            android.support.p014v7.view.ActionMode supportActionMode = AppCompatDelegateImplV14.this.startSupportActionMode(callbackWrapper);
    ...
    final class AutoNightModeManager {
        ...
        final void setup() {
            ...
            if (this.mAutoTimeChangeReceiverFilter == null) {
                ...
                this.mAutoTimeChangeReceiverFilter.addAction(Intent.ACTION_TIME_CHANGED);
                this.mAutoTimeChangeReceiverFilter.addAction(Intent.ACTION_TIMEZONE_CHANGED);
                this.mAutoTimeChangeReceiverFilter.addAction(Intent.ACTION_TIME_TICK);
            }
