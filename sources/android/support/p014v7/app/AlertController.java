...
import android.support.p011v4.widget.NestedScrollView;
import android.support.p014v7.appcompat.C2132R;
import android.support.p014v7.widget.LinearLayoutCompat;
...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C2132R.attr.alertDialogCenterButtons, outValue, true);
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C2132R.styleable.AlertDialog, C2132R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C2132R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C2132R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C2132R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C2132R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C2132R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C2132R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C2132R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    */
    private void setupView() {
        ...
        ListView listView;
        View spacer2;
        View parentPanel = this.mWindow.findViewById(C2132R.C2134id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C2132R.C2134id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C2132R.C2134id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C2132R.C2134id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C2132R.C2134id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C2132R.C2134id.topPanel);
        View customContentPanel = customPanel.findViewById(C2132R.C2134id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C2132R.C2134id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer2 = contentPanel.findViewById(C2132R.C2134id.textSpacerNoButtons)) != null) {
        ...
        if (hasTopPanel) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                divider = topPanel.findViewById(C2132R.C2134id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null && (spacer = contentPanel.findViewById(C2132R.C2134id.textSpacerNoTitle)) != null) {
            i = 0;
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C2132R.C2134id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C2132R.C2134id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() { // from class: android.support.v7.app.AlertController.2
                    @Override // android.support.p011v4.widget.NestedScrollView.OnScrollChangeListener
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C2132R.C2134id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C2132R.C2134id.title_template);
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C2132R.C2134id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C2132R.C2134id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C2132R.C2134id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C2132R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C2132R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C2132R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
