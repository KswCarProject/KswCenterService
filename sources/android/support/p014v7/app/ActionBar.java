...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = 0;
            TypedArray a = c.obtainStyledAttributes(attrs, C2132R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C2132R.styleable.ActionBarLayout_android_layout_gravity, 0);
            a.recycle();
        }
