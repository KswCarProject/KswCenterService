...
import android.support.p014v7.app.ActionBarDrawerToggleHoneycomb;
import android.support.p014v7.graphics.drawable.DrawerArrowDrawable;
...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!this.mWarnedForDisplayHomeAsUp && !this.mActivityImpl.isNavigationVisible()) {
            Log.m64w("ActionBarDrawerToggle", "DrawerToggle may not show up because NavigationIcon is not visible. You may need to call actionbar.setDisplayHomeAsUpEnabled(true);");
    ...
    private static class IcsDelegate extends HoneycombDelegate {
        ...
        @Override // android.support.p014v7.app.ActionBarDrawerToggle.HoneycombDelegate, android.support.p014v7.app.ActionBarDrawerToggle.Delegate
        public Context getActionBarThemedContext() {
            ActionBar actionBar = this.mActivity.getActionBar();
            if (actionBar != null) {
