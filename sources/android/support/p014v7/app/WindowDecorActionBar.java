...
import android.support.p011v4.app.FragmentActivity;
import android.support.p011v4.app.FragmentTransaction;
import android.support.p011v4.view.ViewCompat;
import android.support.p011v4.view.ViewPropertyAnimatorCompat;
import android.support.p011v4.view.ViewPropertyAnimatorListener;
import android.support.p011v4.view.ViewPropertyAnimatorListenerAdapter;
import android.support.p011v4.view.ViewPropertyAnimatorUpdateListener;
...
import android.support.p014v7.view.ActionBarPolicy;
import android.support.p014v7.view.ActionMode;
import android.support.p014v7.view.SupportMenuInflater;
import android.support.p014v7.view.ViewPropertyAnimatorCompatSet;
import android.support.p014v7.view.menu.MenuBuilder;
import android.support.p014v7.view.menu.MenuPopupHelper;
import android.support.p014v7.view.menu.SubMenuBuilder;
import android.support.p014v7.widget.ActionBarContainer;
import android.support.p014v7.widget.ActionBarContextView;
import android.support.p014v7.widget.ActionBarOverlayLayout;
import android.support.p014v7.widget.DecorToolbar;
import android.support.p014v7.widget.ScrollingTabContainerView;
...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new ViewPropertyAnimatorUpdateListener() { // from class: android.support.v7.app.WindowDecorActionBar.3
        @Override // android.support.p011v4.view.ViewPropertyAnimatorUpdateListener
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C2132R.C2134id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C2132R.C2134id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C2132R.C2134id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C2132R.C2134id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C2132R.styleable.ActionBar, C2132R.attr.actionBarStyle, 0);
        if (a.getBoolean(C2132R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C2132R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    @Override // android.support.p014v7.app.ActionBar
    ...
    @Override // android.support.p014v7.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            currentTheme.resolveAttribute(C2132R.attr.actionBarWidgetTheme, outValue, true);
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        @Override // android.support.p014v7.view.ActionMode
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // android.support.p014v7.app.ActionBar.Tab
