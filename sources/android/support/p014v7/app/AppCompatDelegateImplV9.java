...
import android.support.p011v4.app.NavUtils;
import android.support.p011v4.view.LayoutInflaterCompat;
import android.support.p011v4.view.OnApplyWindowInsetsListener;
import android.support.p011v4.view.ViewCompat;
import android.support.p011v4.view.ViewPropertyAnimatorCompat;
import android.support.p011v4.view.ViewPropertyAnimatorListenerAdapter;
import android.support.p011v4.view.WindowInsetsCompat;
import android.support.p011v4.widget.PopupWindowCompat;
...
import android.support.p014v7.view.ContextThemeWrapper;
import android.support.p014v7.view.StandaloneActionMode;
import android.support.p014v7.view.menu.ListMenuPresenter;
import android.support.p014v7.view.menu.MenuBuilder;
import android.support.p014v7.view.menu.MenuPresenter;
import android.support.p014v7.view.menu.MenuView;
import android.support.p014v7.widget.ActionBarContextView;
import android.support.p014v7.widget.AppCompatDrawableManager;
import android.support.p014v7.widget.ContentFrameLayout;
import android.support.p014v7.widget.DecorContentParent;
import android.support.p014v7.widget.FitWindowsViewGroup;
import android.support.p014v7.widget.Toolbar;
import android.support.p014v7.widget.VectorEnabledTintResources;
import android.support.p014v7.widget.ViewStubCompat;
import android.support.p014v7.widget.ViewUtils;
...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    @Override // android.support.p014v7.app.AppCompatDelegateImplBase
    ...
    @Override // android.support.p014v7.app.AppCompatDelegateImplBase, android.support.p014v7.app.AppCompatDelegate
    public void onStop() {
        ActionBar ab = getSupportActionBar();
        if (ab != null) {
    ...
    private ViewGroup createSubDecor() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C2132R.styleable.AppCompatTheme);
        if (!a.hasValue(C2132R.styleable.AppCompatTheme_windowActionBar)) {
            a.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (a.getBoolean(C2132R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (a.getBoolean(C2132R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (a.getBoolean(C2132R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (a.getBoolean(C2132R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = a.getBoolean(C2132R.styleable.AppCompatTheme_android_windowIsFloating, false);
        a.recycle();
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C2132R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C2132R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C2132R.layout.abc_screen_toolbar, (ViewGroup) null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C2132R.C2134id.decor_content_parent);
            ...
            if (this.mOverlayActionMode) {
                viewGroup = (ViewGroup) inflater.inflate(C2132R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            } else {
                viewGroup = (ViewGroup) inflater.inflate(C2132R.layout.abc_screen_simple, (ViewGroup) null);
            }
            subDecor = viewGroup;
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(subDecor, new OnApplyWindowInsetsListener() { // from class: android.support.v7.app.AppCompatDelegateImplV9.2
                    @Override // android.support.p011v4.view.OnApplyWindowInsetsListener
                ...
                ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() { // from class: android.support.v7.app.AppCompatDelegateImplV9.3
                    @Override // android.support.p014v7.widget.FitWindowsViewGroup.OnFitSystemWindowsListener
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor.findViewById(C2132R.C2134id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C2132R.C2134id.action_bar_activity_content);
        ...
        contentView.setAttachListener(new ContentFrameLayout.OnAttachListener() { // from class: android.support.v7.app.AppCompatDelegateImplV9.4
            @Override // android.support.p014v7.widget.ContentFrameLayout.OnAttachListener
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C2132R.styleable.AppCompatTheme);
        a.getValue(C2132R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C2132R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C2132R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C2132R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C2132R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C2132R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C2132R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C2132R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C2132R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C2132R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    @Override // android.support.p014v7.view.menu.MenuBuilder.Callback
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C2132R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext2, (AttributeSet) null, C2132R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext2.getTheme().resolveAttribute(C2132R.attr.actionBarSize, outValue, true);
                        ...
                        public void run() {
                            ...
                            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                                ...
                                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.app.AppCompatDelegateImplV9.5.1
                                    @Override // android.support.p011v4.view.ViewPropertyAnimatorListenerAdapter, android.support.p011v4.view.ViewPropertyAnimatorListener
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C2132R.C2134id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    public void installViewFactory() {
        ...
        if (layoutInflater.getFactory() == null) {
            ...
            Log.m68i("AppCompatDelegate", "The Activity's LayoutInflater already has a Factory installed so we can not install AppCompat's");
        }
    }
    ...
    private void openPanel(PanelFeatureState st, KeyEvent event) {
        ...
        st.isHandled = false;
        WindowManager.LayoutParams lp3 = new WindowManager.LayoutParams(width, -2, st.f272x, st.f273y, 1002, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.resolveAttribute(C2132R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C2132R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    private boolean onKeyUpPanel(int featureId, KeyEvent event) {
        ...
        if (handled) {
            ...
            if (audioManager != null) {
                ...
                Log.m64w("AppCompatDelegate", "Couldn't get audio manager");
            }
        }
        return handled;
    }
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C2132R.color.abc_input_method_navigation_guard));
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            Log.m68i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR id when requesting this feature.");
            return 108;
        } else if (featureId == 9) {
            Log.m68i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return 109;
        } else {
            return featureId;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        @Override // android.support.p014v7.view.ActionMode.Callback
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        @Override // android.support.p014v7.view.menu.MenuPresenter.Callback
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C2132R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C2132R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C2132R.C2135style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C2132R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C2132R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C2132R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C2132R.layout.abc_list_menu_item_layout);
