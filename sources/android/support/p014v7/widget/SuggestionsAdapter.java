...
import android.support.p011v4.widget.ResourceCursorAdapter;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    @Override // android.support.p011v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.Adapter
    public boolean hasStableIds() {
        return false;
    }

    @Override // android.support.p011v4.widget.CursorAdapter, android.support.p011v4.widget.CursorFilter.CursorFilterClient
    ...
    @Override // android.support.p011v4.widget.ResourceCursorAdapter, android.support.p011v4.widget.CursorAdapter
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View v = super.newView(context, cursor, parent);
        v.setTag(new ChildViewCache(v));
        ImageView iconRefine = (ImageView) v.findViewById(C2132R.C2134id.edit_query);
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C2132R.C2134id.edit_query);
        }
    }

    @Override // android.support.p011v4.widget.CursorAdapter
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C2132R.attr.textColorSearchUrl, colorValue, true);
    ...
    @Override // android.support.p011v4.widget.CursorAdapter, android.widget.Adapter
    ...
    @Override // android.support.p011v4.widget.CursorAdapter, android.widget.BaseAdapter, android.widget.SpinnerAdapter
