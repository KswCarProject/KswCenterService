...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C2132R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C2132R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C2132R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C2132R.styleable.ActionBar_height, -1);
        if (getId() == C2132R.C2134id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C2132R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C2132R.C2134id.action_bar);
        this.mContextView = findViewById(C2132R.C2134id.action_context_bar);
    }
