...
import android.support.p014v7.view.menu.ListMenuItemView;
import android.support.p014v7.view.menu.MenuAdapter;
...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    static {
        try {
            ...
            Log.m68i(TAG, "Could not find method setTouchModal() on PopupWindow. Oh well.");
        }
    }
    ...
    public void setTouchModal(boolean touchModal) {
        if (sSetTouchModalMethod != null) {
            try {
                ...
                Log.m68i(TAG, "Could not invoke setTouchModal() on PopupWindow. Oh well.");
            }
        }
    }
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        @Override // android.support.p014v7.widget.DropDownListView, android.view.ViewGroup, android.view.View
        public /* bridge */ /* synthetic */ boolean hasFocus() {
            return super.hasFocus();
        }

        @Override // android.support.p014v7.widget.DropDownListView, android.view.View
        ...
        @Override // android.support.p014v7.widget.DropDownListView
