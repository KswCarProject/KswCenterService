...
import android.support.p011v4.widget.AutoSizeableTextView;
...
public class AppCompatButton extends Button implements TintableBackgroundView, AutoSizeableTextView {
    ...
    public AppCompatButton(Context context, AttributeSet attrs) {
        this(context, attrs, C2132R.attr.buttonStyle);
    }
    ...
    @Override // android.widget.TextView, android.support.p011v4.widget.AutoSizeableTextView
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
