...
public class ActionBarContextView extends AbsActionBarView {
    ...
    @Override // android.support.p014v7.widget.AbsActionBarView
    ...
    @Override // android.support.p014v7.widget.AbsActionBarView, android.view.View
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C2132R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C2132R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C2132R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C2132R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C2132R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C2132R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C2132R.styleable.ActionMode_closeItemLayout, C2132R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            inflater.inflate(C2132R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C2132R.C2134id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C2132R.C2134id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View closeButton = this.mClose.findViewById(C2132R.C2134id.action_mode_close_button);
