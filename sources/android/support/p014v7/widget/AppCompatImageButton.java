...
import android.support.p011v4.widget.TintableImageSourceView;
...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public AppCompatImageButton(Context context, AttributeSet attrs) {
        this(context, attrs, C2132R.attr.imageButtonStyle);
    }
    ...
    @Override // android.support.p011v4.widget.TintableImageSourceView
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
