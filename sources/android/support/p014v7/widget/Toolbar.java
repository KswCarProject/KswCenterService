...
import android.support.p011v4.view.MarginLayoutParamsCompat;
...
import android.support.p014v7.view.menu.MenuItemImpl;
import android.support.p014v7.view.menu.MenuPresenter;
import android.support.p014v7.view.menu.MenuView;
import android.support.p014v7.view.menu.SubMenuBuilder;
import android.support.p014v7.widget.ActionMenuView;
...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C2132R.attr.toolbarStyle);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new ActionMenuView.OnMenuItemClickListener() { // from class: android.support.v7.widget.Toolbar.1
            @Override // android.support.p014v7.widget.ActionMenuView.OnMenuItemClickListener
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C2132R.styleable.Toolbar, defStyleAttr, 0);
        this.mTitleTextAppearance = a.getResourceId(C2132R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = a.getResourceId(C2132R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = a.getInteger(C2132R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = a.getInteger(C2132R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_titleMargin, 0);
        titleMargin = a.hasValue(C2132R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(C2132R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
        ...
        int marginStart = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_titleMarginStart, -1);
        if (marginStart >= 0) {
            this.mTitleMarginStart = marginStart;
        }
        int marginEnd = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_titleMarginEnd, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_titleMarginTop, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_titleMarginBottom, -1);
        if (marginBottom >= 0) {
            this.mTitleMarginBottom = marginBottom;
        }
        this.mMaxButtonHeight = a.getDimensionPixelSize(C2132R.styleable.Toolbar_maxButtonHeight, -1);
        int contentInsetStart = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int contentInsetLeft = a.getDimensionPixelSize(C2132R.styleable.Toolbar_contentInsetLeft, 0);
        int contentInsetRight = a.getDimensionPixelSize(C2132R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C2132R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = a.getDrawable(C2132R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = a.getText(C2132R.styleable.Toolbar_collapseContentDescription);
        CharSequence title = a.getText(C2132R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(title)) {
            setTitle(title);
        }
        CharSequence subtitle = a.getText(C2132R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(subtitle)) {
            setSubtitle(subtitle);
        }
        this.mPopupContext = getContext();
        setPopupTheme(a.getResourceId(C2132R.styleable.Toolbar_popupTheme, 0));
        Drawable navIcon = a.getDrawable(C2132R.styleable.Toolbar_navigationIcon);
        if (navIcon != null) {
            setNavigationIcon(navIcon);
        }
        CharSequence navDesc = a.getText(C2132R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(navDesc)) {
            setNavigationContentDescription(navDesc);
        }
        Drawable logo = a.getDrawable(C2132R.styleable.Toolbar_logo);
        if (logo != null) {
            setLogo(logo);
        }
        CharSequence logoDesc = a.getText(C2132R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(logoDesc)) {
            setLogoDescription(logoDesc);
        }
        if (a.hasValue(C2132R.styleable.Toolbar_titleTextColor)) {
            i = -1;
            setTitleTextColor(a.getColor(C2132R.styleable.Toolbar_titleTextColor, -1));
        } else {
            i = -1;
        }
        if (a.hasValue(C2132R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C2132R.styleable.Toolbar_subtitleTextColor, i));
        }
        a.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C2132R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C2132R.attr.toolbarNavigationButtonStyle);
    ...
    */
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        @Override // android.support.p014v7.view.menu.MenuPresenter
