...
class AppCompatTextViewAutoSizeHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C2132R.styleable.AppCompatTextView, defStyleAttr, 0);
        if (a.hasValue(C2132R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = a.getInt(C2132R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        if (a.hasValue(C2132R.styleable.AppCompatTextView_autoSizeStepGranularity)) {
            autoSizeStepGranularityInPx = a.getDimension(C2132R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f);
        }
        if (a.hasValue(C2132R.styleable.AppCompatTextView_autoSizeMinTextSize)) {
            autoSizeMinTextSizeInPx = a.getDimension(C2132R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f);
        }
        if (a.hasValue(C2132R.styleable.AppCompatTextView_autoSizeMaxTextSize)) {
            autoSizeMaxTextSizeInPx = a.getDimension(C2132R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f);
        }
        if (a.hasValue(C2132R.styleable.AppCompatTextView_autoSizePresetSizes) && (autoSizeStepSizeArrayResId = a.getResourceId(C2132R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
        ...
        if (size != this.mTextView.getPaint().getTextSize()) {
            ...
            if (this.mTextView.getLayout() != null) {
                ...
                try {
                    ...
                    Log.m63w(TAG, "Failed to invoke TextView#nullLayouts() method", ex);
                }
                if (!isInLayout) {
    ...
    private <T> T invokeAndReturnWithDefault(@NonNull Object object, @NonNull String methodName, @NonNull T defaultValue) {
        try {
            try {
                ...
                Log.m63w(TAG, "Failed to invoke TextView#" + methodName + "() method", ex);
                if (0 != 0 || 1 == 0) {
                    return null;
                }
            }
    ...
    private Method getTextViewMethod(@NonNull String methodName) {
        try {
            ...
            Log.m63w(TAG, "Failed to retrieve TextView#" + methodName + "() method", ex);
            return null;
        }
    }
