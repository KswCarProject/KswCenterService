...
import android.support.p011v4.view.AbsSavedState;
import android.support.p011v4.view.ViewCompat;
import android.support.p011v4.widget.CursorAdapter;
import android.support.p014v7.appcompat.C2132R;
import android.support.p014v7.view.CollapsibleActionView;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C2132R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C2132R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a.getResourceId(C2132R.styleable.SearchView_layout, C2132R.layout.abc_search_view);
        inflater.inflate(layoutResId, (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C2132R.C2134id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C2132R.C2134id.search_edit_frame);
        this.mSearchPlate = findViewById(C2132R.C2134id.search_plate);
        this.mSubmitArea = findViewById(C2132R.C2134id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C2132R.C2134id.search_button);
        this.mGoButton = (ImageView) findViewById(C2132R.C2134id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C2132R.C2134id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C2132R.C2134id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C2132R.C2134id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C2132R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C2132R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C2132R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C2132R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C2132R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C2132R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C2132R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C2132R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C2132R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C2132R.styleable.SearchView_suggestionRowLayout, C2132R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C2132R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C2132R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C2132R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C2132R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C2132R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C2132R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C2132R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        boolean focusable = a.getBoolean(C2132R.styleable.SearchView_android_focusable, true);
    ...
    @Override // android.support.p014v7.widget.LinearLayoutCompat, android.view.View
    ...
    @Override // android.support.p014v7.widget.LinearLayoutCompat, android.view.ViewGroup, android.view.View
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C2132R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C2132R.dimen.abc_search_view_preferred_height);
    }
    ...
    void onVoiceClicked() {
        ...
        try {
            ...
            Log.m64w(LOG_TAG, "Could not find voice search activity");
        }
    }
    ...
    @Override // android.support.p014v7.view.CollapsibleActionView
    ...
    static class SavedState extends AbsSavedState {
        ...
        @Override // android.support.p011v4.view.AbsSavedState, android.p007os.Parcelable
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C2132R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C2132R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private void launchIntent(Intent intent) {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Failed launch activity: " + intent, ex);
        }
    }
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            Log.m63w(LOG_TAG, "Search suggestions cursor at row " + rowNum + " returned exception.", e);
            return null;
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C2132R.attr.autoCompleteTextViewStyle);
        }
