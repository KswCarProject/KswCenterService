...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (context.getTheme().resolveAttribute(C2132R.attr.actionBarPopupTheme, tv, true) && tv.resourceId != 0) {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C2132R.styleable.ActionBar, C2132R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C2132R.styleable.ActionBar_height, 0));
        a.recycle();
    ...
    protected class VisibilityAnimListener implements ViewPropertyAnimatorListener {
        ...
        @Override // android.support.p011v4.view.ViewPropertyAnimatorListener
