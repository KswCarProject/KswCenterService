...
import android.support.p011v4.view.TintableBackgroundView;
...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C2132R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C2132R.attr.spinnerStyle);
    }
    ...
    */
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Resources.Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C2132R.styleable.Spinner, defStyleAttr, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C2132R.styleable.Spinner_popupTheme, 0);
        ...
        if (this.mPopupContext != null) {
                ...
                if (Build.VERSION.SDK_INT >= 11) {
                    ...
                    try {
                        try {
                            ...
                            Log.m67i(TAG, "Could not read android:spinnerMode", e);
                        }
                    } catch (Throwable th) {
                        if (aa != null) {
                            aa.recycle();
            ...
            if (mode == 1) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C2132R.styleable.Spinner, defStyleAttr, 0);
                this.mDropDownWidth = pa.getLayoutDimension(C2132R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C2132R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C2132R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
        ...
        CharSequence[] entries = a.getTextArray(C2132R.styleable.Spinner_android_entries);
        if (entries != null) {
            ArrayAdapter<CharSequence> adapter = new ArrayAdapter<>(context, 17367048, entries);
            adapter.setDropDownViewResource(C2132R.layout.support_simple_spinner_dropdown_item);
    ...
    @Override // android.support.p011v4.view.TintableBackgroundView
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        @Override // android.support.p014v7.widget.ListPopupWindow
        ...
        @Override // android.support.p014v7.widget.ListPopupWindow, android.support.p014v7.view.menu.ShowableListMenu
        public void show() {
