    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (layout != null && (lineCount = layout.getLineCount()) > 0) {
            ...
            if (ellipsisCount > 0) {
                setSingleLine(false);
                setMaxLines(2);
                TypedArray a = getContext().obtainStyledAttributes(null, C2132R.styleable.TextAppearance, 16842817, 16973892);
                int textSize = a.getDimensionPixelSize(C2132R.styleable.TextAppearance_android_textSize, 0);
                if (textSize != 0) {
