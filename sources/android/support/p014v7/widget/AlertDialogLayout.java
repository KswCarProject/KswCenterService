    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C2132R.C2134id.topPanel) {
                    topPanel = child;
                } else if (id == C2132R.C2134id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C2132R.C2134id.contentPanel && id != C2132R.C2134id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
