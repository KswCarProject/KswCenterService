...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C2132R.attr.actionBarSize, 16842841};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C2132R.C2134id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C2132R.C2134id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C2132R.C2134id.action_bar));
        }
    }
    ...
    @Override // android.support.p014v7.widget.DecorContentParent
