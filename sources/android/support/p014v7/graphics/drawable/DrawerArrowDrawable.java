package android.support.p014v7.graphics.drawable;
...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C2132R.styleable.DrawerArrowToggle, C2132R.attr.drawerArrowStyle, C2132R.C2135style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C2132R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C2132R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C2132R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize(Math.round(a.getDimension(C2132R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C2132R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(a.getDimension(C2132R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(a.getDimension(C2132R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C2132R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
    ...
    public void setProgress(@FloatRange(from = 0.0d, m105to = 1.0d) float progress) {
