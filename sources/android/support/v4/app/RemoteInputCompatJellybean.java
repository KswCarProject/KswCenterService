...
class RemoteInputCompatJellybean {
    ...
    static RemoteInputCompatBase.RemoteInput fromBundle(Bundle data, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        return factory.build(data.getString(KEY_RESULT_KEY), data.getCharSequence("label"), data.getCharSequenceArray(KEY_CHOICES), data.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), data.getBundle(KEY_EXTRAS), hashSet);
    }
    ...
    private static Intent getClipDataIntentFromIntent(Intent intent) {
        ...
        if (clipDescription.hasMimeType(ClipDescription.MIMETYPE_TEXT_INTENT) && clipDescription.getLabel().equals("android.remoteinput.results")) {
