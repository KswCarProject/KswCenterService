...
public final class LocalBroadcastManager {
    ...
    public boolean sendBroadcast(android.content.Intent r19) {
        /*
            ...
            monitor-enter(r3)
            java.lang.String r5 = r19.getAction()     // Catch:{ all -> 0x0166 }
            android.content.Context r0 = r1.mAppContext     // Catch:{ all -> 0x0166 }
            android.content.ContentResolver r0 = r0.getContentResolver()     // Catch:{ all -> 0x0166 }
            java.lang.String r0 = r2.resolveTypeIfNeeded(r0)     // Catch:{ all -> 0x0166 }
            android.net.Uri r8 = r19.getData()     // Catch:{ all -> 0x0166 }
            java.lang.String r4 = r19.getScheme()     // Catch:{ all -> 0x0166 }
            r11 = r4
            java.util.Set r9 = r19.getCategories()     // Catch:{ all -> 0x0166 }
            int r4 = r19.getFlags()     // Catch:{ all -> 0x0166 }
            r4 = r4 & 8
        ...
        L_0x002e:
            ...
            r6.append(r0)     // Catch:{ all -> 0x0166 }
            java.lang.String r7 = " scheme "
            r6.append(r7)     // Catch:{ all -> 0x0166 }
            r6.append(r11)     // Catch:{ all -> 0x0166 }
            java.lang.String r7 = " of intent "
            r6.append(r7)     // Catch:{ all -> 0x0166 }
            r6.append(r2)     // Catch:{ all -> 0x0166 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0166 }
            android.util.Log.v(r4, r6)     // Catch:{ all -> 0x0166 }
        L_0x0057:
            java.util.HashMap<java.lang.String, java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$ReceiverRecord>> r4 = r1.mActions     // Catch:{ all -> 0x0166 }
            java.lang.String r6 = r19.getAction()     // Catch:{ all -> 0x0166 }
            java.lang.Object r4 = r4.get(r6)     // Catch:{ all -> 0x0166 }
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0166 }
            r15 = r4
            ...
            r6.append(r7)     // Catch:{ all -> 0x0166 }
            r6.append(r15)     // Catch:{ all -> 0x0166 }
            java.lang.String r6 = r6.toString()     // Catch:{ all -> 0x0166 }
            android.util.Log.v(r4, r6)     // Catch:{ all -> 0x0166 }
        L_0x007e:
            r4 = 0
        ...
        L_0x0081:
            r7 = r4
            int r4 = r15.size()     // Catch:{ all -> 0x0166 }
            if (r7 >= r4) goto L_0x0130
            java.lang.Object r4 = r15.get(r7)     // Catch:{ all -> 0x0166 }
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r4 = (android.support.v4.content.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x0166 }
            r6 = r4
            if (r14 == 0) goto L_0x00a9
            java.lang.String r4 = "LocalBroadcastManager"
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ all -> 0x0166 }
            r12.<init>()     // Catch:{ all -> 0x0166 }
            java.lang.String r13 = "Matching against filter "
            r12.append(r13)     // Catch:{ all -> 0x0166 }
            android.content.IntentFilter r13 = r6.filter     // Catch:{ all -> 0x0166 }
            r12.append(r13)     // Catch:{ all -> 0x0166 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x0166 }
            android.util.Log.v(r4, r12)     // Catch:{ all -> 0x0166 }
        L_0x00a9:
            boolean r4 = r6.broadcasting     // Catch:{ all -> 0x0166 }
        ...
        L_0x00b6:
            ...
            goto L_0x0129
        L_0x00bd:
            android.content.IntentFilter r4 = r6.filter     // Catch:{ all -> 0x0166 }
            ...
            r0 = r10
            r10 = r12
            int r4 = r4.match(r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0166 }
            ...
            r7.append(r10)     // Catch:{ all -> 0x0166 }
            java.lang.String r10 = java.lang.Integer.toHexString(r4)     // Catch:{ all -> 0x0166 }
            r7.append(r10)     // Catch:{ all -> 0x0166 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0166 }
            android.util.Log.v(r6, r7)     // Catch:{ all -> 0x0166 }
        L_0x00ec:
            if (r0 != 0) goto L_0x00f5
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0166 }
            r6.<init>()     // Catch:{ all -> 0x0166 }
            r10 = r6
            r0 = r10
        L_0x00f5:
            r0.add(r13)     // Catch:{ all -> 0x0166 }
            r6 = 1
            r13.broadcasting = r6     // Catch:{ all -> 0x0166 }
            r10 = r0
            goto L_0x012a
        L_0x00fd:
        ...
        L_0x0130:
            ...
            r4 = 0
        L_0x0136:
            int r6 = r0.size()     // Catch:{ all -> 0x0166 }
            if (r4 >= r6) goto L_0x0148
            java.lang.Object r6 = r0.get(r4)     // Catch:{ all -> 0x0166 }
            android.support.v4.content.LocalBroadcastManager$ReceiverRecord r6 = (android.support.v4.content.LocalBroadcastManager.ReceiverRecord) r6     // Catch:{ all -> 0x0166 }
            r7 = 0
            r6.broadcasting = r7     // Catch:{ all -> 0x0166 }
            int r4 = r4 + 1
            goto L_0x0136
        L_0x0148:
            java.util.ArrayList<android.support.v4.content.LocalBroadcastManager$BroadcastRecord> r4 = r1.mPendingBroadcasts     // Catch:{ all -> 0x0166 }
            android.support.v4.content.LocalBroadcastManager$BroadcastRecord r6 = new android.support.v4.content.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x0166 }
            r6.<init>(r2, r0)     // Catch:{ all -> 0x0166 }
            r4.add(r6)     // Catch:{ all -> 0x0166 }
            android.os.Handler r4 = r1.mHandler     // Catch:{ all -> 0x0166 }
            r6 = 1
            boolean r4 = r4.hasMessages(r6)     // Catch:{ all -> 0x0166 }
            if (r4 != 0) goto L_0x0160
            android.os.Handler r4 = r1.mHandler     // Catch:{ all -> 0x0166 }
            r4.sendEmptyMessage(r6)     // Catch:{ all -> 0x0166 }
        L_0x0160:
