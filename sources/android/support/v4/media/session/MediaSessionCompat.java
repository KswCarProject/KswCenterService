                ...
                if (cb != null) {
                    switch (msg.what) {
                        ...
                        case 21:
                            ...
                            intent.putExtra(Intent.EXTRA_KEY_EVENT, (Parcelable) keyEvent);
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle metadata) {
            ...
            if (metadata.containsKey("android.media.metadata.USER_RATING")) {
                editor.putObject(MediaMetadataEditor.RATING_KEY_BY_USER, metadata.getParcelable("android.media.metadata.USER_RATING"));
            }
            return editor;
        }
    }
