...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    private static class MediaButtonConnectionCallback extends MediaBrowserCompat.ConnectionCallback {
        ...
        public void onConnected() {
            try {
                new MediaControllerCompat(this.mContext, this.mMediaBrowser.getSessionToken()).dispatchMediaButtonEvent((KeyEvent) this.mIntent.getParcelableExtra(Intent.EXTRA_KEY_EVENT));
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, ComponentName mbrComponent, long action) {
        ...
        intent.putExtra(Intent.EXTRA_KEY_EVENT, (Parcelable) new KeyEvent(0, keyCode));
