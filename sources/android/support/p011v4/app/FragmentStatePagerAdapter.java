...
import android.support.p011v4.view.PagerAdapter;
...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    @Override // android.support.p011v4.view.PagerAdapter
    ...
    public Parcelable saveState() {
        ...
        for (int i = 0; i < this.mFragments.size(); i++) {
            ...
            if (f != null && f.isAdded()) {
                ...
                String key = FullBackup.FILES_TREE_TOKEN + i;
    ...
    public void restoreState(Parcelable state, ClassLoader loader) {
        if (state != null) {
            ...
            for (String key : keys) {
                if (key.startsWith(FullBackup.FILES_TREE_TOKEN)) {
                    ...
                    if (f != null) {
                        ...
                        Log.m64w(TAG, "Bad fragment at key " + key);
                    }
                }
            }
        }
