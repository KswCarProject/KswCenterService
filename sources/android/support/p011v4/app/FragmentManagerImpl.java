...
import android.support.p011v4.util.ArraySet;
import android.support.p011v4.util.DebugUtils;
...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    @Override // android.support.p011v4.app.FragmentManager
    ...
    private static Animation.AnimationListener getAnimationListener(Animation animation) {
        try {
            ...
            Log.m69e(TAG, "Cannot access Animation's mListener field", e);
            return null;
        } catch (NoSuchFieldException e2) {
            Log.m69e(TAG, "No field with the name mListener is found in Animation class", e2);
            return null;
        }
    }
        ...
        if (f.mState <= newState2) {
            ...
            switch (f.mState) {
                ...
                case 3:
                    if (newState2 < 3) {
                        if (DEBUG) {
                            Log.m66v(TAG, "movefrom STOPPED: " + f);
                        }
                        f.performReallyStop();
                    }
                    if (newState2 < 2) {
    ...
    private void animateRemoveFragment(@NonNull final Fragment fragment, @NonNull AnimationOrAnimator anim, int newState) {
        ...
        if (anim.animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(listener) { // from class: android.support.v4.app.FragmentManagerImpl.2
                @Override // android.support.p011v4.app.FragmentManagerImpl.AnimationListenerWrapper, android.view.animation.Animation.AnimationListener
    ...
    */
    ...
    static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        @Override // android.support.p011v4.app.Fragment.OnStartEnterTransitionListener
