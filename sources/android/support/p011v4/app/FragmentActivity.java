...
import android.support.p011v4.app.ActivityCompat;
...
public class FragmentActivity extends BaseFragmentActivityApi16 implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    @Override // android.support.p011v4.app.BaseFragmentActivityApi14, android.app.Activity, android.view.LayoutInflater.Factory2
    public /* bridge */ /* synthetic */ View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        return super.onCreateView(view, str, context, attributeSet);
    }

    @Override // android.support.p011v4.app.BaseFragmentActivityApi14, android.app.Activity, android.view.LayoutInflater.Factory
    public /* bridge */ /* synthetic */ View onCreateView(String str, Context context, AttributeSet attributeSet) {
        return super.onCreateView(str, context, attributeSet);
    }

    @Override // android.support.p011v4.app.BaseFragmentActivityApi16, android.app.Activity
    @RequiresApi(16)
    public /* bridge */ /* synthetic */ void startActivityForResult(Intent intent, int i, @Nullable Bundle bundle) {
        super.startActivityForResult(intent, i, bundle);
    }

    @Override // android.support.p011v4.app.BaseFragmentActivityApi14, android.app.Activity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestIndex != 0) {
            ...
            if (who == null) {
                Log.m64w(TAG, "Activity result delivered for unknown Fragment.");
                return;
            }
            Fragment targetFragment = this.mFragments.findFragmentByWho(who);
            if (targetFragment == null) {
                Log.m64w(TAG, "Activity result no fragment exists for who: " + who);
                return;
            }
    ...
    @Override // android.support.p011v4.app.SupportActivity, android.arch.lifecycle.LifecycleOwner
    public Lifecycle getLifecycle() {
        return super.getLifecycle();
    }

    @Override // android.support.p011v4.app.SupportActivity, android.app.Activity
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(NEXT_CANDIDATE_REQUEST_INDEX_TAG)) {
                ...
                if (requestCodes == null || fragmentWhos == null || requestCodes.length != fragmentWhos.length) {
                    Log.m64w(TAG, "Invalid requestCode mapping in savedInstanceState.");
                } else {
    ...
    @Override // android.support.p011v4.app.BaseFragmentActivityApi14
    ...
    @Override // android.support.p011v4.app.ActivityCompat.RequestPermissionsRequestCodeValidator
    ...
    @Override // android.app.Activity, android.support.p011v4.app.ActivityCompat.OnRequestPermissionsResultCallback
    ...
    class HostCallbacks extends FragmentHostCallback<FragmentActivity> {
        ...
        @Override // android.support.p011v4.app.FragmentHostCallback
        ...
        @Override // android.support.p011v4.app.FragmentHostCallback, android.support.p011v4.app.FragmentContainer
        @Nullable
