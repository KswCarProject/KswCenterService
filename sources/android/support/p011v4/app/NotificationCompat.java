...
import android.support.compat.C1899R;
import android.support.p011v4.app.NotificationCompatApi20;
import android.support.p011v4.app.NotificationCompatApi21;
import android.support.p011v4.app.NotificationCompatApi24;
import android.support.p011v4.app.NotificationCompatApi26;
import android.support.p011v4.app.NotificationCompatBase;
import android.support.p011v4.app.NotificationCompatJellybean;
import android.support.p011v4.app.NotificationCompatKitKat;
import android.support.p011v4.app.RemoteInputCompatBase;
import android.support.p011v4.text.BidiFormatter;
...
public class NotificationCompat {
    ...
    static class NotificationCompatBaseImpl implements NotificationCompatImpl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
    ...
    static class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
            Bundle extras;
    ...
    static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    static class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
    ...
    static class NotificationCompatApi24Impl extends NotificationCompatApi21Impl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatApi21Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Action[] getActionsFromParcelableArrayList(ArrayList<Parcelable> parcelables) {
    ...
    static class NotificationCompatApi26Impl extends NotificationCompatApi24Impl {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.NotificationCompatApi24Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi21Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi20Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi19Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatApi16Impl, android.support.p011v4.app.NotificationCompat.NotificationCompatBaseImpl, android.support.p011v4.app.NotificationCompat.NotificationCompatImpl
        public Notification build(Builder b, BuilderExtender extender) {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C1899R.C1901id.notification_background, "setBackgroundResource", C1899R.C1900drawable.notification_bg_low);
                    contentView.setInt(C1899R.C1901id.icon, "setBackgroundResource", C1899R.C1900drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C1899R.C1901id.notification_background, "setBackgroundResource", C1899R.C1900drawable.notification_bg);
                    contentView.setInt(C1899R.C1901id.icon, "setBackgroundResource", C1899R.C1900drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C1899R.C1901id.icon, 0);
                    contentView.setImageViewBitmap(C1899R.C1901id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C1899R.C1901id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C1899R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C1899R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT < 21) {
                        contentView.setImageViewBitmap(C1899R.C1901id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    } else {
                        Bitmap smallBit = createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor());
                        contentView.setImageViewBitmap(C1899R.C1901id.right_icon, smallBit);
                    }
                    contentView.setViewVisibility(C1899R.C1901id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C1899R.C1901id.icon, 0);
                if (Build.VERSION.SDK_INT < 21) {
                    contentView.setImageViewBitmap(C1899R.C1901id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                } else {
                    int backgroundSize2 = res.getDimensionPixelSize(C1899R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C1899R.dimen.notification_big_circle_margin);
                    int iconSize2 = res.getDimensionPixelSize(C1899R.dimen.notification_small_icon_size_as_large);
                    ...
                    contentView.setImageViewBitmap(C1899R.C1901id.icon, smallBit2);
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C1899R.C1901id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C1899R.C1901id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C1899R.C1901id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C1899R.C1901id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                int tooBig = res.getInteger(C1899R.integer.status_bar_notification_info_maxnum);
                if (this.mBuilder.mNumber > tooBig) {
                    contentView.setTextViewText(C1899R.C1901id.info, res.getString(C1899R.string.status_bar_notification_info_overflow));
                } else {
                    NumberFormat f = NumberFormat.getIntegerInstance();
                    contentView.setTextViewText(C1899R.C1901id.info, f.format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C1899R.C1901id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C1899R.C1901id.info, 8);
            }
            boolean showLine32 = showLine3;
            boolean hasRightSide2 = hasRightSide;
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C1899R.C1901id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C1899R.C1901id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C1899R.C1901id.text2, 0);
                    showLine2 = true;
                    i = 8;
                    if (!showLine2 && Build.VERSION.SDK_INT >= 16) {
                        if (fitIn1U) {
                            float subTextSize = res.getDimensionPixelSize(C1899R.dimen.notification_subtext_size);
                            contentView.setTextViewTextSize(C1899R.C1901id.text, 0, subTextSize);
                        }
                        i2 = i;
                        contentView.setViewPadding(C1899R.C1901id.line1, 0, 0, 0, 0);
                    } else {
                        i2 = i;
                    }
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        if (this.mBuilder.mUseChronometer && Build.VERSION.SDK_INT >= 16) {
                            contentView.setViewVisibility(C1899R.C1901id.chronometer, 0);
                            contentView.setLong(C1899R.C1901id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            contentView.setBoolean(C1899R.C1901id.chronometer, "setStarted", true);
                        } else {
                            contentView.setViewVisibility(C1899R.C1901id.time, 0);
                            contentView.setLong(C1899R.C1901id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        }
                        hasRightSide2 = true;
                    }
                    contentView.setViewVisibility(C1899R.C1901id.right_side, !hasRightSide2 ? 0 : i2);
                    contentView.setViewVisibility(C1899R.C1901id.line3, showLine32 ? 0 : i2);
                    return contentView;
                }
                i = 8;
                contentView.setViewVisibility(C1899R.C1901id.text2, 8);
            } else {
                i = 8;
            }
            showLine2 = false;
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C1899R.C1900drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C1899R.C1901id.notification_main_column);
            outerView.addView(C1899R.C1901id.notification_main_column, innerView.mo149clone());
            outerView.setViewVisibility(C1899R.C1901id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C1899R.C1901id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C1899R.C1901id.title, 8);
            outerView.setViewVisibility(C1899R.C1901id.text2, 8);
            outerView.setViewVisibility(C1899R.C1901id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C1899R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C1899R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            int numActions;
            RemoteViews remoteViews = applyStandardTemplate(true, C1899R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C1899R.C1901id.actions);
            ...
            if (showActions && this.mBuilder.mActions != null && (numActions = Math.min(this.mBuilder.mActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    ...
                    remoteViews.addView(C1899R.C1901id.actions, button);
                }
            }
            int actionVisibility = actionsVisible ? 0 : 8;
            remoteViews.setViewVisibility(C1899R.C1901id.actions, actionVisibility);
            remoteViews.setViewVisibility(C1899R.C1901id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), tombstone ? C1899R.layout.notification_action_tombstone : C1899R.layout.notification_action);
            button.setImageViewBitmap(C1899R.C1901id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C1899R.color.notification_action_color_filter)));
            button.setTextViewText(C1899R.C1901id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C1899R.C1901id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C1899R.C1901id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action extends NotificationCompatBase.Action {
        ...
        public static final NotificationCompatBase.Action.Factory FACTORY = new NotificationCompatBase.Action.Factory() { // from class: android.support.v4.app.NotificationCompat.Action.1
            @Override // android.support.p011v4.app.NotificationCompatBase.Action.Factory
        ...
        @Override // android.support.p011v4.app.NotificationCompatBase.Action
        public int getIcon() {
            return this.icon;
        }
        ...
        public static final class WearableExtender implements Extender {
            ...
            @Override // android.support.p011v4.app.NotificationCompat.Action.Extender
            ...
            /* renamed from: clone */
            public WearableExtender m168clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        @Override // android.support.p011v4.app.NotificationCompat.Extender
        public Builder extend(Builder builder) {
            Bundle wearableBundle = new Bundle();
        ...
        /* renamed from: clone */
        public WearableExtender m169clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends NotificationCompatBase.UnreadConversation {
            static final NotificationCompatBase.UnreadConversation.Factory FACTORY = new NotificationCompatBase.UnreadConversation.Factory() { // from class: android.support.v4.app.NotificationCompat.CarExtender.UnreadConversation.1
                @Override // android.support.p011v4.app.NotificationCompatBase.UnreadConversation.Factory
            ...
            @Override // android.support.p011v4.app.NotificationCompatBase.UnreadConversation
