...
import android.support.p011v4.app.LoaderManager;
...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements Loader.OnLoadCompleteListener<Object>, Loader.OnLoadCanceledListener<Object> {
        ...
        void destroy() {
            ...
            if (this.mCallbacks != null && this.mLoader != null && this.mHaveData && needReset) {
                if (LoaderManagerImpl.DEBUG) {
                    Log.m66v(LoaderManagerImpl.TAG, "  Resetting: " + this);
                }
        ...
        @Override // android.support.p011v4.content.Loader.OnLoadCanceledListener
        ...
        @Override // android.support.p011v4.content.Loader.OnLoadCompleteListener
    ...
    @Override // android.support.p011v4.app.LoaderManager
