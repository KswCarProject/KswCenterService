...
import android.support.p011v4.app.Fragment;
import android.support.p011v4.app.FragmentManager;
import android.support.p011v4.app.FragmentManagerImpl;
import android.support.p011v4.util.LogWriter;
...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    ArrayList<C1937Op> mOps = new ArrayList<>();
    ...
    static final class C1937Op {
        ...
        C1937Op(int cmd, Fragment fragment) {
            this.cmd = cmd;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C1937Op op = this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
    ...
    @Override // android.support.p011v4.app.FragmentManager.BackStackEntry
    public int getId() {
        return this.mIndex;
    }
    ...
    @Override // android.support.p011v4.app.FragmentTransaction
    ...
    private void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C1937Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C1937Op(3, fragment));
        return this;
    }

    @Override // android.support.p011v4.app.FragmentTransaction
    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C1937Op(4, fragment));
        return this;
    }

    @Override // android.support.p011v4.app.FragmentTransaction
    public FragmentTransaction show(Fragment fragment) {
        addOp(new C1937Op(5, fragment));
        return this;
    }

    @Override // android.support.p011v4.app.FragmentTransaction
    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C1937Op(6, fragment));
        return this;
    }

    @Override // android.support.p011v4.app.FragmentTransaction
    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C1937Op(7, fragment));
        return this;
    }

    @Override // android.support.p011v4.app.FragmentTransaction
    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C1937Op(8, fragment));
        return this;
    }
    ...
    @Override // android.support.p011v4.app.FragmentManagerImpl.OpGenerator
    ...
    boolean interactsWith(ArrayList<BackStackRecord> records, int startIndex, int endIndex) {
        ...
        for (int lastContainer2 = 0; lastContainer2 < numOps; lastContainer2++) {
            C1937Op op = this.mOps.get(lastContainer2);
            ...
            if (container != 0 && container != lastContainer) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C1937Op thatOp = record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C1937Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C1937Op removeOp = new C1937Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment == oldPrimaryNav) {
                        this.mOps.add(opNum, new C1937Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    } else {
                ...
                case 8:
                    this.mOps.add(opNum, new C1937Op(9, oldPrimaryNav));
                    opNum++;
    ...
    private static boolean isFragmentPostponed(C1937Op op) {
