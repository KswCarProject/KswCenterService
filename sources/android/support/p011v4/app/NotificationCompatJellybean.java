...
class NotificationCompatJellybean {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        ...
        /* renamed from: b */
        private Notification.Builder f265b;
        ...
        public void addAction(NotificationCompatBase.Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f265b, action));
        }
        ...
        public Notification build() {
            Notification notif = this.f265b.build();
            ...
            try {
                if (sExtrasField == null) {
                    ...
                    if (!Bundle.class.isAssignableFrom(extrasField.getType())) {
                        Log.m70e(TAG, "Notification.extras field is not of type Bundle");
                ...
                Log.m69e(TAG, "Unable to access notification extras", e);
                sExtrasFieldAccessFailed = true;
                return null;
            } catch (NoSuchFieldException e2) {
                Log.m69e(TAG, "Unable to access notification extras", e2);
                sExtrasFieldAccessFailed = true;
                return null;
            }
        }
        ...
        synchronized (sActionsLock) {
            try {
                try {
                    ...
                    Log.m69e(TAG, "Unable to access notification actions", e);
    ...
    private static boolean ensureActionReflectionReadyLocked() {
        ...
        try {
            if (sActionsField == null) {
                ...
                sActionsField = Notification.class.getDeclaredField(Slice.HINT_ACTIONS);
            ...
            Log.m69e(TAG, "Unable to access notification actions", e2);
            sActionsAccessFailed = true;
        }
