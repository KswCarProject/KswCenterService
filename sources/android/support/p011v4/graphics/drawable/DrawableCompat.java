...
public final class DrawableCompat {
    ...
    static class DrawableCompatApi17Impl extends DrawableCompatBaseImpl {
        ...
        @Override // android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public boolean setLayoutDirection(Drawable drawable, int layoutDirection) {
            if (!sSetLayoutDirectionMethodFetched) {
                try {
                    ...
                    Log.m67i(TAG, "Failed to retrieve setLayoutDirection(int) method", e);
                }
            ...
            if (sSetLayoutDirectionMethod != null) {
                try {
                    ...
                    Log.m67i(TAG, "Failed to invoke setLayoutDirection(int) via reflection", e2);
        ...
        public int getLayoutDirection(Drawable drawable) {
            if (!sGetLayoutDirectionMethodFetched) {
                try {
                    ...
                    Log.m67i(TAG, "Failed to retrieve getLayoutDirection() method", e);
                }
            ...
            if (sGetLayoutDirectionMethod != null) {
                try {
                    ...
                    Log.m67i(TAG, "Failed to invoke getLayoutDirection() via reflection", e2);
    ...
    static class DrawableCompatApi21Impl extends DrawableCompatApi19Impl {
        ...
        @Override // android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatApi19Impl, android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public Drawable wrap(Drawable drawable) {
            if (!(drawable instanceof TintAwareDrawable)) {
    ...
    static class DrawableCompatApi23Impl extends DrawableCompatApi21Impl {
        ...
        @Override // android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatApi17Impl, android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public boolean setLayoutDirection(Drawable drawable, int layoutDirection) {
        ...
        @Override // android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatApi21Impl, android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatApi19Impl, android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public Drawable wrap(Drawable drawable) {
            return drawable;
        }

        @Override // android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatApi21Impl, android.support.p011v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl
        public void clearColorFilter(Drawable drawable) {
            drawable.clearColorFilter();
        }
    }
