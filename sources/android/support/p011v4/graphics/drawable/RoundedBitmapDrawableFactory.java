...
import android.support.p011v4.graphics.BitmapCompat;
...
public final class RoundedBitmapDrawableFactory {
    ...
    private static class DefaultRoundedBitmapDrawable extends RoundedBitmapDrawable {
        ...
        @Override // android.support.p011v4.graphics.drawable.RoundedBitmapDrawable
    ...
    public static RoundedBitmapDrawable create(Resources res, String filepath) {
        ...
        if (drawable.getBitmap() == null) {
            Log.m64w(TAG, "RoundedBitmapDrawable cannot decode " + filepath);
        }
        return drawable;
    }
    ...
    public static RoundedBitmapDrawable create(Resources res, InputStream is) {
        ...
        if (drawable.getBitmap() == null) {
            Log.m64w(TAG, "RoundedBitmapDrawable cannot decode " + is);
        }
        return drawable;
    }
