...
public final class TextViewCompat {
    ...
    static class TextViewCompatBaseImpl {
        ...
        private static Field retrieveField(String fieldName) {
            ...
            try {
                ...
                Log.m70e(LOG_TAG, "Could not retrieve " + fieldName + " field.");
                return field;
            }
        }
        ...
        private static int retrieveIntFromField(Field field, TextView textView) {
            try {
                ...
                Log.m72d(LOG_TAG, "Could not retrieve value of " + field.getName() + " field.");
                return -1;
            }
        }
    ...
    static class TextViewCompatApi16Impl extends TextViewCompatBaseImpl {
        ...
        @Override // android.support.p011v4.widget.TextViewCompat.TextViewCompatBaseImpl
        public int getMaxLines(TextView textView) {
    ...
    static class TextViewCompatApi18Impl extends TextViewCompatApi17Impl {
        ...
        @Override // android.support.p011v4.widget.TextViewCompat.TextViewCompatApi17Impl, android.support.p011v4.widget.TextViewCompat.TextViewCompatBaseImpl
        public void setCompoundDrawablesRelative(@NonNull TextView textView, @Nullable Drawable start, @Nullable Drawable top, @Nullable Drawable end, @Nullable Drawable bottom) {
