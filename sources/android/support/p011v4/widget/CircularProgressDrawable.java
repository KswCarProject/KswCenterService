...
import android.support.p011v4.view.animation.FastOutSlowInInterpolator;
    ...
    public void applyTransformation(float interpolatedTime, Ring ring, boolean lastFrame) {
        ...
        if (this.mFinishing) {
            ...
            if (interpolatedTime < 0.5f) {
                ...
                float endTrim = (MATERIAL_INTERPOLATOR.getInterpolation(scaledTime) * 0.79f) + 0.01f + startTrim3;
                startTrim2 = startTrim3;
                startTrim = endTrim;
            } else {
                float endTrim2 = interpolatedTime - 0.5f;
                float scaledTime2 = endTrim2 / 0.5f;
                startTrim = ring.getStartingStartTrim() + 0.79f;
                startTrim2 = startTrim - (((1.0f - MATERIAL_INTERPOLATOR.getInterpolation(scaledTime2)) * 0.79f) + 0.01f);
            }
