...
public final class CompoundButtonCompat {
        ...
        public Drawable getButtonDrawable(CompoundButton button) {
            if (!sButtonDrawableFieldFetched) {
                try {
                    ...
                    Log.m67i(TAG, "Failed to retrieve mButtonDrawable field", e);
                }
            ...
            if (sButtonDrawableField != null) {
                try {
                    ...
                    Log.m67i(TAG, "Failed to get button drawable via reflection", e2);
    ...
    static class CompoundButtonCompatApi21Impl extends CompoundButtonCompatBaseImpl {
        ...
        @Override // android.support.p011v4.widget.CompoundButtonCompat.CompoundButtonCompatBaseImpl
        public void setButtonTintList(CompoundButton button, ColorStateList tint) {
