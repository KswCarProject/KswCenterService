...
public final class PopupWindowCompat {
    ...
    static class PopupWindowCompatApi19Impl extends PopupWindowCompatBaseImpl {
        ...
        @Override // android.support.p011v4.widget.PopupWindowCompat.PopupWindowCompatBaseImpl
        public void showAsDropDown(PopupWindow popup, View anchor, int xoff, int yoff, int gravity) {
    ...
    static class PopupWindowCompatApi21Impl extends PopupWindowCompatApi19Impl {
        ...
        static {
            try {
                ...
                Log.m67i(TAG, "Could not fetch mOverlapAnchor field from PopupWindow", e);
            }
        }
        ...
        public void setOverlapAnchor(PopupWindow popupWindow, boolean overlapAnchor) {
            if (sOverlapAnchorField != null) {
                try {
                    ...
                    Log.m67i(TAG, "Could not set overlap anchor field in PopupWindow", e);
                }
            }
        }
        ...
        public boolean getOverlapAnchor(PopupWindow popupWindow) {
            if (sOverlapAnchorField != null) {
                try {
                    ...
                    Log.m67i(TAG, "Could not get overlap anchor field in PopupWindow", e);
                    return false;
                }
            }
            return false;
    ...
    static class PopupWindowCompatApi23Impl extends PopupWindowCompatApi21Impl {
        ...
        @Override // android.support.p011v4.widget.PopupWindowCompat.PopupWindowCompatApi21Impl, android.support.p011v4.widget.PopupWindowCompat.PopupWindowCompatBaseImpl
        public void setOverlapAnchor(PopupWindow popupWindow, boolean overlapAnchor) {
