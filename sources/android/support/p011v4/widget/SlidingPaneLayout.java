...
import android.support.p011v4.view.AccessibilityDelegateCompat;
...
import android.support.p011v4.widget.ViewDragHelper;
...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public static class SimplePanelSlideListener implements PanelSlideListener {
        @Override // android.support.p011v4.widget.SlidingPaneLayout.PanelSlideListener
    ...
    */
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount2 > 2) {
            Log.m70e(TAG, "onMeasure: More than two child views are not supported.");
        }
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int childWidthSpec = lp.width == -2 ? View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, Integer.MIN_VALUE) : lp.width == -1 ? View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, 1073741824) : View.MeasureSpec.makeMeasureSpec(lp.width, 1073741824);
                child.measure(childWidthSpec, lp.height == -2 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE) : lp.height == -1 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824) : View.MeasureSpec.makeMeasureSpec(lp.height, 1073741824));
                int childWidth = child.getMeasuredWidth();
                int childHeight = child.getMeasuredHeight();
                if (heightMode2 == Integer.MIN_VALUE && childHeight > widthRemaining2) {
                    widthRemaining2 = Math.min(childHeight, maxLayoutHeight2);
                }
                ...
                if (child2.getVisibility() != i) {
                    ...
                    if (child2.getVisibility() != i) {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            ...
                            if (lp2.weight > 0.0f) {
                                int childHeightSpec2 = lp2.width == 0 ? lp2.height == -2 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE) : lp2.height == -1 ? View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, 1073741824) : View.MeasureSpec.makeMeasureSpec(lp2.height, 1073741824) : View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), 1073741824);
                                if (canSlide) {
                                    ...
                                    child2.measure(childWidthSpec3, childHeightSpec2);
                                }
                            } else {
                                fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                maxLayoutHeight = maxLayoutHeight2;
    ...
    */
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        @Override // android.support.p011v4.widget.ViewDragHelper.Callback
    ...
    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        ...
        @Override // android.support.p011v4.widget.SlidingPaneLayout.SlidingPanelLayoutImpl
    ...
    static class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
        ...
        SlidingPanelLayoutImplJB() {
            try {
                ...
                Log.m69e(SlidingPaneLayout.TAG, "Couldn't fetch getDisplayList method; dimming won't work right.", e);
            }
            try {
                this.mRecreateDisplayList = View.class.getDeclaredField("mRecreateDisplayList");
                this.mRecreateDisplayList.setAccessible(true);
            } catch (NoSuchFieldException e2) {
                Log.m69e(SlidingPaneLayout.TAG, "Couldn't fetch mRecreateDisplayList field; dimming will be slow.", e2);
            }
        }

        @Override // android.support.p011v4.widget.SlidingPaneLayout.SlidingPanelLayoutImplBase, android.support.p011v4.widget.SlidingPaneLayout.SlidingPanelLayoutImpl
        public void invalidateChildRegion(SlidingPaneLayout parent, View child) {
            if (this.mGetDisplayList != null && this.mRecreateDisplayList != null) {
                try {
                    ...
                    Log.m69e(SlidingPaneLayout.TAG, "Error refreshing display list state", e);
                }
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        @Override // android.support.p011v4.view.AccessibilityDelegateCompat
