...
import android.support.p011v4.view.NestedScrollingChild;
            ...
            switch (action) {
                ...
                case 2:
                    if (this.mActivePointerId == -1) {
                        Log.m70e(LOG_TAG, "Got ACTION_MOVE event but don't have an active pointer id.");
                        return false;
                    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case 1:
                int pointerIndex = ev.findPointerIndex(this.mActivePointerId);
                if (pointerIndex < 0) {
                    Log.m70e(LOG_TAG, "Got ACTION_UP event but don't have an active pointer id.");
                    return false;
                }
            ...
            case 2:
                int pointerIndex2 = ev.findPointerIndex(this.mActivePointerId);
                if (pointerIndex2 < 0) {
                    Log.m70e(LOG_TAG, "Got ACTION_MOVE event but have an invalid active pointer id.");
                    return false;
                }
                float y = ev.getY(pointerIndex2);
                startDragging(y);
            ...
            case 5:
                ...
                if (pointerIndex3 < 0) {
                    Log.m70e(LOG_TAG, "Got ACTION_POINTER_DOWN event but have an invalid action index.");
                    return false;
                }
