package android.support.p011v4.content.p012pm;
...
import android.support.p011v4.graphics.drawable.IconCompat;
...
public class ShortcutInfoCompat {
    ...
    Intent addToIntent(Intent outIntent) {
        outIntent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, this.mIntents[this.mIntents.length - 1]).putExtra(Intent.EXTRA_SHORTCUT_NAME, this.mLabel.toString());
        if (this.mIcon != null) {
