...
import android.support.p011v4.media.MediaBrowserCompatApi21;
import android.support.p011v4.media.MediaBrowserCompatApi23;
import android.support.p011v4.media.MediaBrowserCompatApi24;
import android.support.p011v4.media.session.IMediaSession;
import android.support.p011v4.media.session.MediaSessionCompat;
import android.support.p011v4.p013os.ResultReceiver;
...
public final class MediaBrowserCompat {
    ...
    public static class ConnectionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.ConnectionCallback {
            ...
            @Override // android.support.p011v4.media.MediaBrowserCompatApi21.ConnectionCallback
            public void onConnected() {
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            @Override // android.support.p011v4.media.MediaBrowserCompatApi21.SubscriptionCallback
        ...
        private class StubApi24 extends StubApi21 implements MediaBrowserCompatApi24.SubscriptionCallback {
            ...
            @Override // android.support.p011v4.media.MediaBrowserCompatApi24.SubscriptionCallback
    ...
    public static abstract class ItemCallback {
        ...
        private class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
            ...
            @Override // android.support.p011v4.media.MediaBrowserCompatApi23.ItemCallback
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        @Override // android.support.p011v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void connect() {
                ...
                public void run() {
                    ...
                    if (MediaBrowserCompat.DEBUG && MediaBrowserImplBase.this.mServiceConnection != null) {
                        ...
                        try {
                            ...
                            Log.m70e(MediaBrowserCompat.TAG, "Failed binding to service " + MediaBrowserImplBase.this.mServiceComponent);
                        }
                        if (!bound) {
                        ...
                        if (MediaBrowserCompat.DEBUG) {
                            Log.m72d(MediaBrowserCompat.TAG, "connect...");
                ...
                public void run() {
                    if (MediaBrowserImplBase.this.mCallbacksMessenger != null) {
                        try {
                            ...
                            Log.m64w(MediaBrowserCompat.TAG, "RemoteException during connect for " + MediaBrowserImplBase.this.mServiceComponent);
                        }
                    }
                    ...
                    if (MediaBrowserCompat.DEBUG) {
                        Log.m72d(MediaBrowserCompat.TAG, "disconnect...");
                        MediaBrowserImplBase.this.dump();
                    }
                }
            });
        ...
        public void subscribe(@NonNull String parentId, Bundle options, @NonNull SubscriptionCallback callback) {
            ...
            if (isConnected()) {
                try {
                    ...
                    Log.m72d(MediaBrowserCompat.TAG, "addSubscription failed with RemoteException parentId=" + parentId);
                }
            }
        }
        ...
        public void unsubscribe(@NonNull String parentId, SubscriptionCallback callback) {
            ...
            try {
                ...
                Log.m72d(MediaBrowserCompat.TAG, "removeSubscription failed with RemoteException parentId=" + parentId);
            }
        ...
        public void getItem(@NonNull final String mediaId, @NonNull final ItemCallback cb) {
            ...
            if (!isConnected()) {
                Log.m68i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
            ...
            try {
                ...
                Log.m68i(MediaBrowserCompat.TAG, "Remote error getting media item: " + mediaId);
        ...
        public void search(@NonNull final String query, final Bundle extras, @NonNull final SearchCallback callback) {
            ...
            try {
                ...
                Log.m67i(MediaBrowserCompat.TAG, "Remote error searching items with query: " + query, e);
        ...
        public void sendCustomAction(@NonNull final String action, final Bundle extras, @Nullable final CustomActionCallback callback) {
            ...
            try {
                ...
                Log.m67i(MediaBrowserCompat.TAG, "Remote error sending a custom action: action=" + action + ", extras=" + extras, e);
                if (callback != null) {
        ...
        @Override // android.support.p011v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
        public void onServiceConnected(Messenger callback, String root, MediaSessionCompat.Token session, Bundle extra) {
            if (!isCurrent(callback, "onConnect")) {
                return;
            }
            if (this.mState != 2) {
                Log.m64w(MediaBrowserCompat.TAG, "onConnect from service while mState=" + getStateLabel(this.mState) + "... ignoring");
                return;
            }
            this.mRootId = root;
            ...
            this.mState = 3;
            if (MediaBrowserCompat.DEBUG) {
                Log.m72d(MediaBrowserCompat.TAG, "ServiceCallbacks.onConnect...");
                dump();
            }
            ...
            try {
                ...
                Log.m72d(MediaBrowserCompat.TAG, "addSubscription failed with RemoteException.");
            }
        }

        @Override // android.support.p011v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
        public void onConnectionFailed(Messenger callback) {
            Log.m70e(MediaBrowserCompat.TAG, "onConnectFailed for " + this.mServiceComponent);
        ...
        public void onLoadChildren(Messenger callback, String parentId, List list, Bundle options) {
            ...
            if (MediaBrowserCompat.DEBUG) {
                Log.m72d(MediaBrowserCompat.TAG, "onLoadChildren for " + this.mServiceComponent + " id=" + parentId);
            }
            Subscription subscription = this.mSubscriptions.get(parentId);
            if (subscription == null) {
                if (MediaBrowserCompat.DEBUG) {
                    Log.m72d(MediaBrowserCompat.TAG, "onLoadChildren for id that isn't subscribed id=" + parentId);
                    return;
                }
                return;
            }
        ...
        private boolean isCurrent(Messenger callback, String funcName) {
            if (this.mCallbacksMessenger != callback || this.mState == 0 || this.mState == 1) {
                if (this.mState != 0 && this.mState != 1) {
                    Log.m68i(MediaBrowserCompat.TAG, funcName + " for " + this.mServiceComponent + " with mCallbacksMessenger=" + this.mCallbacksMessenger + " this=" + this);
                    return false;
                }
                return false;
            }
        ...
        void dump() {
            Log.m72d(MediaBrowserCompat.TAG, "MediaBrowserCompat...");
            Log.m72d(MediaBrowserCompat.TAG, "  mServiceComponent=" + this.mServiceComponent);
            Log.m72d(MediaBrowserCompat.TAG, "  mCallback=" + this.mCallback);
            Log.m72d(MediaBrowserCompat.TAG, "  mRootHints=" + this.mRootHints);
            Log.m72d(MediaBrowserCompat.TAG, "  mState=" + getStateLabel(this.mState));
            Log.m72d(MediaBrowserCompat.TAG, "  mServiceConnection=" + this.mServiceConnection);
            Log.m72d(MediaBrowserCompat.TAG, "  mServiceBinderWrapper=" + this.mServiceBinderWrapper);
            Log.m72d(MediaBrowserCompat.TAG, "  mCallbacksMessenger=" + this.mCallbacksMessenger);
            Log.m72d(MediaBrowserCompat.TAG, "  mRootId=" + this.mRootId);
            Log.m72d(MediaBrowserCompat.TAG, "  mMediaSessionToken=" + this.mMediaSessionToken);
        }
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            public void onServiceConnected(final ComponentName name, final IBinder binder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            Log.m72d(MediaBrowserCompat.TAG, "MediaServiceConnection.onServiceConnected name=" + name + " binder=" + binder);
                            MediaBrowserImplBase.this.dump();
                        }
            ...
            public void onServiceDisconnected(final ComponentName name) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.2
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            Log.m72d(MediaBrowserCompat.TAG, "MediaServiceConnection.onServiceDisconnected name=" + name + " this=" + this + " mServiceConnection=" + MediaBrowserImplBase.this.mServiceConnection);
                            MediaBrowserImplBase.this.dump();
                        }
            ...
            boolean isCurrent(String funcName) {
                if (MediaBrowserImplBase.this.mServiceConnection != this || MediaBrowserImplBase.this.mState == 0 || MediaBrowserImplBase.this.mState == 1) {
                    if (MediaBrowserImplBase.this.mState != 0 && MediaBrowserImplBase.this.mState != 1) {
                        Log.m68i(MediaBrowserCompat.TAG, funcName + " for " + MediaBrowserImplBase.this.mServiceComponent + " with mServiceConnection=" + MediaBrowserImplBase.this.mServiceConnection + " this=" + this);
                        return false;
                    }
                    return false;
                }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void disconnect() {
            if (this.mServiceBinderWrapper != null && this.mCallbacksMessenger != null) {
                try {
                    ...
                    Log.m68i(MediaBrowserCompat.TAG, "Remote error unregistering client messenger.");
                }
            }
        ...
        public void subscribe(@NonNull String parentId, Bundle options, @NonNull SubscriptionCallback callback) {
            ...
            try {
                ...
                Log.m68i(MediaBrowserCompat.TAG, "Remote error subscribing media item: " + parentId);
            }
        }
        ...
        public void search(@NonNull final String query, final Bundle extras, @NonNull final SearchCallback callback) {
            ...
            if (this.mServiceBinderWrapper == null) {
                Log.m68i(MediaBrowserCompat.TAG, "The connected service doesn't support search.");
        ...
        public void sendCustomAction(@NonNull final String action, final Bundle extras, @Nullable final CustomActionCallback callback) {
            ...
            if (this.mServiceBinderWrapper == null) {
                Log.m68i(MediaBrowserCompat.TAG, "The connected service doesn't support sendCustomAction.");
                if (callback != null) {
        ...
        @Override // android.support.p011v4.media.MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
        public void onConnected() {
            ...
            if (serviceBinder != null) {
                ...
                try {
                    ...
                    Log.m68i(MediaBrowserCompat.TAG, "Remote error registering client messenger.");
                }
            }
    ...
    static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        @Override // android.support.p011v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.p011v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (this.mServiceBinderWrapper == null) {
            ...
            try {
                switch (msg.what) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        Log.m64w(MediaBrowserCompat.TAG, "Unhandled message: " + msg + "\n  Client version: 1\n  Service version: " + msg.arg1);
                        break;
                }
            } catch (BadParcelableException e) {
                Log.m70e(MediaBrowserCompat.TAG, "Could not unparcel the data.");
                if (msg.what == 1) {
                    serviceCallback.onConnectionFailed(callbacksMessenger);
                }
            }
    ...
    private static class ItemReceiver extends ResultReceiver {
        ...
        @Override // android.support.p011v4.p013os.ResultReceiver
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            switch (resultCode) {
                ...
                case 1:
                    ...
                    return;
                default:
                    Log.m64w(MediaBrowserCompat.TAG, "Unknown result code: " + resultCode + " (extras=" + this.mExtras + ", resultData=" + resultData + ")");
                    return;
            }
        }
    }
