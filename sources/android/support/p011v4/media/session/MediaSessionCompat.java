...
import android.support.p011v4.media.VolumeProviderCompat;
...
import android.support.p011v4.media.session.MediaSessionCompatApi23;
import android.support.p011v4.media.session.MediaSessionCompatApi24;
...
public class MediaSessionCompat {
    ...
    public MediaSessionCompat(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
        ...
        if (mbrComponent == null && (mbrComponent = MediaButtonReceiver.getMediaButtonReceiverComponent(context)) == null) {
            Log.m64w(TAG, "Couldn't find a unique registered media button receiver in the given context.");
        }
    ...
    public static abstract class Callback {
        ...
        public boolean onMediaButtonEvent(Intent mediaButtonEvent) {
            ...
            if (impl == null || this.mCallbackHandler == null || (keyEvent = (KeyEvent) mediaButtonEvent.getParcelableExtra(Intent.EXTRA_KEY_EVENT)) == null || keyEvent.getAction() != 0) {
                return false;
            }
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            @Override // android.support.p011v4.media.session.MediaSessionCompatApi21.Callback
            public void onCommand(String command, Bundle extras, ResultReceiver cb) {
                try {
                    QueueItem item = null;
                    ...
                    Log.m70e(MediaSessionCompat.TAG, "Could not unparcel the extra data.");
                }
            }
        ...
        private class StubApi23 extends StubApi21 implements MediaSessionCompatApi23.Callback {
            ...
            @Override // android.support.p011v4.media.session.MediaSessionCompatApi23.Callback
            public void onPlayFromUri(Uri uri, Bundle extras) {
        ...
        private class StubApi24 extends StubApi23 implements MediaSessionCompatApi24.Callback {
            ...
            @Override // android.support.p011v4.media.session.MediaSessionCompatApi24.Callback
            public void onPrepare() {
                Callback.this.onPrepare();
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        ResultReceiverWrapper(Parcel in) {
            this.mResultReceiver = ResultReceiver.CREATOR.createFromParcel(in);
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private VolumeProviderCompat.Callback mVolumeCallback = new VolumeProviderCompat.Callback() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // android.support.p011v4.media.VolumeProviderCompat.Callback
        ...
        @Override // android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCallback(Callback callback, Handler handler) {
            Handler handler2;
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            @Override // android.support.p011v4.media.session.IMediaSession
        ...
        class MessageHandler extends Handler {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                Log.m64w(MediaSessionCompat.TAG, "KEYCODE_MEDIA_PLAY_PAUSE and KEYCODE_HEADSETHOOK are handled already");
            }
        }
    }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        @Override // android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImplBase, android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCallback(Callback callback, Handler handler) {
        ...
        @Override // android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImplBase
        void setRccState(PlaybackStateCompat state) {
        ...
        void registerMediaButtonEventReceiver(PendingIntent mbrIntent, ComponentName mbrComponent) {
            if (sIsMbrPendingIntentSupported) {
                try {
                    ...
                    Log.m64w(MediaSessionCompat.TAG, "Unable to register media button event receiver with PendingIntent, falling back to ComponentName.");
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        @Override // android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImplApi18, android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImplBase, android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCallback(Callback callback, Handler handler) {
            super.setCallback(callback, handler);
            if (callback == null) {
        ...
        @Override // android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImplApi18, android.support.p011v4.media.session.MediaSessionCompat.MediaSessionImplBase
        int getRccTransportControlFlagsFromActions(long actions) {
            int transportControlFlags = super.getRccTransportControlFlagsFromActions(actions);
            if ((128 & actions) != 0) {
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle metadata) {
            ...
            if (metadata.containsKey("android.media.metadata.USER_RATING")) {
                editor.putObject(MediaMetadataEditor.RATING_KEY_BY_USER, (Object) metadata.getParcelable("android.media.metadata.USER_RATING"));
            }
            return editor;
        }
    }
