...
import android.support.p011v4.media.MediaBrowserServiceCompatApi24;
...
import android.support.p011v4.util.Pair;
...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        @Override // android.support.p011v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
                ...
                public void run() {
                    ...
                    while (iter.hasNext()) {
                        ...
                        try {
                            ...
                            Log.m64w(MediaBrowserServiceCompat.TAG, "Connection for " + connection.pkg + " is no longer valid.");
                            iter.remove();
                        }
                    }
                }
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        @Override // android.support.p011v4.media.MediaBrowserServiceCompatApi21.ServiceCompatProxy
        ...
        public void onLoadChildren(String parentId, final MediaBrowserServiceCompatApi21.ResultWrapper<List<Parcel>> resultWrapper) {
            Result<List<MediaBrowserCompat.MediaItem>> result = new Result<List<MediaBrowserCompat.MediaItem>>(parentId) { // from class: android.support.v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.3
                ...
                @Override // android.support.p011v4.media.MediaBrowserServiceCompat.Result
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        @Override // android.support.p011v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21, android.support.p011v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
        public void onCreate() {
            this.mServiceObj = MediaBrowserServiceCompatApi23.createService(MediaBrowserServiceCompat.this, this);
            MediaBrowserServiceCompatApi21.onCreate(this.mServiceObj);
        }

        @Override // android.support.p011v4.media.MediaBrowserServiceCompatApi23.ServiceCompatProxy
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
        ...
        @Override // android.support.p011v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi23, android.support.p011v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21, android.support.p011v4.media.MediaBrowserServiceCompat.MediaBrowserServiceImpl
        public void onCreate() {
        ...
        @Override // android.support.p011v4.media.MediaBrowserServiceCompatApi24.ServiceCompatProxy
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 9:
                    ...
                    return;
                default:
                    Log.m64w(MediaBrowserServiceCompat.TAG, "Unhandled message: " + msg + "\n  Service version: 1\n  Client version: " + msg.arg1);
                    return;
            }
        }
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                ...
                public void run() {
                    ...
                    if (connection.root == null) {
                        Log.m68i(MediaBrowserServiceCompat.TAG, "No root for client " + pkg + " from service " + getClass().getName());
                        try {
                            callbacks.onConnectFailed();
                            return;
                        } catch (RemoteException e) {
                            Log.m64w(MediaBrowserServiceCompat.TAG, "Calling onConnectFailed() failed. Ignoring. pkg=" + pkg);
                            return;
                        }
                    }
                    try {
                        ...
                        Log.m64w(MediaBrowserServiceCompat.TAG, "Calling onConnect() failed. Dropping client. pkg=" + pkg);
                        MediaBrowserServiceCompat.this.mConnections.remove(b);
                    }
                }
            });
        ...
        public void addSubscription(final String id, final IBinder token, final Bundle options, final ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.3
                ...
                public void run() {
                    ...
                    if (connection == null) {
                        Log.m64w(MediaBrowserServiceCompat.TAG, "addSubscription for callback that isn't registered id=" + id);
                        return;
                    }
        ...
        public void removeSubscription(final String id, final IBinder token, final ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.4
                ...
                public void run() {
                    ...
                    ConnectionRecord connection = MediaBrowserServiceCompat.this.mConnections.get(b);
                    if (connection == null) {
                        Log.m64w(MediaBrowserServiceCompat.TAG, "removeSubscription for callback that isn't registered id=" + id);
                    } else if (!MediaBrowserServiceCompat.this.removeSubscription(id, connection, token)) {
                        Log.m64w(MediaBrowserServiceCompat.TAG, "removeSubscription called for " + id + " which is not subscribed");
                    }
                }
            });
        }
        ...
        public void getMediaItem(final String mediaId, final ResultReceiver receiver, final ServiceCallbacks callbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.5
                ...
                public void run() {
                    ...
                    ConnectionRecord connection = MediaBrowserServiceCompat.this.mConnections.get(b);
                    if (connection == null) {
                        Log.m64w(MediaBrowserServiceCompat.TAG, "getMediaItem for callback that isn't registered id=" + mediaId);
                        return;
                    }
        ...
        public void search(final String query, final Bundle extras, final ResultReceiver receiver, final ServiceCallbacks callbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.8
                ...
                public void run() {
                    ...
                    ConnectionRecord connection = MediaBrowserServiceCompat.this.mConnections.get(b);
                    if (connection == null) {
                        Log.m64w(MediaBrowserServiceCompat.TAG, "search for callback that isn't registered query=" + query);
                        return;
                    }
        ...
        public void sendCustomAction(final String action, final Bundle extras, final ResultReceiver receiver, final ServiceCallbacks callbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                ...
                public void run() {
                    ...
                    ConnectionRecord connection = MediaBrowserServiceCompat.this.mConnections.get(b);
                    if (connection == null) {
                        Log.m64w(MediaBrowserServiceCompat.TAG, "sendCustomAction for callback that isn't registered action=" + action + ", extras=" + extras);
                        return;
                    }
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        @Override // android.support.p011v4.media.MediaBrowserServiceCompat.ServiceCallbacks
            ...
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connection.callbacks.asBinder()) != connection) {
                    if (MediaBrowserServiceCompat.DEBUG) {
                        Log.m72d(MediaBrowserServiceCompat.TAG, "Not sending onLoadChildren result for connection that has been disconnected. pkg=" + connection.pkg + " id=" + parentId);
                        return;
                    }
                    return;
                }
                ...
                try {
                    ...
                    Log.m64w(MediaBrowserServiceCompat.TAG, "Calling onLoadChildren() failed for id=" + parentId + " package=" + connection.pkg);
                }
            }
        };
