...
import android.support.p011v4.view.ViewPager;
import android.support.p011v4.widget.TextViewCompat;
...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, m105to = 1.0d) float alpha) {
    ...
    private class PageListener extends DataSetObserver implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener {
        ...
        @Override // android.support.p011v4.view.ViewPager.OnAdapterChangeListener
