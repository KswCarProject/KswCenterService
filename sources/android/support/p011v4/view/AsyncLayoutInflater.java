...
import android.support.p011v4.util.Pools;
        ...
        public void runInner() {
            try {
                ...
                try {
                    ...
                    Log.m63w(AsyncLayoutInflater.TAG, "Failed to inflate resource in the background! Retrying on the UI thread", ex);
                }
                Message.obtain(request.inflater.mHandler, 0, request).sendToTarget();
            } catch (InterruptedException ex2) {
                Log.m62w(AsyncLayoutInflater.TAG, ex2);
            }
        }
