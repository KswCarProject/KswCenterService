...
public final class MenuItemCompat {
    ...
    static class MenuItemCompatBaseImpl implements MenuVersionImpl {
        ...
        @Override // android.support.p011v4.view.MenuItemCompat.MenuVersionImpl
    ...
    static class MenuItemCompatApi26Impl extends MenuItemCompatBaseImpl {
        ...
        @Override // android.support.p011v4.view.MenuItemCompat.MenuItemCompatBaseImpl, android.support.p011v4.view.MenuItemCompat.MenuVersionImpl
        public void setContentDescription(MenuItem item, CharSequence contentDescription) {
    ...
    public static MenuItem setActionProvider(MenuItem item, ActionProvider provider) {
        ...
        Log.m64w(TAG, "setActionProvider: item does not implement SupportMenuItem; ignoring");
        return item;
    }
    ...
    public static ActionProvider getActionProvider(MenuItem item) {
        ...
        Log.m64w(TAG, "getActionProvider: item does not implement SupportMenuItem; returning null");
        return null;
    }
