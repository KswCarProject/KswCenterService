...
import android.support.p011v4.view.accessibility.AccessibilityNodeProviderCompat;
...
public class ViewCompat {
    ...
    static class ViewCompatBaseImpl {
        ...
        public void dispatchStartTemporaryDetach(View view) {
            ...
            if (this.mDispatchStartTemporaryDetach != null) {
                try {
                    ...
                    Log.m71d(ViewCompat.TAG, "Error calling dispatchStartTemporaryDetach", e);
                    return;
                }
            }
        ...
        public void dispatchFinishTemporaryDetach(View view) {
            ...
            if (this.mDispatchFinishTemporaryDetach != null) {
                try {
                    ...
                    Log.m71d(ViewCompat.TAG, "Error calling dispatchFinishTemporaryDetach", e);
                    return;
                }
            }
        ...
        private void bindTempDetach() {
            try {
                ...
                Log.m69e(ViewCompat.TAG, "Couldn't find method", e);
            }
        ...
        public void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean enabled) {
            if (sChildrenDrawingOrderMethod == null) {
                try {
                    ...
                    Log.m69e(ViewCompat.TAG, "Unable to find childrenDrawingOrderEnabled", e);
                }
            ...
            try {
                ...
                Log.m69e(ViewCompat.TAG, "Unable to invoke childrenDrawingOrderEnabled", e2);
            } catch (IllegalArgumentException e3) {
                Log.m69e(ViewCompat.TAG, "Unable to invoke childrenDrawingOrderEnabled", e3);
            } catch (InvocationTargetException e4) {
                Log.m69e(ViewCompat.TAG, "Unable to invoke childrenDrawingOrderEnabled", e4);
            }
        }
    ...
    static class ViewCompatApi15Impl extends ViewCompatBaseImpl {
        ...
        @Override // android.support.p011v4.view.ViewCompat.ViewCompatBaseImpl
        public boolean hasOnClickListeners(View view) {
    ...
    static class ViewCompatApi19Impl extends ViewCompatApi18Impl {
        ...
        @Override // android.support.p011v4.view.ViewCompat.ViewCompatApi16Impl, android.support.p011v4.view.ViewCompat.ViewCompatBaseImpl
        public void setImportantForAccessibility(View view, int mode) {
            view.setImportantForAccessibility(mode);
        }
    ...
    static class ViewCompatApi23Impl extends ViewCompatApi21Impl {
        ...
        @Override // android.support.p011v4.view.ViewCompat.ViewCompatApi21Impl, android.support.p011v4.view.ViewCompat.ViewCompatBaseImpl
        public void offsetLeftAndRight(View view, int offset) {
            view.offsetLeftAndRight(offset);
        }
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m105to = 1.0d) float value) {
        view.setAlpha(value);
    }
