...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m101x(float value) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().m45x(value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m100y(float value) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().m44y(value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m99z(float value) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().m43z(value);
        }
        return this;
    }
