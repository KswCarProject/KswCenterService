...
public abstract class DocumentsProvider extends ContentProvider {
    ...
    public String getDocumentType(String documentId) throws FileNotFoundException {
        Cursor cursor = queryDocument(documentId, (String[]) null);
        try {
    ...
    private Bundle callUnchecked(String method, String arg, Bundle extras) throws FileNotFoundException {
        ...
        if (DocumentsContract.METHOD_EJECT_ROOT.equals(str)) {
            ...
            enforceWritePermissionInner(rootUri, getCallingPackage(), (IBinder) null);
        ...
        if (this.mAuthority.equals(authority)) {
            ...
            if (DocumentsContract.METHOD_IS_CHILD_DOCUMENT.equals(str)) {
                enforceReadPermissionInner(documentUri, getCallingPackage(), (IBinder) null);
                ...
                enforceWritePermissionInner(documentUri, getCallingPackage(), (IBinder) null);
                ...
                enforceWritePermissionInner(documentUri, getCallingPackage(), (IBinder) null);
                out.putParcelable("result", createWebLinkIntent(documentId, bundle.getBundle(DocumentsContract.EXTRA_OPTIONS)));
                ...
                enforceReadPermissionInner(documentUri, getCallingPackage(), (IBinder) null);
                enforceWritePermissionInner(targetUri, getCallingPackage(), (IBinder) null);
                ...
                enforceWritePermissionInner(documentUri, getCallingPackage(), (IBinder) null);
                enforceReadPermissionInner(parentSourceUri, getCallingPackage(), (IBinder) null);
                enforceWritePermissionInner(targetUri2, getCallingPackage(), (IBinder) null);
                ...
                enforceReadPermissionInner(parentSourceUri2, getCallingPackage(), (IBinder) null);
                enforceWritePermissionInner(documentUri, getCallingPackage(), (IBinder) null);
                ...
                if (isTreeUri) {
                    ...
                    getContext().enforceCallingPermission(Manifest.permission.MANAGE_DOCUMENTS, (String) null);
                }
                if (isTreeUri) {
                ...
                if (isTreeUri) {
                    if (!Objects.equals(path.getPath().get(0), parentDocumentId)) {
                        ...
                        path = new DocumentsContract.Path((String) null, docs);
                    }
                    if (path.getRootId() != null) {
                        Log.wtf(TAG, "Provider returns root id :" + path.getRootId() + " unexpectedly. Erase root id.");
                        path = new DocumentsContract.Path((String) null, path.getPath());
                    }
                }
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        enforceTree(uri);
        return openDocument(DocumentsContract.getDocumentId(uri), mode, (CancellationSignal) null);
    }
    ...
    public final AssetFileDescriptor openAssetFile(Uri uri, String mode) throws FileNotFoundException {
        enforceTree(uri);
        ParcelFileDescriptor fd = openDocument(DocumentsContract.getDocumentId(uri), mode, (CancellationSignal) null);
        if (fd != null) {
    ...
    public final AssetFileDescriptor openTypedAssetFile(Uri uri, String mimeTypeFilter, Bundle opts) throws FileNotFoundException {
        return openTypedAssetFileImpl(uri, mimeTypeFilter, opts, (CancellationSignal) null);
    }
    ...
    public String[] getDocumentStreamTypes(String documentId, String mimeTypeFilter) {
        Cursor cursor = null;
        try {
            cursor = queryDocument(documentId, (String[]) null);
            if (cursor.moveToFirst()) {
