    ...
    private void moveToState(LocalActivityRecord r, int desiredState) {
        ...
        if (r.curState == 1) {
            ...
            if (lastNonConfigurationInstances != null) {
                instanceObj = lastNonConfigurationInstances.get(r.f16id);
            }
            ...
            r.activity = this.mActivityThread.startActivityNow(this.mParent, r.f16id, r.intent, r.activityInfo, r, r.instanceState, instance2, r);
            if (r.activity == null) {
                return;
            }
        ...
        if (state != null) {
            for (String id : state.keySet()) {
                try {
                    ...
                    Log.m69e(TAG, "Exception thrown when restoring LocalActivityManager state", e);
                }
            }
        }
        this.mCurState = 2;
    ...
    public Bundle saveInstanceState() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (r.instanceState != null) {
                state.putBundle(r.f16id, r.instanceState);
            }
        }
        return state;
    }
    ...
    public HashMap<String, Object> dispatchRetainNonConfigurationInstance() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (r != null && r.activity != null && (instance = r.activity.onRetainNonConfigurationInstance()) != null) {
                ...
                instanceMap.put(r.f16id, instance);
            }
        }
        return instanceMap;
    }
