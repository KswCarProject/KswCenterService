        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    boolean isRoleHeld = isRoleHeld(_arg02, _arg1);
                    reply.writeNoException();
                ...
                case 3:
                    ...
                    List<String> _result = getRoleHoldersAsUser(_arg03, _arg12);
                    reply.writeNoException();
                ...
                case 4:
                    ...
                    addRoleHolderAsUser(_arg04, _arg13, _arg2, _arg3, _arg4);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    removeRoleHolderAsUser(_arg05, _arg14, _arg22, _arg32, _arg42);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    clearRoleHoldersAsUser(_arg06, _arg15, _arg23, _arg33);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    addOnRoleHoldersChangedListenerAsUser(_arg07, _arg16);
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    removeOnRoleHoldersChangedListenerAsUser(_arg08, _arg17);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 10:
                    ...
                    boolean addRoleHolderFromController = addRoleHolderFromController(_arg010, _arg18);
                    reply.writeNoException();
                ...
                case 11:
                    ...
                    boolean removeRoleHolderFromController = removeRoleHolderFromController(_arg011, _arg19);
                    reply.writeNoException();
                ...
                case 14:
                    ...
                    getSmsMessagesForFinancialApp(_arg014, _arg110, _arg24);
                    reply.writeNoException();
                    return true;
                default:
