...
public abstract class RoleControllerService extends Service {
    ...
    /* loaded from: classes.dex */
    class roleIRoleController$StubC03881 extends IRoleController.Stub {
        roleIRoleController$StubC03881() {
        }
        ...
        public void isApplicationQualifiedForRole(String roleName, String packageName, RemoteCallback callback) {
            RoleControllerService.this.enforceCallingPermission(Manifest.C0000permission.MANAGE_ROLE_HOLDERS, null);
            Preconditions.checkStringNotEmpty(roleName, "roleName cannot be null or empty");
            Preconditions.checkStringNotEmpty(packageName, "packageName cannot be null or empty");
            Preconditions.checkNotNull(callback, "callback cannot be null");
    ...
    public final IBinder onBind(Intent intent) {
        return new roleIRoleController$StubC03881();
    }
