...
public class SearchDialog extends Dialog {
    ...
    static int resolveDialogTheme(Context context) {
        ...
        context.getTheme().resolveAttribute(C3132R.attr.searchDialogTheme, outValue, true);
    ...
    private void createContentView() {
        setContentView(C3132R.layout.search_bar);
        this.mSearchView = (SearchView) findViewById(C3132R.C3134id.search_view);
        ...
        this.mBadgeLabel = (TextView) this.mSearchView.findViewById(C3132R.C3134id.search_badge);
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(C3132R.C3134id.search_src_text);
        this.mAppIcon = (ImageView) findViewById(C3132R.C3134id.search_app_icon);
        this.mSearchPlate = this.mSearchView.findViewById(C3132R.C3134id.search_plate);
        this.mWorkingSpinner = getContext().getDrawable(C3132R.C3133drawable.search_spinner);
        setWorking(false);
    ...
    private void updateSearchAppIcon() {
        ...
        try {
            ...
            Log.m64w(LOG_TAG, this.mLaunchComponent + " not found, using generic app icon");
            icon = icon2;
        }
    ...
    private void launchIntent(Intent intent) {
        ...
        Log.m72d(LOG_TAG, "launching " + intent);
        try {
