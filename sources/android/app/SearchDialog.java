...
public class SearchDialog extends Dialog {
    ...
    private void updateUI() {
        if (this.mSearchable != null) {
            ...
            if (this.mSearchable.getVoiceSearchEnabled()) {
                ...
                this.mSearchAutoComplete.setPrivateImeOptions((String) null);
            }
        }
    }
    ...
    public void launchQuerySearch(int actionKey, String actionMsg) {
        launchIntent(createIntent(Intent.ACTION_SEARCH, (Uri) null, (String) null, this.mSearchAutoComplete.getText().toString(), actionKey, actionMsg));
    }
