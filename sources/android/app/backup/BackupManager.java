...
public class BackupManager {
    ...
    public int requestRestore(RestoreObserver observer) {
        return requestRestore(observer, (BackupManagerMonitor) null);
    }
    ...
    public RestoreSession beginRestoreSession() {
        ...
        try {
            IRestoreSession binder = sService.beginRestoreSessionForUser(this.mContext.getUserId(), (String) null, (String) null);
            if (binder != null) {
    ...
    public int requestBackup(String[] packages, BackupObserver observer) {
        return requestBackup(packages, observer, (BackupManagerMonitor) null, 0);
    }
