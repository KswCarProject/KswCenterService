...
import android.media.p006tv.ITvInputManager;
...
import android.p007os.DeviceIdleManager;
import android.p007os.DropBoxManager;
import android.p007os.HardwarePropertiesManager;
import android.p007os.IBatteryPropertiesRegistrar;
import android.p007os.IBinder;
import android.p007os.IDeviceIdleController;
import android.p007os.IDumpstate;
import android.p007os.IHardwarePropertiesManager;
import android.p007os.IPowerManager;
import android.p007os.IRecoverySystem;
import android.p007os.ISystemUpdateManager;
import android.p007os.IUserManager;
...
import android.p007os.SystemUpdateManager;
import android.p007os.SystemVibrator;
import android.p007os.UserHandle;
import android.p007os.UserManager;
import android.p007os.Vibrator;
import android.p007os.health.SystemHealthManager;
import android.p007os.image.DynamicSystemManager;
import android.p007os.image.IDynamicSystemService;
...
import com.android.internal.p016os.IDropBoxManagerService;
...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.CARRIER_CONFIG_SERVICE, CarrierConfigManager.class, new CachedServiceFetcher<CarrierConfigManager>() { // from class: android.app.SystemServiceRegistry.48
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.app.SystemServiceRegistry.CachedServiceFetcher
        ...
        registerService(Context.WIFI_P2P_SERVICE, WifiP2pManager.class, new StaticServiceFetcher<WifiP2pManager>() { // from class: android.app.SystemServiceRegistry.60
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.app.SystemServiceRegistry.StaticServiceFetcher
                    ...
                    synchronized (cache) {
                        while (gates[this.mCacheIndex] < 2) {
                            try {
                                ...
                                Log.m64w(SystemServiceRegistry.TAG, "getService() interrupted");
