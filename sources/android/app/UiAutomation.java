...
public final class UiAutomation {
    ...
    public void adoptShellPermissionIdentity() {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error executing adopting shell permission identity!", re);
        }
    }
    ...
    public void dropShellPermissionIdentity() {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error executing dropping shell permission identity!", re);
        }
    }
    ...
    public boolean injectInputEvent(InputEvent event, boolean sync) {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error while injecting input event!", re);
            return false;
        }
    }
    ...
    public void syncInputTransactions() {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error while syncing input transactions!", re);
        }
    }
        ...
        switch (rotation) {
            ...
            case 3:
                try {
                    ...
                    Log.m69e(LOG_TAG, "Error while setting rotation!", re);
                    return false;
                }
            default:
    ...
    */
    ...
    public Bitmap takeScreenshot() {
        ...
        try {
            Bitmap screenShot = this.mUiAutomationConnection.takeScreenshot(new Rect(0, 0, displaySize.f59x, displaySize.f60y), rotation);
            if (screenShot == null) {
                return null;
            }
            ...
            Log.m69e(LOG_TAG, "Error while taking screnshot!", re);
            return null;
        }
    }
    ...
    public void setRunAsMonkey(boolean enable) {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error while setting run as monkey!", re);
        }
    }
    ...
    public boolean clearWindowContentFrameStats(int windowId) {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error clearing window content frame stats!", re);
            return false;
        }
    }
    ...
    public WindowContentFrameStats getWindowContentFrameStats(int windowId) {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error getting window content frame stats!", re);
            return null;
        }
    }
    ...
    public void clearWindowAnimationFrameStats() {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error clearing window animation frame stats!", re);
        }
    }
    ...
    public WindowAnimationFrameStats getWindowAnimationFrameStats() {
        ...
        try {
            ...
            Log.m69e(LOG_TAG, "Error getting window animation frame stats!", re);
            return null;
        }
    }
    ...
    public ParcelFileDescriptor executeShellCommand(String command) {
        ...
        try {
            try {
                ...
                Log.m69e(LOG_TAG, "Error executing shell command!", re);
            } catch (IOException ioe) {
                Log.m69e(LOG_TAG, "Error executing shell command!", ioe);
            }
            return source;
        } finally {
    ...
    private void warnIfBetterCommand(String cmd) {
        if (cmd.startsWith("pm grant ")) {
            Log.m64w(LOG_TAG, "UiAutomation.grantRuntimePermission() is more robust and should be used instead of 'pm grant'");
        } else if (cmd.startsWith("pm revoke ")) {
            Log.m64w(LOG_TAG, "UiAutomation.revokeRuntimePermission() is more robust and should be used instead of 'pm revoke'");
        }
    }
