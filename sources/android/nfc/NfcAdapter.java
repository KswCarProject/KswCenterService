...
public final class NfcAdapter {
    ...
    private static boolean hasBeamFeature() {
        ...
        if (pm != null) {
            try {
                ...
                Log.m69e(TAG, "Package manager query failed, assuming no Android Beam feature", e);
                return false;
            }
        }
        Log.m70e(TAG, "Cannot get package manager, assuming no Android Beam feature");
        return false;
    }
    ...
    private static boolean hasNfcFeature() {
        ...
        if (pm != null) {
            try {
                ...
                Log.m69e(TAG, "Package manager query failed, assuming no NFC feature", e);
                return false;
            }
        }
        Log.m70e(TAG, "Cannot get package manager, assuming no NFC feature");
        return false;
    }
    ...
    public List<String> getSupportedOffHostSecureElements() {
        ...
        IPackageManager pm = ActivityThread.getPackageManager();
        if (pm == null) {
            Log.m70e(TAG, "Cannot get package manager, assuming no off-host CE feature");
            return offHostSE;
        }
        try {
            ...
            Log.m69e(TAG, "Package manager query failed, assuming no off-host CE feature", e);
            offHostSE.clear();
            return offHostSE;
        }
    }
        ...
        synchronized (NfcAdapter.class) {
            if (!sIsInitialized) {
                ...
                if (!sHasNfcFeature && !hasHceFeature) {
                    Log.m66v(TAG, "this device does not have NFC support");
                    throw new UnsupportedOperationException();
                }
                sService = getServiceInterface();
                if (sService == null) {
                    Log.m70e(TAG, "could not retrieve NFC service");
                    throw new UnsupportedOperationException();
                }
                if (sHasNfcFeature) {
                    try {
                        ...
                        Log.m70e(TAG, "could not retrieve NFC Tag service");
                        throw new UnsupportedOperationException();
                    }
                }
                if (hasHceFeature) {
                    try {
                        ...
                        try {
                            ...
                            Log.m70e(TAG, "could not retrieve card emulation service");
                            throw new UnsupportedOperationException();
                        }
                    } catch (RemoteException e3) {
                        Log.m70e(TAG, "could not retrieve NFC-F card emulation service");
                        throw new UnsupportedOperationException();
                    }
                }
                sIsInitialized = true;
    ...
    public static NfcAdapter getDefaultAdapter() {
        Log.m63w(TAG, "WARNING: NfcAdapter.getDefaultAdapter() is deprecated, use NfcAdapter.getDefaultAdapter(Context) instead", new Exception());
    ...
    public void attemptDeadServiceRecovery(Exception e) {
        Log.m69e(TAG, "NFC service dead - attempting to recover", e);
        INfcAdapter service = getServiceInterface();
        if (service == null) {
            Log.m70e(TAG, "could not retrieve NFC service during service recovery");
            return;
        }
        sService = service;
        try {
            ...
            try {
                ...
                Log.m70e(TAG, "could not retrieve NFC card emulation service during service recovery");
            }
            try {
                sNfcFCardEmulationService = service.getNfcFCardEmulationInterface();
            } catch (RemoteException e3) {
                Log.m70e(TAG, "could not retrieve NFC-F card emulation service during service recovery");
            }
        } catch (RemoteException e4) {
            Log.m70e(TAG, "could not retrieve NFC tag service during service recovery");
        }
    }
            ...
            if (sHasBeamFeature) {
                ...
                try {
                    ...
                    if (targetSdkVersion < 16) {
                        Log.m69e(TAG, "Cannot call API with Activity that has already been destroyed", e);
                        return;
                    }
                    throw e;
                }
        ...
        synchronized (NfcAdapter.class) {
            ...
            if (sHasBeamFeature) {
                ...
                try {
                    ...
                    Log.m70e(TAG, "invokeBeam: NFC process has died.");
                    attemptDeadServiceRecovery(e);
                    return false;
                }
            }
    ...
    public boolean invokeBeam(BeamShareData shareData) {
        try {
            Log.m70e(TAG, "invokeBeamInternal()");
    ...
    public boolean addNfcUnlockHandler(final NfcUnlockHandler unlockHandler, String[] tagTechnologies) {
        ...
        try {
            ...
            Log.m69e(TAG, "Unable to register LockscreenDispatch", e2);
            return false;
        }
    }
