    ...
    public static abstract class Stub extends Binder implements INfcAdapter {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    BeamShareData _arg03 = data.readInt() != 0 ? BeamShareData.CREATOR.createFromParcel(data) : null;
                ...
                case 19:
                    ...
                    boolean ignore = ignore(_arg04, _arg12, _arg22);
                    reply.writeNoException();
                    reply.writeInt(ignore ? 1 : 0);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    Tag _arg05 = data.readInt() != 0 ? Tag.CREATOR.createFromParcel(data) : null;
                    dispatch(_arg05);
                    reply.writeNoException();
                    return true;
                case 21:
