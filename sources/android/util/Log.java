...
public final class Log {
    ...
    public static int wtf(String tag, String msg) {
        return wtf(0, tag, msg, (Throwable) null, false, false);
    }

    public static int wtfStack(String tag, String msg) {
        return wtf(0, tag, msg, (Throwable) null, true, false);
    }
    ...
    static void wtfQuiet(int logId, String tag, String msg, boolean system) {
        sWtfHandler.onTerribleFailure(tag, new TerribleFailure(msg, (Throwable) null), system);
    }
