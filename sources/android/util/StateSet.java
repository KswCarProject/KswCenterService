...
public class StateSet {
    ...
    static {
        if (VIEW_STATE_IDS.length / 2 != C3132R.styleable.ViewDrawableStates.length) {
            throw new IllegalStateException("VIEW_STATE_IDs array length does not match ViewDrawableStates style array");
        }
        int[] orderedIds = new int[VIEW_STATE_IDS.length];
        for (int i = 0; i < C3132R.styleable.ViewDrawableStates.length; i++) {
            int viewState = C3132R.styleable.ViewDrawableStates[i];
