...
public class ApkSignatureSchemeV2Verifier {
    ...
    */
    private static X509Certificate[] verifySigner(ByteBuffer signerBlock, Map<Integer, byte[]> contentDigests, CertificateFactory certFactory) throws SecurityException, IOException {
        ...
        while (signatures.hasRemaining()) {
            ...
            try {
                ...
                if (isSupportedSignatureAlgorithm(sigAlgorithm)) {
                    if (bestSigAlgorithm2 == -1 || ApkSigningBlockUtils.compareSignatureAlgorithm(sigAlgorithm, bestSigAlgorithm2) > 0) {
                        bestSigAlgorithm2 = sigAlgorithm;
        ...
        if (bestSigAlgorithm2 == -1) {
            if (signatureCount == 0) {
                throw new SecurityException("No signatures found");
            }
            throw new SecurityException("No supported signatures found");
        }
        String keyAlgorithm = ApkSigningBlockUtils.getSignatureAlgorithmJcaKeyAlgorithm(bestSigAlgorithm2);
        Pair<String, ? extends AlgorithmParameterSpec> signatureAlgorithmParams = ApkSigningBlockUtils.getSignatureAlgorithmJcaSignatureAlgorithm(bestSigAlgorithm2);
        ...
        try {
            ...
            while (true) {
                ...
                if (digests.hasRemaining()) {
                    ...
                    throw new IOException("Failed to parse digest record #" + digestCount3, e);
                } else if (signaturesSigAlgorithms.equals(digestsSigAlgorithms)) {
                    int certificateCount = ApkSigningBlockUtils.getSignatureAlgorithmContentDigestAlgorithm(bestSigAlgorithm2);
                    ...
                    while (certificates.hasRemaining()) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                bestSigAlgorithm2 = bestSigAlgorithm;
