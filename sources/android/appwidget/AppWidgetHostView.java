...
public class AppWidgetHostView extends FrameLayout {
    ...
    public void setAppWidget(int appWidgetId, AppWidgetProviderInfo info) {
        ...
        if (info != null) {
            ...
            if ((info.providerInfo.applicationInfo.flags & 1073741824) != 0) {
                description = Resources.getSystem().getString(C3132R.string.suspended_widget_accessibility, description);
            }
    ...
    private static Rect getDefaultPaddingForWidget(Context context, Rect padding) {
        ...
        padding.left = r.getDimensionPixelSize(C3132R.dimen.default_app_widget_padding_left);
        padding.right = r.getDimensionPixelSize(C3132R.dimen.default_app_widget_padding_right);
        padding.top = r.getDimensionPixelSize(C3132R.dimen.default_app_widget_padding_top);
        padding.bottom = r.getDimensionPixelSize(C3132R.dimen.default_app_widget_padding_bottom);
        return padding;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        try {
            ...
            Log.m69e(TAG, "Remote provider threw runtime exception, using error view instead.", e);
    ...
    public void applyContent(View content, boolean recycled, Exception exception) {
        if (content == null) {
            ...
            if (exception != null) {
                Log.m64w(TAG, "Error inflating RemoteViews : " + exception.toString());
            }
    ...
    protected Context getRemoteContext() {
        try {
            ...
            Log.m70e(TAG, "Package name " + this.mInfo.providerInfo.packageName + " not found");
    ...
    protected View getDefaultView() {
        ...
        try {
            if (this.mInfo != null) {
                ...
                Log.m64w(TAG, "can't inflate defaultView because mInfo is missing");
            }
        } catch (RuntimeException e) {
            exception = e;
        }
        if (exception != null) {
            Log.m64w(TAG, "Error inflating AppWidget " + this.mInfo + PluralRules.KEYWORD_RULE_SEPARATOR + exception.toString());
        }
        if (defaultView == null) {
            return getErrorView();
        }
    ...
    protected View getErrorView() {
        ...
        tv.setText(C3132R.string.gadget_host_error_inflating);
