        ...
        private static class Proxy implements IInstalld {
            ...
            public void moveCompleteApp(String fromUuid, String toUuid, String packageName, String dataAppName, int appId, String seInfo, int targetSdkVersion) throws RemoteException {
                ...
                try {
                    ...
                    th = th6;
                    String str5 = fromUuid;
                    String str32 = toUuid;
                    String str42 = packageName;
                    String str2222 = dataAppName;
                    int i2222 = appId;
                    _reply.recycle();
                    _data.recycle();
                    throw th;
            ...
            public void freeCache(String uuid, long targetFreeBytes, long cacheReservedBytes, int flags) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        ...
                        th = th4;
                        long j2 = targetFreeBytes;
                        long j3 = cacheReservedBytes;
                        int i22 = flags;
                        _reply.recycle();
                        _data.recycle();
                        throw th;
                    ...
                    th = th5;
                    String str = uuid;
                    long j22 = targetFreeBytes;
                    long j32 = cacheReservedBytes;
                    int i222 = flags;
                    _reply.recycle();
                    _data.recycle();
                    throw th;
            ...
            public boolean prepareAppProfile(String packageName, int userId, int appId, String profileName, String codePath, String dexMetadata) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                String str4 = codePath;
                                String str22 = dexMetadata;
                                _reply.recycle();
                                _data.recycle();
                                throw th;
                            }
                            ...
                            th = th3;
                            int i = appId;
                            String str32 = profileName;
                            String str42 = codePath;
                            String str222 = dexMetadata;
                            _reply.recycle();
                            _data.recycle();
                            throw th;
                        }
                        ...
                        int i2 = userId;
                        int i3 = appId;
                        String str322 = profileName;
                        String str422 = codePath;
                        String str22222 = dexMetadata;
                        _reply.recycle();
                        _data.recycle();
                        throw th;
                    }
                    ...
                    int i22 = userId;
                    int i32 = appId;
                    String str3222 = profileName;
                    String str4222 = codePath;
                    String str222222 = dexMetadata;
                    _reply.recycle();
                    _data.recycle();
                    throw th;
                }
