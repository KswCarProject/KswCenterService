...
public class AppZygote {
    ...
    private void connectToZygoteIfNeededLocked() {
        ...
        try {
            ...
            this.mZygote = zygoteProcess.startChildZygote("com.android.internal.os.AppZygoteInit", this.mAppInfo.processName + "_zygote", this.mZygoteUid, this.mZygoteUid, (int[]) null, 0, "app_zygote", abi, abi, (String) null, this.mZygoteUidGidMin, this.mZygoteUidGidMax);
