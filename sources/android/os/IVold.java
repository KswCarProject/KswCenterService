            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 27:
                        ...
                        reply.writeNoException();
                        parcel2.writeRawFileDescriptor(_result2);
                        return true;
                    case 28:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 43:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result7 = isConvertibleToFbe();
                        reply.writeNoException();
                    ...
                    case 58:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result8 = needsCheckpoint();
                        reply.writeNoException();
                        parcel2.writeInt(_result8);
                        return true;
                    case 59:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result9 = needsRollback();
                        reply.writeNoException();
                    ...
                    case 66:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result10 = supportsCheckpoint();
                        reply.writeNoException();
                        parcel2.writeInt(_result10);
                        return true;
                    case 67:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result11 = supportsBlockCheckpoint();
                        reply.writeNoException();
                        parcel2.writeInt(_result11);
                        return true;
                    case 68:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result12 = supportsFileCheckpoint();
                        reply.writeNoException();
                        parcel2.writeInt(_result12);
                        return true;
                    case 69:
                        parcel.enforceInterface(DESCRIPTOR);
                        String _result13 = createStubVolume(data.readString(), data.readString(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
                    ...
                    case 71:
                        parcel.enforceInterface(DESCRIPTOR);
                        FileDescriptor _result14 = openAppFuseFile(data.readInt(), data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeRawFileDescriptor(_result14);
                        return true;
                    default:
