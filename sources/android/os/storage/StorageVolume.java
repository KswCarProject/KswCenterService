...
public final class StorageVolume implements Parcelable {
    ...
    private StorageVolume(Parcel in) {
        ...
        this.mOwner = (UserHandle) in.readParcelable((ClassLoader) null);
    ...
    public Intent createOpenDocumentTreeIntent() {
        ...
        return new Intent(Intent.ACTION_OPEN_DOCUMENT_TREE).putExtra(DocumentsContract.EXTRA_INITIAL_URI, (Parcelable) DocumentsContract.buildRootUri(DocumentsContract.EXTERNAL_STORAGE_PROVIDER_AUTHORITY, rootId)).putExtra(DocumentsContract.EXTRA_SHOW_ADVANCED, true);
    }
    ...
    public void dump(IndentingPrintWriter pw) {
        ...
        pw.increaseIndent();
        pw.printPair("mId", (Object) this.mId);
        pw.printPair("mPath", (Object) this.mPath);
        pw.printPair("mInternalPath", (Object) this.mInternalPath);
        pw.printPair("mDescription", (Object) this.mDescription);
        pw.printPair("mPrimary", (Object) Boolean.valueOf(this.mPrimary));
        pw.printPair("mRemovable", (Object) Boolean.valueOf(this.mRemovable));
        pw.printPair("mEmulated", (Object) Boolean.valueOf(this.mEmulated));
        pw.printPair("mAllowMassStorage", (Object) Boolean.valueOf(this.mAllowMassStorage));
        pw.printPair("mMaxFileSize", (Object) Long.valueOf(this.mMaxFileSize));
        pw.printPair("mOwner", (Object) this.mOwner);
        pw.printPair("mFsUuid", (Object) this.mFsUuid);
        pw.printPair("mState", (Object) this.mState);
        pw.decreaseIndent();
    }
