...
public class DiskInfo implements Parcelable {
    ...
    public void dump(IndentingPrintWriter pw) {
        ...
        pw.increaseIndent();
        pw.printPair("flags", (Object) DebugUtils.flagsToString(getClass(), "FLAG_", this.flags));
        pw.printPair(DumpHeapActivity.KEY_SIZE, (Object) Long.valueOf(this.size));
        pw.printPair("label", (Object) this.label);
        pw.println();
        pw.printPair("sysPath", (Object) this.sysPath);
        pw.decreaseIndent();
        pw.println();
    }
