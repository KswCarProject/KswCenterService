...
public final class Debug {
    ...
    public static void startNativeTracing() {
        /*
            ...
            com.android.internal.util.FastPrintWriter r2 = new com.android.internal.util.FastPrintWriter     // Catch:{ Exception -> 0x001f, all -> 0x0018 }
            r2.<init>((java.io.OutputStream) r1)     // Catch:{ Exception -> 0x001f, all -> 0x0018 }
            r0 = r2
    ...
    public static void stopNativeTracing() {
        ...
        try {
            outStream = new FastPrintWriter((OutputStream) new FileOutputStream(SYSFS_QEMU_TRACE_STATE));
            outStream.println("0");
        } catch (Exception e) {
            if (outStream == null) {
                return;
    ...
    public static void startMethodTracing() {
        VMDebug.startMethodTracing(fixTracePath((String) null), 0, 0, false, 0);
    }
    ...
    private static String fixTracePath(String tracePath) {
        ...
        if (tracePath == null || tracePath.charAt(0) != '/') {
            ...
            if (context != null) {
                dir = context.getExternalFilesDir((String) null);
            } else {
    ...
    private static boolean fieldTypeMatches(Field field, Class<?> cl) {
        ...
        try {
            try {
                if (fieldClass == ((Class) cl.getField("TYPE").get((Object) null))) {
                    return true;
                }
                return false;
