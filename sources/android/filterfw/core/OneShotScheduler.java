...
public class OneShotScheduler extends RoundRobinScheduler {
    ...
    public Filter scheduleNextNode() {
        ...
        while (true) {
            ...
            if (filter == null) {
                if (this.mLogVerbose) {
                    Log.m66v(TAG, "No filters available to run.");
                }
                return null;
                ...
                if (this.mLogVerbose) {
                    Log.m66v(TAG, "Scheduling filter \"" + filter.getName() + "\" of type " + filter.getFilterClassName());
                }
                return filter;
                ...
                if (this.mLogVerbose) {
                    Log.m66v(TAG, "One pass through graph completed.");
                }
                return null;
            }
        }
